...
Namespace SunatProduccionIquitosService
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="SunatProduccionIquitosService.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As SunatProduccionIquitosService.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> SunatProduccionIquitosService.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As SunatProduccionIquitosService.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> SunatProduccionIquitosService.sendBillResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As SunatProduccionIquitosService.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatProduccionIquitosService.sendPackResponse
        
        'CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As SunatProduccionIquitosService.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatProduccionIquitosService.sendSummaryResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As SunatProduccionIquitosService.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As SunatProduccionIquitosService.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits SunatProduccionIquitosService.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of SunatProduccionIquitosService.billService)
        Implements SunatProduccionIquitosService.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionIquitosService_billService_getStatus(ByVal request As SunatProduccionIquitosService.getStatusRequest) As SunatProduccionIquitosService.getStatusResponse Implements SunatProduccionIquitosService.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As SunatProduccionIquitosService.statusResponse
            Dim inValue As SunatProduccionIquitosService.getStatusRequest = New SunatProduccionIquitosService.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As SunatProduccionIquitosService.getStatusResponse = CType(Me,SunatProduccionIquitosService.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionIquitosService_billService_sendBill(ByVal request As SunatProduccionIquitosService.sendBillRequest) As SunatProduccionIquitosService.sendBillResponse Implements SunatProduccionIquitosService.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As Byte()
            Dim inValue As SunatProduccionIquitosService.sendBillRequest = New SunatProduccionIquitosService.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionIquitosService.sendBillResponse = CType(Me,SunatProduccionIquitosService.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionIquitosService_billService_sendPack(ByVal request As SunatProduccionIquitosService.sendPackRequest) As SunatProduccionIquitosService.sendPackResponse Implements SunatProduccionIquitosService.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatProduccionIquitosService.sendPackRequest = New SunatProduccionIquitosService.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionIquitosService.sendPackResponse = CType(Me,SunatProduccionIquitosService.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionIquitosService_billService_sendSummary(ByVal request As SunatProduccionIquitosService.sendSummaryRequest) As SunatProduccionIquitosService.sendSummaryResponse Implements SunatProduccionIquitosService.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatProduccionIquitosService.sendSummaryRequest = New SunatProduccionIquitosService.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionIquitosService.sendSummaryResponse = CType(Me,SunatProduccionIquitosService.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
    End Class
End Namespace
