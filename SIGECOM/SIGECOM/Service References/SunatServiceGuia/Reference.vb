...
Namespace SunatServiceGuia
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="SunatServiceGuia.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As SunatServiceGuia.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> SunatServiceGuia.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As SunatServiceGuia.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> SunatServiceGuia.sendBillResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As SunatServiceGuia.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatServiceGuia.sendPackResponse
        
        'CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As SunatServiceGuia.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatServiceGuia.sendSummaryResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As SunatServiceGuia.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As SunatServiceGuia.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits SunatServiceGuia.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of SunatServiceGuia.billService)
        Implements SunatServiceGuia.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceGuia_billService_getStatus(ByVal request As SunatServiceGuia.getStatusRequest) As SunatServiceGuia.getStatusResponse Implements SunatServiceGuia.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As SunatServiceGuia.statusResponse
            Dim inValue As SunatServiceGuia.getStatusRequest = New SunatServiceGuia.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As SunatServiceGuia.getStatusResponse = CType(Me,SunatServiceGuia.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceGuia_billService_sendBill(ByVal request As SunatServiceGuia.sendBillRequest) As SunatServiceGuia.sendBillResponse Implements SunatServiceGuia.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As Byte()
            Dim inValue As SunatServiceGuia.sendBillRequest = New SunatServiceGuia.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceGuia.sendBillResponse = CType(Me,SunatServiceGuia.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceGuia_billService_sendPack(ByVal request As SunatServiceGuia.sendPackRequest) As SunatServiceGuia.sendPackResponse Implements SunatServiceGuia.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatServiceGuia.sendPackRequest = New SunatServiceGuia.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceGuia.sendPackResponse = CType(Me,SunatServiceGuia.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceGuia_billService_sendSummary(ByVal request As SunatServiceGuia.sendSummaryRequest) As SunatServiceGuia.sendSummaryResponse Implements SunatServiceGuia.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatServiceGuia.sendSummaryRequest = New SunatServiceGuia.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceGuia.sendSummaryResponse = CType(Me,SunatServiceGuia.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
    End Class
End Namespace
