...
Namespace SunatProduccionService
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="SunatProduccionService.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As SunatProduccionService.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> SunatProduccionService.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As SunatProduccionService.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> SunatProduccionService.sendBillResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As SunatProduccionService.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatProduccionService.sendPackResponse
        
        'CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As SunatProduccionService.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatProduccionService.sendSummaryResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As SunatProduccionService.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As SunatProduccionService.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits SunatProduccionService.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of SunatProduccionService.billService)
        Implements SunatProduccionService.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionService_billService_getStatus(ByVal request As SunatProduccionService.getStatusRequest) As SunatProduccionService.getStatusResponse Implements SunatProduccionService.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As SunatProduccionService.statusResponse
            Dim inValue As SunatProduccionService.getStatusRequest = New SunatProduccionService.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As SunatProduccionService.getStatusResponse = CType(Me,SunatProduccionService.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionService_billService_sendBill(ByVal request As SunatProduccionService.sendBillRequest) As SunatProduccionService.sendBillResponse Implements SunatProduccionService.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As Byte()
            Dim inValue As SunatProduccionService.sendBillRequest = New SunatProduccionService.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionService.sendBillResponse = CType(Me,SunatProduccionService.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionService_billService_sendPack(ByVal request As SunatProduccionService.sendPackRequest) As SunatProduccionService.sendPackResponse Implements SunatProduccionService.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatProduccionService.sendPackRequest = New SunatProduccionService.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionService.sendPackResponse = CType(Me,SunatProduccionService.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatProduccionService_billService_sendSummary(ByVal request As SunatProduccionService.sendSummaryRequest) As SunatProduccionService.sendSummaryResponse Implements SunatProduccionService.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatProduccionService.sendSummaryRequest = New SunatProduccionService.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatProduccionService.sendSummaryResponse = CType(Me,SunatProduccionService.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
    End Class
End Namespace
