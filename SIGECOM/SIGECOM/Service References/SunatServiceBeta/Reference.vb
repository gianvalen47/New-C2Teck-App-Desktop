...
Namespace SunatServiceBeta
    
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0"),  _
     System.ServiceModel.ServiceContractAttribute([Namespace]:="http://service.sunat.gob.pe", ConfigurationName:="SunatServiceBeta.billService")>  _
    Public Interface billService
        ...
        Function getStatus(ByVal request As SunatServiceBeta.getStatusRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="status")> SunatServiceBeta.getStatusResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendBill", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendBill(ByVal request As SunatServiceBeta.sendBillRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="applicationResponse")> SunatServiceBeta.sendBillResponse
        ...
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendPack", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendPack(ByVal request As SunatServiceBeta.sendPackRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatServiceBeta.sendPackResponse
        
        'CODEGEN: Parameter 'ticket' requires additional schema information that cannot be captured using the parameter mode. The specific attribute is 'System.Xml.Serialization.XmlElementAttribute'.
        <System.ServiceModel.OperationContractAttribute(Action:="urn:sendSummary", ReplyAction:="*"),  _
         System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults:=true)>  _
        Function sendSummary(ByVal request As SunatServiceBeta.sendSummaryRequest) As <System.ServiceModel.MessageParameterAttribute(Name:="ticket")> SunatServiceBeta.sendSummaryResponse
    End Interface
    ...
    Partial Public Class getStatusResponse
        ...
        <System.ServiceModel.MessageBodyMemberAttribute([Namespace]:="http://service.sunat.gob.pe", Order:=0),  _
         System.Xml.Serialization.XmlElementAttribute(Form:=System.Xml.Schema.XmlSchemaForm.Unqualified)>  _
        Public status As SunatServiceBeta.statusResponse
        
        Public Sub New()
            MyBase.New
        End Sub
        
        Public Sub New(ByVal status As SunatServiceBeta.statusResponse)
            MyBase.New
            Me.status = status
        End Sub
    End Class
    ...
    Public Interface billServiceChannel
        Inherits SunatServiceBeta.billService, System.ServiceModel.IClientChannel
    End Interface
    
    <System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")>  _
    Partial Public Class billServiceClient
        Inherits System.ServiceModel.ClientBase(Of SunatServiceBeta.billService)
        Implements SunatServiceBeta.billService
        ...
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceBeta_billService_getStatus(ByVal request As SunatServiceBeta.getStatusRequest) As SunatServiceBeta.getStatusResponse Implements SunatServiceBeta.billService.getStatus
            Return MyBase.Channel.getStatus(request)
        End Function
        
        Public Function getStatus(ByVal ticket As String) As SunatServiceBeta.statusResponse
            Dim inValue As SunatServiceBeta.getStatusRequest = New SunatServiceBeta.getStatusRequest()
            inValue.ticket = ticket
            Dim retVal As SunatServiceBeta.getStatusResponse = CType(Me,SunatServiceBeta.billService).getStatus(inValue)
            Return retVal.status
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceBeta_billService_sendBill(ByVal request As SunatServiceBeta.sendBillRequest) As SunatServiceBeta.sendBillResponse Implements SunatServiceBeta.billService.sendBill
        ...
        Public Function sendBill(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As Byte()
            Dim inValue As SunatServiceBeta.sendBillRequest = New SunatServiceBeta.sendBillRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceBeta.sendBillResponse = CType(Me,SunatServiceBeta.billService).sendBill(inValue)
            Return retVal.applicationResponse
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceBeta_billService_sendPack(ByVal request As SunatServiceBeta.sendPackRequest) As SunatServiceBeta.sendPackResponse Implements SunatServiceBeta.billService.sendPack
        ...
        Public Function sendPack(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatServiceBeta.sendPackRequest = New SunatServiceBeta.sendPackRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceBeta.sendPackResponse = CType(Me,SunatServiceBeta.billService).sendPack(inValue)
            Return retVal.ticket
        End Function
        
        <System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)>  _
        Function SunatServiceBeta_billService_sendSummary(ByVal request As SunatServiceBeta.sendSummaryRequest) As SunatServiceBeta.sendSummaryResponse Implements SunatServiceBeta.billService.sendSummary
        ...
        Public Function sendSummary(ByVal fileName As String, ByVal contentFile() As Byte, ByVal partyType As String) As String
            Dim inValue As SunatServiceBeta.sendSummaryRequest = New SunatServiceBeta.sendSummaryRequest()
            inValue.fileName = fileName
            inValue.contentFile = contentFile
            inValue.partyType = partyType
            Dim retVal As SunatServiceBeta.sendSummaryResponse = CType(Me,SunatServiceBeta.billService).sendSummary(inValue)
            Return retVal.ticket
        End Function
    End Class
End Namespace
