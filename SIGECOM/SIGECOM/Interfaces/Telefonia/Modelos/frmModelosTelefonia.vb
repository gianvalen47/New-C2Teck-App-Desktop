...
Public Class frmModelosTelefonia
    ...
    Private Sub frmModelosTelefonia_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmModelosTelefonia_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmModelosTelefonia_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 280)
        '/*************************************************************************************/
    ...
    Private Sub btnBuscar_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscar.Click, cmbMarca.ValueChanged, cbActivo.CheckedChanged, txtDesModelo.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmModeloTelefonia
            frm.state_button = True
            frm.IdModelo = dgvDatos.CurrentRow.Cells("IdModelo").Value
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdModelo").Value = codigo Then
            ...
            While lLog
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdModelo)
                    End If
                Else
                    lLog = False
                End If
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oLineasService.BorrarModelo(dgvDatos.CurrentRow.Cells("IdModelo").Value)
