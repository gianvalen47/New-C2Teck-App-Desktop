...
Public Class frmLineasTelefonia
    ...
    Private Sub frmLineasTelefonia_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmLineasTelefonia_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmLineasTelefonia_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 283)
        '/*************************************************************************************/
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oLineasService.Filtrar(toBlank(cmbRegion.Value), toNumber(IdPlan), toBlank(txtNumLinea.Text)).Tables(0)
    ...
    Private Sub chkPlan_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles chkPlan.CheckedChanged
        If txtPlan.Text <> "(Todos)" Then
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmLineaTelefonia
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdLinea)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVA LINEA TELEFONICA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            RowPossesion(dgvDatos, frm.IdLinea)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR LA LINEA TELEFONICA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oLineasService.Borrar(dgvDatos.CurrentRow.Cells("IdLinea").Value)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR LA LINEA TELEFONICA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdLinea").Value = codigo Then
