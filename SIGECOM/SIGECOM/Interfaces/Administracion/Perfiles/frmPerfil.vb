...
Public Class frmPerfil
    ...
    Private Sub LlenarCombos()
        Try
            ...
            '==================================== EMPRESAS ===================================
            dtEmpresa = oMaestro.MostrarEmpresas().Tables(0)
    ...
    Private Sub eliminarDetalle()
        Try
            ...
            If MsgBox("¿Está seguro de de ELIMINAR la opción " & dgvDatos.CurrentRow.Cells("DesOpc1").Text & "?", MsgBoxStyle.YesNo, "Eliminar") = MsgBoxResult.Yes Then
                ...
                estado_process = oSeguridadService.BorrarPerfilOpciones(dgvDatos.CurrentRow.Cells("IdOpcion").Text, txtCodigo.Text, cmbEmpresa.Value)
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oSeguridadService.MostrarPerfilOpciones(CodPerfil, cmbModulos.Value, cmbEmpresa.Value).Tables(0)
    ...
    Private Sub btnAsignarPerfil_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAsignarPerfil.Click
        ...
        frm.CodEmp = cmbEmpresa.Value
        frm.lblEmpresa.Text = cmbEmpresa.Text
        If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            listaDatos()
        End If
        listaDatos()
