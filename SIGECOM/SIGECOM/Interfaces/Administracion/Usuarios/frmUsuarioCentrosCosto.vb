...
Public Class frmUsuarioCentrosCosto
            ...
            If MsgBox("¿Está seguro de ASIGNAR los centros de costo seleccionados al usuario: " & CodUsu & "?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    For Each fila As DataRow In dtSeleccionados.Rows
                        estado_process = oSeguridadService.InsertarCentroCosto(CodUsu, fila.Item("CodCentro"), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    Next
    ...
    Private Sub cmbEmpresa_ValueChanged(sender As Object, e As EventArgs) Handles cmbEmpresa.ValueChanged
        '======================================= AREAS ================================================
        dtAreas = oMaestroService.MostrarAreas(cmbEmpresa.Value, "").Tables(0)
        ...
        If dtAreas.Rows.Count() > 0 Then
            ...
            dtAreas = Nothing
        Else
            cmbCodArea.DataSource = Nothing
            dgvCentros.DataSource = Nothing
            cmbCodArea.Text = ""
        End If
