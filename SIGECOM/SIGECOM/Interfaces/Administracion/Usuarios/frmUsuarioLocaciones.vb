...
Public Class frmUsuarioLocaciones
    ...
    Private oEmpUsuario As New EmpresaUsuarioService.EmpresaUsuarioServiceClient
    ...
    Private Sub llenarCombos()
        Try
            ...
            '==================================== EMPRESAS ===================================
            dtEmpresa = oEmpUsuario.Mostrar(CodUsu).Tables(0)
            cmbEmpresa.DataSource = dtEmpresa
            cmbEmpresa.DropDownList.DataMember = dtEmpresa.Columns("DesEmp").ToString
            cmbEmpresa.DropDownList.DisplayMember = dtEmpresa.Columns("DesEmp").ToString
            cmbEmpresa.DropDownList.ValueMember = dtEmpresa.Columns("CodEmp").ToString
            cmbEmpresa.DropDownList.Columns(0).DataMember = dtEmpresa.Columns("CodEmp").ToString
            cmbEmpresa.DropDownList.Columns(1).DataMember = dtEmpresa.Columns("DesEmp").ToString
            cmbEmpresa.SelectedIndex = 0
            dtEmpresa = Nothing

            ''======================================== OFICINAS ================================================
            'dtOficinas = oMaestroService.MostrarOficinasEmpresa(cmbEmpresa.Value, "").Tables(0)
    ...
    Private Sub listaDatos()
        Try
            ...
            '===================================== LISTA LOCACIONES ======================================
            dtLocaciones = oMaestroService.MostrarLocaciones(cmbEmpresa.Value, cmdOficina.Value, "").Tables(0)
            ...
            If MsgBox("¿Está seguro de ASIGNAR las locaciones seleccionadas al usuario: " & CodUsu & "?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    For Each fila As DataRow In dtSeleccionados.Rows
                        estado_process = oSeguridadService.InsertarLocacionUsuario(CodUsu, fila.Item("IdLocacion"), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    Next
    ...
    Private Sub cmbEmpresa_ValueChanged(sender As Object, e As EventArgs) Handles cmbEmpresa.ValueChanged

        cmdOficina.Clear()
        '======================================== OFICINAS ================================================
        dtOficinas = oMaestroService.MostrarOficinasEmpresa(cmbEmpresa.Value, Session.sCodUsu).Tables(0)
        cmdOficina.DataSource = dtOficinas
        cmdOficina.DropDownList.DataMember = dtOficinas.Columns("DesOfi").ToString
        cmdOficina.DropDownList.DisplayMember = dtOficinas.Columns("DesOfi").ToString
        cmdOficina.DropDownList.ValueMember = dtOficinas.Columns("CodOfi").ToString
