...
Public Class frmRubrosxEmpresa_DetalleM
    ...
    Private Sub frmRubrosxEmpresa_DetalleM_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRubrosxEmpresa_DetalleM_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            biCerrar_Click(sender, e)
        End If
    End Sub

    Private Sub frmRubrosxEmpresa_DetalleM_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Else 'Nuevo
            ...
            Me.Text = "Registrar nuevo Rubro x Empresa"
    ...
    Private Sub NuevoDetalle()
        ...
        Try
            Dim frm As New frmRubrosxEmpresa_Detalle
            frm.CodEmp = CodEmpV
    ...
    '        FacCos = dgvDatos.CurrentRow.Cells("FacCos").Text
    '        FacVen = dgvDatos.CurrentRow.Cells("FacVen").Text
    '        Dscto = dgvDatos.CurrentRow.Cells("Dscto").Text
    ...
    '        rubro.CodRub = CodRubGrilla
    '        registro.Rubro = rubro

    '        empresa.CodEmp = CodEmp
    '        registro.Empresa = empresa

    '        registro.FacCos = toDouble(FacCos)
    '        registro.FacVen = toDouble(FacVen)
    '        registro.Dscto = toDouble(Dscto)

    '        registro.CodUsu = Session.sCodUsu
    '        registro.NomPc = Session.sNomPc
    '        registro.DirIp = Session.sDirIp

    '        estado = oRubrosService.InsertarRubrosEmpresa(registro)
    ...
    Private Sub Insertar(ByVal registro As RubrosService.RubrosEmpresa)
        Try
            ...
            If estado_process Then
                MsgBox("Se insertó el Rubro x Empresa correctamente")
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL INSERTAR EL RUBRO X EMPRESA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Modificar(ByVal registro As RubrosService.RubrosEmpresa)
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MODIFICAR EL RUBRO X EMPRESA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
