...
Public Class frmMemoriasRam
    ...
    Private Sub frmMemoriasRam_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmMemoriasRam_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmMemoriasRam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesMemRam.TextChanged, txtMarca.TextChanged, txtSerie.TextChanged, txtModelo.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                'dtDatos = oComputadoraService.FiltrarMemoria(toBlank(txtDesMemRam.Text), toBlank(txtMarca.Text), toBlank(txtModelo.Text), toBlank(txtSerie.Text)).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdMemRam)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR LA MEMORIA RAM: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdMemRam = dgvDatos.CurrentRow.Cells("IdMemRam").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oComputadoraService.BorrarMemoria(dgvDatos.CurrentRow.Cells("IdMemRam").Value)
    ...
    Private Sub dgvDatos_SelectionChanged(sender As Object, e As EventArgs)
        enableOpciones()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdMemRam").Text
        End If
        dtDatos = Nothing
        listaDatos()
