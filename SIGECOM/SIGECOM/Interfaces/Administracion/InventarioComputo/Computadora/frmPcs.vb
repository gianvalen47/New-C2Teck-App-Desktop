...
Public Class frmPcs
    ...
    Private Sub frmPcs_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmPcs_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmPcs_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
