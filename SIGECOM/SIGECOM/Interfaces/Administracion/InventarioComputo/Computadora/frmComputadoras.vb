...
Public Class frmComputadoras
    ...
    Private Sub frmComputadoras_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmComputadoras_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmComputadoras_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 285)
        '/*************************************************************************************/
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, cmbTipoComputadora.ValueChanged, txtNomPc.TextChanged, cbVigente.CheckedChanged
        listaDatos()
    End Sub
    ...
    Private Sub Nuevo()
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR NUEVA COMPUTADORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
        ...
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    limpiaOpcionesBusqueda("update", frm.txtComputadora.Text)
                    listaDatos()
                    RowPossesion(dgvDatos, frm.IdComputadora)
                Else
            ...
            RowPossesion(dgvDatos, frm.IdComputadora)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR LA COMPUTADORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub limpiaOpcionesBusqueda(ByVal type_process As String, ByVal nomcomp As String)
        If type_process = "update" Or type_process = "insert" Then
            cmbTipoComputadora.Value = 0
            txtNomPc.Text = nomcomp
        End If
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oComputadoraService.BorrarComputadora(dgvDatos.CurrentRow.Cells("IdComputadora").Value)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR LA COMPUTADORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biImprimir_Click(sender As Object, e As EventArgs) Handles biImprimir.Click
        Try
            Dim frm5 As New frmComputadora_Imprimir
            frm5.IdComputadora = dgvDatos.CurrentRow.Cells("IdComputadora").Text
            frm5.ShowDialog()

            'Dim dtReporte As New DataTable

            'dtReporte = oComputadoraService.ImprimirComputadora(dgvDatos.CurrentRow.Cells("IdComputadora").Text).Tables(0)
