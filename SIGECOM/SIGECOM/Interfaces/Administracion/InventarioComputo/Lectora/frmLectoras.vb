...
Public Class frmLectoras
    ...
    Private Sub frmLectoras_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmLectoras_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmLectoras_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesLectora.TextChanged, txtMarca.TextChanged, txtSerie.TextChanged, txtModelo.TextChanged, cmbTipoConector.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                'dtDatos = oComputadoraService.FiltrarLectora(toBlank(txtDesLectora.Text), toBlank(txtMarca.Text), toBlank(txtModelo.Text), toBlank(txtSerie.Text), toNumber(cmbTipoConector.Value)).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdLectora)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR LA LECTORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdLectora = dgvDatos.CurrentRow.Cells("IdLectora").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oComputadoraService.BorrarLectora(dgvDatos.CurrentRow.Cells("IdLectora").Value)
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdLectora").Text
        End If
        dtDatos = Nothing
        listaDatos()
