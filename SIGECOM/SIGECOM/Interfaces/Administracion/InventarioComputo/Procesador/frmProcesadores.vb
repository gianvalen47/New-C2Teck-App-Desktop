...
Public Class frmProcesadores
    ...
    Private Sub frmProcesadores_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmProcesadores_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmProcesadores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesProcesador.TextChanged, txtModelo.TextChanged, txtMarca.TextChanged, txtSerie.TextChanged, txtTipoProcesador.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdProcesador)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVO PROCESADOR: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdPlacaMadre = dgvDatos.CurrentRow.Cells("IdProcesador").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oComputadoraService.BorrarProcesador(dgvDatos.CurrentRow.Cells("IdProcesador").Value)
