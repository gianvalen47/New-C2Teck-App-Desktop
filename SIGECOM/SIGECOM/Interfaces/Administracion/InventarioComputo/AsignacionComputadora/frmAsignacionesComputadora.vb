...
Public Class frmAsignacionesComputadora
    ...
    Private Sub frmAsignacionesComputadora_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 286)
        '/*************************************************************************************/
    ...
    Private Sub frmAsignacionesComputadora_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmAsignacionesComputadora_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click ', txtPersona.TextChanged, txtComputadora.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oAsignacionComputadoraService.Filtrar(toNumber(IdPer), toNumber(IdComputadora)).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmAsignacionComputadora
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdComputadora)
                    End If
                Else
                    lLog = False
                End If
            ...
            'End If
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR LA ASIGNACION DE COMPUTADORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdPersona = dgvDatos.CurrentRow.Cells("IdPersona").Value
            frm.IdComputadora = dgvDatos.CurrentRow.Cells("IdComputadora").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
            ...
            'End If
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR LA ASIGNACION DE COMPUTADORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oAsignacionComputadoraService.Borrar(dgvDatos.CurrentRow.Cells("IdPersona").Value, dgvDatos.CurrentRow.Cells("IdComputadora").Value)
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdComputadora").Value = codigo Then
    ...
    Private Sub chkComputadora_CheckedChanged(sender As Object, e As EventArgs) Handles chkComputadora.CheckedChanged
        If txtComputadora.Text <> "(Todos)" Then
            chkComputadora.Enabled = False
            txtComputadora.Text = "(Todos)"
            IdComputadora = 0
            listaDatos()
        Else
            chkComputadora.Enabled = True
            pboxLimpiarComputadora.Enabled = True
        End If
    End Sub
End Class