    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        If state_button Then    'Modificar
            ...
            If (lblEstado.Text = "GENERADO" Or lblEstado.Text = "GN") Then
                ...
                dgvDatos.AllowEdit = Janus.Windows.GridEX.EditType.NoEdit
                dtDatos.Columns.Item("CodMer").ReadOnly = True
            Else
    ...
    Private Sub Insertar(ByVal registro As ImportacionService.Importacion)
        Try
            ...
            If estadoImportar_PI Then
                Try
                    estado_process = oImportacionService.IngresarFacturaImportacion(IdLocacion, IdCliente, txtFecDoc.Text, txtNumDoc.Text, txtObservacion.Text, Session.sCodUsu)
                ...
                If importacion = True Then
                    ...
                    If frmAlmacen_FacturaImportacionGrilla.ShowDialog = Windows.Forms.DialogResult.OK Then
