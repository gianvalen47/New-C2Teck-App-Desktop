    ...
    Private Sub frmTablero_Grafica_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try
            ...
            If iGrupo = "1" Then
                ...
                '--------------------------------------------------------------------------General-------------------------------------------------------------------------------
                If iCodRub = "00" Then
                    dtDatos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 7).Tables(0)
                    dtTablero = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 13).Tables(0)
                    ...
                    '----------------------------------------------------------------------X Rubro--------------------------------------------------------------------------------
                Else
                    dtDatos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 8).Tables(0)
                    dtTablero = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 14).Tables(0)
                    dgvGrafica.DataSource = dtDatos
                    dgvTablero.DataSource = dtTablero
                    Dim estilo1 As New Estilo
                    estilo1.cargaEstiloDataDrid(dgvTablero)
            ...
            ElseIf iGrupo = "2" Then
                '----------------------------------------------------------------------General--------------------------------------------------------------------------------
                If iCodRub = "00" Then
                    dtDatos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 9).Tables(0)
                    dtTablero = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 15).Tables(0)
                    dtMotivos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 11).Tables(0)
                    dgvGrafica.DataSource = dtDatos
                    dgvTablero.DataSource = dtTablero
                    ...
                    '----------------------------------------------------------------------X Rubro--------------------------------------------------------------------------------
                Else
                    dtDatos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 10).Tables(0)
                    dtTablero = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 16).Tables(0)
                    dtMotivos = oIndicadoresAlmacenService.ConsultasTablero(Session.sCodEmp, iCodRub, iFecha, 12).Tables(0)
                    dgvGrafica.DataSource = dtDatos
                    dgvTablero.DataSource = dtTablero
                    dgvMotivos.DataSource = dtMotivos
                    Dim estilo1 As New Estilo
    ...
    Private Sub MostrarGraficoMotivos()
        Try
            ...
            Else
                ...
                ChartMotivo.Plot.Axis(MSChart20Lib.VtChAxisId.VtChAxisIdX).AxisTitle.Visible = False
