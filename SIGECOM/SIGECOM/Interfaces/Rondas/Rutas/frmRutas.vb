...
Public Class frmRutas
    ...
    Private Sub frmRutas_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRutas_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRutas_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ListaDatos()
    End Sub
    ...
    Private Sub ListaDatos()
        Try
            ...
            dtDatos = oRondasService.MostrarRutas().Tables(0)
    ...
    Private Sub biMostrar_Click(sender As System.Object, e As System.EventArgs) Handles biMostrar.Click, miNuevo.Click
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la ruta?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oRondasService.BorrarRutas(dgvDatos.CurrentRow.Cells("CodRuta").Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
