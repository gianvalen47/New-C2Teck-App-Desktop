...
Public Class frmKardex_VerStock
    ...
    Private Sub listaDatos()
        Try
            ...
            dtDatos = oLocacionMercaderiaService.MostrarStockGeneral(Session.sCodEmp, CodMer, toNumber(txtanio.Value)).Tables(0)
            dgvDatos.SetDataBinding(dtDatos, 0)

            txtTotalStock.Text = getTotal("Stock")
            txtComprometido.Text = getTotal("Comprometido")
            txtTotalDisponible.Text = getTotal("Disponible")
