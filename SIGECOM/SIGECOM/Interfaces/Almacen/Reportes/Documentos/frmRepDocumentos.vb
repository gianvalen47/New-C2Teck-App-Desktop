...
Public Class frmRepDocumentos
    ...
    Private Sub frmRepDocumentos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 160)
        '/*************************************************************************************/
    ...
    Private Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        oSeguridadService.RegistrarVisitaOpciones(160, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
        MostrarReporte()
    End Sub
