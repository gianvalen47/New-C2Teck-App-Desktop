...
Public Class frmTransferenciaInterna_Transferir
    ...
    Private Sub frmTransferenciaInterna_Transferir_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Function ValidaCampos() As Boolean
        Try
            If toNumber(IdTransferencia) = 0 Then
                MsgBox("Debe Ingresar el código de la T.I.", MsgBoxStyle.Information, "Información")
                Return False
    ...
    Private Sub Transferir()
        Try
            ...
            estado_process = oTransferenciaService.Transferir(toNumber(IdTransferencia), toNumber(IdLocacion), Session.sCodUsu)
            type_process = "insert"
            If estado_process = True Then
                MsgBox(" Se Transfirió correctamente al T.I. Nº: " + NumDoc + " :", MsgBoxStyle.Information)
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro de transferirir la T/I Nº: " + NumDoc + " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
