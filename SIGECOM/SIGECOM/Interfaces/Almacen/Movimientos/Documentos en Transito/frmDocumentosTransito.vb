Public Class frmDocumentosTransito
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 8)
        '/*************************************************************************************/
    ...
    Private Sub mostrarGUIA()
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    limpiaOpcionesBusqueda("update", frm.txtNumDoc.Text, frm.IdSerieDoc)
                    listaDatos()
                ...
                If MsgBox("¿Está seguro de Trasladar el documento Nº " + dgvDatos.CurrentRow.Cells("NumDoc").Text + " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    If oDocumentoTransitoService.ValidarIngreso(dgvDatos.CurrentRow.Cells("IdTransito").Text) Then
                        If ActualizaLista() Then
                            oDocumentoTransitoService.TrasladarDocumento(dgvDatos.CurrentRow.Cells("IdTransito").Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
 ...
 _
 _
                                   miTrasladar.MouseLeave, miMostrar.MouseLeave, miEliminar.MouseLeave, _
