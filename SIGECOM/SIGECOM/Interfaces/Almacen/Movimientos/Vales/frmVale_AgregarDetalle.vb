...
Public Class frmVale_AgregarDetalle
    ...
    Private Sub FinallyObjects_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            ...
            End If
            If isClosed(oPrecio) = False Then
                oLocacionMercaderiaService.Close()
            End If
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf toNumber(txtCanMer.Value) <= 0 Then
                ...
                txtCanMer.Focus()
                Return False
                'Comentado para que permita modificar el precio despues de haber despachado (stock 0) 26-09-24
    ...
    Private Sub btnBuscarMercaderia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscarMercaderia.Click
        ...
        If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ...
            Dim valeMaterial As New ValeMaterialService.ValeMaterial
            valeMaterial = oValeMaterialService.MostrarPorId(IdVale)
            txtDesMer.Text = frm.descripcion
            txtCodMer.Text = frm.codigo
            txtCodMer.BackColor = System.Drawing.SystemColors.Window
            txtPreMer.Text = oPrecio.PrecioVenta(IdLocacion, valeMaterial.Cliente.IdCliente, frm.codigo, valeMaterial.Moneda.CodMon, valeMaterial.FecDoc)  'LocacionMercaderia.CosDol  'frm.precio
            txtDscMer.Text = oPrecio.DescuentoVenta(IdLocacion, valeMaterial.Cliente.IdCliente, frm.codigo) '0.00 'frm.descuento
            txtStock.Text = oLocacionMercaderiaService.MostrarStock(IdLocacion, txtCodMer.Text)
            calculateTotal()
        End If
        txtCodMer.Select()
        ...
        Try
            If Len(Trim(txtCodMer.Text)) > 0 And state_button = False Then
                ...
                If oLocacionMercaderiaService.Buscar(IdLocacion, txtCodMer.Text) Then
                    ...
                    txtPreMer.Text = oPrecio.PrecioVenta(IdLocacion, valeMaterial.Cliente.IdCliente, txtCodMer.Text, valeMaterial.Moneda.CodMon, valeMaterial.FecDoc) 'LocacionMercaderia.Mercaderia.CosDol  'LocacionMercaderia.Mercaderia.DeaMer
                    txtDscMer.Text = oPrecio.DescuentoVenta(IdLocacion, valeMaterial.Cliente.IdCliente, txtCodMer.Text)
                    calculateTotal()
                Else
