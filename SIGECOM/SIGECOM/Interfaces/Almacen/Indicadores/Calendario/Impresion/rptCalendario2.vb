...
Public Class rptCalendario2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptCalendario2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pCodUsu() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptCalendario2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCalendario2 = New rptCalendario2()
        rpt.Site = Me.Site
        Return rpt
    End Function
