...
Public Class rptIndicUsuxGrupo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptIndicUsuxGrupo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptIndicUsuxGrupo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptIndicUsuxGrupo = New rptIndicUsuxGrupo()
        rpt.Site = Me.Site
        Return rpt
    End Function
