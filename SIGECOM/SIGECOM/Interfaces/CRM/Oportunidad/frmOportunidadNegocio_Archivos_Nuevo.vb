...
Public Class frmOportunidadNegocio_Archivos_Nuevo
    ...
    Private Sub frmOportunidadNegocio_Archivos_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmOportunidadNegocio_Archivos_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmOportunidadNegocio_Archivos_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub biGuardar_Click(sender As Object, e As EventArgs) Handles biGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                Dim registro As New OportunidadNegocioService.OportunidadNegocioArchivo
    ...
    Private Sub Insertar(ByVal registro As OportunidadNegocioService.OportunidadNegocioArchivo)
        Try
            IdOportunidadArchivo = oOportunidadNegocioService.InsertarArchivo(registro)
            type_process = "insert"
            If IdOportunidadArchivo > 0 Then
