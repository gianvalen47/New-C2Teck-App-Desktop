...
Public Class rpRepPlanilla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepPlanilla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepPlanilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepPlanilla = New rpRepPlanilla()
        rpt.Site = Me.Site
        Return rpt
    End Function
