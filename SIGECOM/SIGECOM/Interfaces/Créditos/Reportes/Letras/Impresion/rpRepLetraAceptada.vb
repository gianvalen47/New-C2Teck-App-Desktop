...
Public Class rpRepLetraAceptada
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepLetraAceptada.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepLetraAceptada
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepLetraAceptada = New rpRepLetraAceptada()
        rpt.Site = Me.Site
        Return rpt
    End Function
