...
Public Class rptSaldoBancoUnit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptSaldoBancoUnit.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_TituloSaldo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSaldoBancoUnit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoBancoUnit = New rptSaldoBancoUnit()
        rpt.Site = Me.Site
        Return rpt
    End Function
