...
Public Class rptClientesFacDscs
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptClientesFacDscs.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClientesFacDscs
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClientesFacDscs = New rptClientesFacDscs()
        rpt.Site = Me.Site
        Return rpt
    End Function
