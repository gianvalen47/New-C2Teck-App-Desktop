...
Public Class frmComOrdenCompra_Archivos_Nuevo

    Private oOrdenCompraService As New OrdenesCompraService.OrdenesCompraServiceClient
    ...
    Private Sub Insertar(ByVal registro As OrdenesCompraService.OrdenesCompraArchivos)
        Try
            IdOrdenArchivo = oOrdenCompraService.InsertarArchivo(registro)
            type_process = "insert"
            If IdOrdenArchivo > 0 Then
