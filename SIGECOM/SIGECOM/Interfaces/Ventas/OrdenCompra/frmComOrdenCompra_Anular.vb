...
Public Class frmComOrdenCompra_Anular
    ...
    Private Sub frmComOrdenCompra_Anular_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.Text = "Anular la Orden de Compra N°:" & IdOrden
    End Sub
    ...
    Private Sub btnAnular_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAnular.Click
        Try
            ...
            Else
                If MsgBox("¿Está seguro de ANULAR la Orden de Compra N°:" & IdOrden.ToString & "?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then

                    estado_process = oOrdenesCompraService.Anular(IdOrden, toBlank(txtObservacion.Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    If estado_process Then
                        MsgBox("Se Anuló la Orden de Compra correctamente")
