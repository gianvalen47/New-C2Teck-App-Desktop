...
Public Class frmComOrdenCompra_Archivos_Actualizar

    Private oOrdenService As New OrdenesCompraService.OrdenesCompraServiceClient
    ...
    Private Sub ObtenerRegistro()
        ...
        Try
            Dim registro2 As OrdenesCompraService.OrdenesCompraArchivos
            oOrdenService.InnerChannel.OperationTimeout = TimeSpan.FromMinutes(10)
            registro2 = oOrdenService.ObtenerArchivo(IdArchivo)
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            Dim registro As New OrdenesCompraService.OrdenesCompraArchivos

            Dim orden As New OrdenesCompraService.OrdenesCompra
            orden.IdOrden = IdOrden
            registro.OrdenesCompra = orden

            registro.IdOrdenArchivo = IdArchivo
            ...
            actualizar = oOrdenService.ActualizarArchivo(registro)
