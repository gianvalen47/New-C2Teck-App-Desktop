...
Public Class rptPrecioLista
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptPrecioLista.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrecioLista
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrecioLista = New rptPrecioLista()
        rpt.Site = Me.Site
        Return rpt
    End Function
