...
Public Class frmListaOfertaNuevo_Aprobar
    ...
    Private Sub frmListaOfertaNuevo_Aprobar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.Text = "Aprobar la Lista de oferta N°:" & IdOferta
        btnAprobar.Focus() '------- Agregado el 30/05/2012 -------
        Me.Size = New System.Drawing.Size(560, 269)
    End Sub

    Private Sub frmListaOfertaNuevo_Aprobar_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaOfertaNuevo_Aprobar_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub btnAprobar_Click(sender As Object, e As EventArgs) Handles btnAprobar.Click
        ...
        Try
            ...
            If cbAprobar.Checked Then
                ...
                If IdEstado = 2 Then
                    If MsgBox("¿Está seguro de APROBAR la Lista de oferta N°: " & IdOferta & " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                        ...
                        estado_process = oListaOfertaCabService.AprobacionJefe(IdOferta, toBlank(txtObservacion.Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                        If estado_process Then
                            MsgBox("Se Aprobó la Lista de oferta correctamente ")
                ...
                Else
                    ...
                    '    If MsgBox("¿Está seguro de APROBAR la Lista de oferta N°: " & IdLista & " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    ...
                    '     Environment.NewLine &
                    '    "¿Está seguro de APROBAR la Lista de oferta N°: " & IdLista & " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    '        'estado_process = oListaPrecioCabService.AprobacionGerencia(IdLista, toBlank(txtObservacion.Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    '        MsgBox("Se Aprobó la Lista de oferta correctamente ")
                    '        Me.DialogResult = System.Windows.Forms.DialogResult.OK
                    '    End If
            ...
            ElseIf cbRechazar.Checked Then
                ...
                Else
                    If MsgBox("¿Está seguro de RECHAZAR la Lista de precio N°:" & IdOferta & "?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then

                        estado_process = oListaOfertaCabService.Rechazar(IdOferta, toBlank(txtObservacion.Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                        If estado_process Then
