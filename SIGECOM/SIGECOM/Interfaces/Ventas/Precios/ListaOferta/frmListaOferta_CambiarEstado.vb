...
Public Class frmListaOferta_CambiarEstado
    ...
    Private Sub frmListaOferta_CambiarEstado_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaOferta_CambiarEstado_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaOferta_CambiarEstado_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenarCombos()
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oPrecioService.MostrarListaOferta(Session.sCodEmp, cmbRubro.Value, txtCodMer.Text, utils.toNumber(IdEstado)).Tables(0)
            'MostrarListaPrecio
    ...
    Private Sub btnEnviar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEnviar.Click
        ...
        Try
            If dgvDatos.RowCount > 0 Then
                If MsgBox("¿Está seguro de ENVIAR los precio oferta seleccionados?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    ...
                    If rows.Count <> 0 Then
                        ...
                        If rowsLista.Count <> 0 Then
                            ...
                            For Each row In rowsLista
                                ...
                                estado_process = oPrecioService.EnviarListaOferta(IdLista, Cadena, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                                i = i + 1

                            Next

                        Else
                            MsgBox("Debe seleccionar algun precio oferta")
                        End If
                    Else
                    ...
                    If rowsLista.Count = i And rowsLista.Count <> 0 Then
                        MsgBox("Se envio los precio oferta correctamente.")
        ...
        Catch ex As Exception
            MsgBox("Error al enviar los precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub btnAprobar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAprobar.Click
        Try
            ...
            If cbAprobar.Checked Then
                If MsgBox("¿Está seguro de APROBAR los precio oferta seleccionados?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    ...
                    If IdEstado = 2 Or IdEstado = 3 Then
                        ...
                        If rowsLista.Count <> 0 Then
                            ...
                            For Each row In rowsLista
                                ...
                                IdLista = row.Cells("IdLista").Text
                                estado_process = oPrecioService.AprobarListaOferta(IdLista, txtObservacion.Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                                i = i + 1
                            Next
                        ...
                        If rowsLista.Count = i And rowsLista.Count <> 0 Then
                            MsgBox("Se aprobó los precio oferta correctamente.")
                            Me.DialogResult = System.Windows.Forms.DialogResult.OK
                        End If
            ...
            ElseIf cbRechazar.Checked Then
                If MsgBox("¿Está seguro de RECHAZAR los precio oferta seleccionados?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    ...
                    Else
                        ...
                        If rowsLista.Count <> 0 Then
                            ...
                            For Each row In rowsLista
                                ...
                                IdLista = row.Cells("IdLista").Text
                                estado_process = oPrecioService.RechazarListaOferta(IdLista, txtObservacion.Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                                i = i + 1
                        ...
                        If rowsLista.Count = i And rowsLista.Count <> 0 Then
                            MsgBox("Se rechazó los precio oferta correctamente.")
                            Me.DialogResult = System.Windows.Forms.DialogResult.OK
                        End If
                    End If
                End If
        ...
        Catch ex As Exception
            MsgBox("Error al aprobar/rechazar los precio oferta : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub btnVencer_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnVencer.Click
        ...
        Try
            ...
            If IdEstado = 4 Then
                If MsgBox("¿Está seguro de DAR DE BAJA los precio oferta seleccionados?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    Dim rowsLista() As Janus.Windows.GridEX.GridEXRow
                    ...
                    If rowsLista.Count <> 0 Then
                        ...
                        For Each row In rowsLista
                            ...
                            IdLista = row.Cells("IdLista").Text
                            estado_process = oPrecioService.VencimientoPrecioListaOferta(IdLista, txtObservacion.Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                            i = i + 1
                        Next
                    ...
                    If rowsLista.Count = i And rowsLista.Count <> 0 Then
                        MsgBox("Se dio de baja los precio oferta correctamente.")
                        Me.DialogResult = System.Windows.Forms.DialogResult.OK
                    End If
            ...
            End If
        Catch ex As Exception
            MsgBox("Error al dar de baja los precio oferta : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
