...
Public Class frmListaPrecioNuevo
    ...
    Private Sub frmListaPrecioNuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 204)
        '/*************************************************************************************/

        Dim estilo As New Estilo
        estilo.cargaEstiloGridExtAlternating(dgvDatos)
        dgvDatos.Anchor = AnchorStyles.Bottom Or AnchorStyles.Top Or AnchorStyles.Right Or AnchorStyles.Left
        Me.Size = New System.Drawing.Size(971, 496)
        llenarCombos()
        listaDatos()

    End Sub

    Private Sub frmListaPrecioNuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaPrecioNuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub llenarCombos()
        ...
        '======================================= ESTADOS ================================================
        dtEstados = oListaPrecioCabService.MostrarEstados().Tables(0)
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oListaPrecioCabService.Filtrar(Session.sCodEmp, cmbEstado.Value).Tables(0)
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmListaPrecioNuevo_Nuevo
    ...
    Private Sub enableOpciones()
        ...
        Else
            ...
            biAprobar.Enabled = IIf(iEstado = 2 Or iEstado = 3 Or (oListaPrecioCabService.BuscarAprobacionPendiente(dgvDatos.CurrentRow.Cells("IdLista").Value) And iEstado = 4), True, False)
            ...
            miAprobar.Enabled = IIf(iEstado = 2 Or iEstado = 3 Or (oListaPrecioCabService.BuscarAprobacionPendiente(dgvDatos.CurrentRow.Cells("IdLista").Value) And iEstado = 4), True, False)
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Lista de Precio Nº " + dgvDatos.CurrentRow.Cells("IdLista").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oListaPrecioCabService.Borrar(CInt(dgvDatos.CurrentRow.Cells("IdLista").Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub biVerEstados_Click(sender As Object, e As EventArgs) Handles biVerEstados.Click, miVerEstados.Click
        Try
            If ValidaCodigoSeleccionado() Then
                Dim frm As New frmListaPrecioNuevo_Estados
    ...
    Private Sub biAprobar_Click(sender As Object, e As EventArgs) Handles biAprobar.Click, miAprobar.Click
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("Error al aprobar la lista precio : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biImprimir_Click(sender As Object, e As EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            ...
            Dim reporte As New rptListaPrecioNuevo

            If dgvDatos.RowCount > 0 Then
                dtReporte = oListaPrecioCabService.Imprimir(dgvDatos.CurrentRow.Cells("IdLista").Text).Tables(0)
    ...
    Private Sub biDarBaja_Click(sender As Object, e As EventArgs) Handles biDarBaja.Click, miDarBaja.Click
        ...
        Try
            If dgvDatos.CurrentRow.Cells("IdLista").Text <> "" Then
                ...
                Dim frm As New frmListaPrecioNuevo_DarBaja
    ...
    Private Sub biModificarValidez_Click(sender As Object, e As EventArgs) Handles biModificarValidez.Click, miModificarValidez.Click
        Try
            Dim frm As New frmListaPrecioNuevo_ModificarValidez
