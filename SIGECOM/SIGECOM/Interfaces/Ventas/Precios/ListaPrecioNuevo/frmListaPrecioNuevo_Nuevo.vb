...
Public Class frmListaPrecioNuevo_Nuevo
    ...
    Private Sub frmListaPrecioNuevo_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaPrecioNuevo_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaPrecioNuevo_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If state_button Then    'Modificar 
            ...
            listaCorreos()
            If iEstado <> 1 Then
                Me.Size = New System.Drawing.Size(960, 523)
                gbCorreos.Visible = False
            Else
                Me.Size = New System.Drawing.Size(960, 680)
                gbCorreos.Visible = True
            End If
            Me.Text = "LISTA PRECIO Nº " + Chr(34) + txtLista.Text.ToString + Chr(34)
            'dgvDatos.Select()
        ...
        Else                          'Nuevo
            ...
            Me.Size = New System.Drawing.Size(960, 265)

            gbEstado.Visible = False
            gbDetalle.Visible = False
            'gbCorreos.Visible = False
            Me.Text = "Registrar nueva Lista precio"
            activar()
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oListaPrecioDetService.Mostrar(IdLista).Tables(0)
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ListaPrecioCabService.ListaPrecioCab
            registro = oListaPrecioCabService.Obtener(IdLista)
    ...
    Private Sub enableOpciones()
        ...
        miFormatoExcel.Enabled = IIf(iEstado = 1, True, False)
        biFormatoExcel.Enabled = IIf(iEstado = 1, True, False)
        ...
        biAprobar.Enabled = IIf(iEstado = 2 Or iEstado = 3 Or (oListaPrecioCabService.BuscarAprobacionPendiente(IdLista) And iEstado = 4), True, False)
    ...
    Private Sub biGuardar_Click(sender As Object, e As EventArgs) Handles biGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                ...
                Dim registro As New ListaPrecioCabService.ListaPrecioCab
                Dim Moneda As New ListaPrecioCabService.Moneda
                Dim empresa As New ListaPrecioCabService.Empresa
                Dim estado As New ListaPrecioCabService.EstadoListaPrecio
    ...
    Private Sub Insertar(ByVal registro As ListaPrecioCabService.ListaPrecioCab)
        Try
            Dim estado_process As Integer
            estado_process = oListaPrecioCabService.Insertar(registro)
            type_process = "insert"
    ...
    Private Sub Modificar(ByVal registro As ListaPrecioCabService.ListaPrecioCab)
        Try
            Dim estado_process As Boolean
            estado_process = oListaPrecioCabService.Actualizar(registro)
            type_process = "update"
    ...
    Private Sub eliminarDetalle()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("CodMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                Dim estado_process As Boolean
                estado_process = oListaPrecioDetService.Borrar(dgvDatos.CurrentRow.Cells("IdListaDet").Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                If estado_process = True Then
                    dtDatos = Nothing
                    listaDatos()
                    ObtenerRegistro()
    ...
    Private Sub NuevoDetalle()
        Try
            ...
            While lLog
                Dim frm As New frmListaPrecioNuevo_Detalle
            ...
            If dgvDatos.RowCount > 0 Then
                If MsgBox("¿Está seguro de ENVIAR la Lista de Precio Nº" & txtLista.Text & " ?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    ...
                    If rows.Count <> 0 Then
                        ...
                        Dim estado_process As Boolean
                        estado_process = oListaPrecioCabService.Enviar(IdLista, Cadena, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                        ...
                        If estado_process Then
                            ...
                            enableOpciones()
                            actualizarDetalles()
                            Me.Size = New System.Drawing.Size(963, 521)
                            gbCorreos.Visible = False
                        Else
    ...
    Private Sub InsertarMasivo()
        ...
        Try
            Dim estado_process As Boolean
            estado_process = oListaPrecioDetService.InsertarMasivo(IdLista, dtInsertarMasivo, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub biAprobar_Click(sender As Object, e As EventArgs) Handles biAprobar.Click
        Try
            If txtLista.Text <> "" Then
                ...
                Dim frm As New frmListaPrecioNuevo_Aprobar
                Dim frmGer As New frmListaPrecioNuevo_AprobarGerencia
                Dim estado As Integer
