...
Public Class rpImprimirTicketPC
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpImprimirTicketPC.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirTicketPC
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirTicketPC = New rpImprimirTicketPC()
        rpt.Site = Me.Site
        Return rpt
    End Function
