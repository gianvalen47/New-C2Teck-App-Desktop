...
Public Class frmGuiaRemision_GuiaRemisionElectronica_EnviarCorreo
    ...
    Private Sub frmGuiaRemision_GuiaRemisionElectronica_EnviarCorreo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmGuiaRemision_GuiaRemisionElectronica_EnviarCorreo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmGuiaRemision_GuiaRemisionElectronica_EnviarCorreo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CargarCorreo()
        ...
        Try
            ...
            txtAsunto.Text = Session.sDesEmp & " - Guia Remision Electronica: " & Documento '"DETROIT DIESEL MTU PERU SAC - Factura Electronica: " & Documento
            txtMensaje.Text = "Envio de Guia Remision Electronica c/Adjunto xml, pdf" & Environment.NewLine & Environment.NewLine & "No Contestar el correo porque es una cuenta desatendida"
    ...
    Private Sub DescargarPDF()
        ...
        Try
            ...
            pdfDoc = oGuiaRemisionDigitalService.DescargarPdf(IdGuia)

            Dim NombreXMLPDF As String = oGuiaRemisionDigitalService.ObtenerNombre(IdGuia)

            System.IO.File.WriteAllBytes("D:\Documentos_Electronicos\GuiaRemision_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf", pdfDoc)
    ...
    Private Sub DescargarXML()
        ...
        Try
            ...
            xmlDoc.Load(New StringReader(oGuiaRemisionDigitalService.Descargar(IdGuia)))

            Dim NombreXMLPDF As String = oGuiaRemisionDigitalService.ObtenerNombre(IdGuia)

            xmlDoc.Save("D:\Documentos_Electronicos\GuiaRemision_Electronicas\" & Documento & "\" & NombreXMLPDF & ".xml")
    ...
    Private Sub DescargarCDRXML()
        ...
        Try
            ...
            Dim xmlDoc As New XmlDocument
            xmlDoc.Load(New StringReader(oGuiaRemisionDigitalService.DescargarCDR(IdGuia)))

            Dim NombreXMLPDF As String = oGuiaRemisionDigitalService.ObtenerNombre(IdGuia)

            xmlDoc.Save("D:\Documentos_Electronicos\GuiaRemision_Electronicas\" & Documento & "\R-" & NombreXMLPDF & ".xml")
    ...
    Private Sub btnVerGuiaRemision_Click(sender As Object, e As EventArgs) Handles btnVerGuiaRemision.Click
        Try

            Dim NombreXMLPDF As String = oGuiaRemisionDigitalService.ObtenerNombre(IdGuia)

            System.Diagnostics.Process.Start("D:\Documentos_Electronicos\GuiaRemision_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf")
