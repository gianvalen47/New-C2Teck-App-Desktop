Public Class frmGuiaRemision_SugerirCabecera
    ...
    Private Sub frmGuiaRemision_SugerirCabecera_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.DialogResult = System.Windows.Forms.DialogResult.Cancel
            Me.Close()
        End If
    End Sub
    Private Sub frmGuiaRemision_SugerirCabecera_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim estilo As New Estilo
        Me.Text = "Sugerir Factor - Dscto"
        state_button = oGuiaRemisionService.BuscarSugerido(IdGuia)
    ...
    Private Sub Insertar()
        Try
            ...
            estado_process = oGuiaRemisionService.InsertarSugerido(IdGuia, txtFactorSug.Text, txtDsctoSug.Text, txtObservacion.Text)
            type_process = "insert"
    ...
    Private Sub Modificar()
        Try
            ...
            estado_process = oGuiaRemisionService.ActualizarSugerido(IdSugerido, txtFactorSug.Text, txtDsctoSug.Text, txtObservacion.Text)
            type_process = "update"
    ...
    Private Sub Eliminar()
        Try
            Dim estado_process As Boolean
            estado_process = oGuiaRemisionService.BorrarSugerido(IdSugerido)
            type_process = "delete"
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As GuiaRemisionService.SugeridoGuia
            registro = oGuiaRemisionService.MostrarSugeridoPorId(IdSugerido)
    ...
    Private Sub frmGuiaRemision_SugerirCabecera_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
