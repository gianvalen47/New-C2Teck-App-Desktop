...
Public Class rpImprimirDigital
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpImprimirDigital.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirDigital
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirDigital = New rpImprimirDigital()
        rpt.Site = Me.Site
        Return rpt
    End Function
