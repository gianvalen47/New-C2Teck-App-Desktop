...
Public Class frmGenerarDocumento
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf toNumber(txtNumDoc.Text) = 0 Then
                MsgBox("Debe ingresar el Númro del documento. ", MsgBoxStyle.Information, "Información")
    ...
    Private Sub Generar()
        Try
            ...
            estado_process = oFacturaImportService.GenerarDocumento(toNull(IdFactura), toNull(cmbDocaumentos.Value), toNull(txtNumDoc.Text), toNull(txtFecha.Text))
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro que generar el docuento?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
