...
Public Class frmAgregarDetalle_Documento
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf state_button = False And oFacturaImportDetService.Buscar(registro) = 1 Then
                ...
                txtCodMer.Focus()
                Return False
            ElseIf dtPedidos.Rows.Count <> 0 Then
                If (txtCanMer.Value) > toNumber(txtCantidadPendiente.Text) Then
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro que desea guardar los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
            ...
            Else
                pedidoImpDet.IdDetPedidoImp = toNumber(cmbPedidos.DropDownList.GetRow.Cells(3).Text)
                pedidoImp.IdPedidoImp = toNumber(cmbPedidos.DropDownList.GetRow.Cells(4).Text)
            End If
    ...
    Private Sub btnBuscarMercaderia_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscarMercaderia.Click
        ...
        If frm.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            'recalculamos el mºonto total del Detalle
            ...
            If Len(Trim(txtCodMer.Text)) > 0 Then
                If btnBuscarMercaderia.Enabled = True Then
                    If oMercaderiaService.Buscar(txtCodMer.Text) Then
                        ...
                        txtalmacen.Text = IIf(llenarCombos() > 0, Nothing, "LIMA - REPUESTOS")
                        IdLocacion = IIf(llenarCombos() > 0, Nothing, 1)
                        calculateTotal()
                    Else
    ...
    Private Sub txtCodMar_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtCodMar.Validating
        Try
            If Len(Trim(txtCodMar.Text)) > 0 Then
                Dim Marca As New MarcaService.Marca
                Marca.CodMar = txtCodMar.Text
                If oMarcaService.Buscar(Marca) Then
                    Marca = oMarcaService.MostrarPorCodigo(Trim(txtCodMar.Text))
