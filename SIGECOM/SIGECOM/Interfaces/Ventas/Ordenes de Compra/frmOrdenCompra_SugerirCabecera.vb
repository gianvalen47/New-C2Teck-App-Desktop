Public Class frmOrdenCompra_SugerirCabecera
    ...
    Private Sub frmOrdenCompra_SugerirCabecera_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmOrdenCompra_SugerirCabecera_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmOrdenCompra_SugerirCabecera_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
    ...
    Private Sub frmOrdenCompra_SugerirCabecera_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Dim estilo As New Estilo
        Me.Text = "Sugerir Factor - Dscto"
        state_button = oOrdenCompraService.BuscarSugerido(IdOrden)
    ...
    Private Sub Insertar()
        Try
            ...
            estado_process = oOrdenCompraService.InsertarSugerido(IdOrden, txtFactorSug.Value, txtDsctoSug.Value, txtObservacion.Text)
            type_process = "insert"
    ...
    Private Sub Modificar()
        Try
            ...
            estado_process = oOrdenCompraService.ActualizarSugerido(IdSugerido, txtFactorSug.Text, txtDsctoSug.Text, txtObservacion.Text)
            type_process = "update"
    ...
    Private Sub Eliminar()
        Try
            Dim estado_process As Boolean
            estado_process = oOrdenCompraService.BorrarSugerido(IdSugerido)
            type_process = "delete"
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As OrdenCompraService.SugeridoOrden
            registro = oOrdenCompraService.MostrarPorIdSugerido(IdSugerido)
