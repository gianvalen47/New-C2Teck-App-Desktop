...
Public Class rptVenOrdenCompra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptVenOrdenCompra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVenOrdenCompra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVenOrdenCompra = New rptVenOrdenCompra()
        rpt.Site = Me.Site
        Return rpt
    End Function
