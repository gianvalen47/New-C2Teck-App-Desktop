...
Public Class frmSepararOrdenCompra
    ...
    Private Sub frmSepararOrdenCompra_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
