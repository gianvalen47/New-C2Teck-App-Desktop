...
Public Class frmNotaCredito_NotaElectronica_ComunicadoBaja
    ...
    Private Sub frmNotaCredito_NotaElectronica_ComunicadoBaja_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmNotaCredito_NotaElectronica_ComunicadoBaja_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmNotaCredito_NotaElectronica_ComunicadoBaja_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        Try
            Dim dtDarBaja As New DataTable

            dtDarBaja = oNotaCreditoService.ComunicacionBajaDigital(IdNota).Tables(0)
        ...
        Try
            ...
            If firmado = True Then
                ...
                Dim xmlDoc As New XmlDocument
                    ...
                    tipodoc.IdDocumento = CInt(IdDocumento) 'Credito o Debito
    ...
    Private Sub btnAceptar_Click(sender As System.Object, e As System.EventArgs) Handles btnAceptar.Click
        Try
            ...
            'If oFacturaService.ObtenerContabilizado(IdSerieDoc, NumDoc) Then
            '    MsgBox("Esta contabilizado, debe borrar el asiento contable.", MsgBoxStyle.Information)
            '    Exit Sub
            'End If
