...
Public Class rpImprimirNota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpImprimirNota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirNota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirNota = New rpImprimirNota()
        rpt.Site = Me.Site
        Return rpt
    End Function
