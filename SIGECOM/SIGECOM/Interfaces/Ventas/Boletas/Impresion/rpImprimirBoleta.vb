...
Public Class rpImprimirBoleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SYSTECK.rpImprimirBoleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirBoleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirBoleta = New rpImprimirBoleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
