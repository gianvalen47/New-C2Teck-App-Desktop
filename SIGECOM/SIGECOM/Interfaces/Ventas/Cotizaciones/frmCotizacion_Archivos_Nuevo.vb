...
Public Class frmCotizacion_Archivos_Nuevo
    ...
    Private Sub biGuardar_Click(sender As Object, e As EventArgs) Handles biGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                Dim registro As New CotizacionService.CotizacionArchivo
    ...
    Private Sub Insertar(ByVal registro As CotizacionService.CotizacionArchivo)
        Try
            IdCotizacionArchivo = oCotizacionService.InsertarArchivo(registro)
            type_process = "insert"
            If IdCotizacionArchivo > 0 Then
