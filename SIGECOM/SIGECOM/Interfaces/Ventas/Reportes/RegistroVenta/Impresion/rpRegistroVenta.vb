...
Public Class rpRegistroVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRegistroVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRegistroVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRegistroVenta = New rpRegistroVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
