...
Public Class rpResumenRegVenta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpResumenRegVenta.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CodTipo() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrpResumenRegVenta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpResumenRegVenta = New rpResumenRegVenta()
        rpt.Site = Me.Site
        Return rpt
    End Function
