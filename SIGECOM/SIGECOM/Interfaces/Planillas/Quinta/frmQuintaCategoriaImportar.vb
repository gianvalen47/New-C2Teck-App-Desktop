...
Public Class frmQuintaCategoriaImportar
    '===========================Servicios====================================================
            ...
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    If rbIngresos.Checked Then
                        estado_process = oQuintaCategoriaDetService.ImportarIngresosPlanilla(Session.sCodEmp, txtAnio.Value, txtMesRegistro.Text, IdPersona, cmbTipoPlanilla.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    ElseIf rbRetencion.Checked
                        estado_process = oQuintaCategoriaDetService.ImportarRetenidoPlanilla(Session.sCodEmp, txtAnio.Value, txtMesRegistro.Text, IdPersona, cmbTipoPlanilla.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    End If
