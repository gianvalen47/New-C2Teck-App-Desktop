...
Public Class frmQuintaCategoriaExportar
    '===========================Servicios====================================================
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oQuintaCategoriaDetService.ExportarRetencion(Session.sCodEmp, txtIdPlanilla.Text, txtAnio.Value, txtMesRegistro.Text, cmbTipoPlanilla.Value, IdPersona, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
