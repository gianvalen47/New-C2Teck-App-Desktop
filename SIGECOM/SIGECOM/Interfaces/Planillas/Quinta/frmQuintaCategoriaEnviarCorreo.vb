...
Public Class frmQuintaCategoriaEnviarCorreo
    ...
    Private Sub ListarArchivos()
        Try
            Dim d As New DirectoryInfo("D:\QuintaCategoriaElectronicas\" & Session.sDesEmp & "\" & periodo & "\" & idPer)
    ...
    Private Sub CargarCorreo()
        ...
        Try
            ...
            txtMensaje.Text = "Envio de Certificado de Quinta Categoria c/Adjunto pdf" & Environment.NewLine & Environment.NewLine
    ...
    Private Sub EnviarCorreo()
        ...
        Try
            If ValidaCamposCorreo() Then
                ...
                Dim pdfdir As String = "D:\QuintaCategoriaElectronicas\" & Session.sDesEmp & "\" & periodo.ToString() & "\" & idPer & "\" & periodo & idPer & ".pdf"
