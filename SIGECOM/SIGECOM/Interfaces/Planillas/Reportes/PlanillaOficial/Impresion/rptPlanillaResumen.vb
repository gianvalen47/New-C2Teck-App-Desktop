...
Public Class rptPlanillaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptPlanillaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pIdPlanilla() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptPlanillaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanillaResumen = New rptPlanillaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
