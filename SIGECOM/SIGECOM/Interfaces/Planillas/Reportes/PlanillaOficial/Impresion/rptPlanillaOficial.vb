...
Public Class rptPlanillaOficial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptPlanillaOficial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanillaOficial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanillaOficial = New rptPlanillaOficial()
        rpt.Site = Me.Site
        Return rpt
    End Function
