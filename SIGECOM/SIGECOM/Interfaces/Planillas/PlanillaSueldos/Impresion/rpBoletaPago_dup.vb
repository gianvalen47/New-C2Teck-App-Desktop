...
Public Class rpBoletaPago_dup
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpBoletaPago_dup.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RNumero() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrpBoletaPago_dup
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpBoletaPago_dup = New rpBoletaPago_dup()
        rpt.Site = Me.Site
        Return rpt
    End Function
