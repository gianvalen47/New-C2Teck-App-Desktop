...
Public Class rpBoletaPagoCTS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpBoletaPagoCTS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpBoletaPagoCTS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpBoletaPagoCTS = New rpBoletaPagoCTS()
        rpt.Site = Me.Site
        Return rpt
    End Function
