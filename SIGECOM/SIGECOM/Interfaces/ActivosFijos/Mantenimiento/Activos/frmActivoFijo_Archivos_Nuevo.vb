...
Public Class frmActivoFijo_Archivos_Nuevo
    ...
    Private Sub frmActivoFijo_Archivos_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmActivoFijo_Archivos_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmActivoFijo_Archivos_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub Insertar(ByVal registro As ActivoFijoService.ActivoFijoArchivos)
        Try
            IdActivoArchivo = oActivoFijoService.InsertarArchivo(registro)
            type_process = "insert"
            If IdActivoArchivo > 0 Then
