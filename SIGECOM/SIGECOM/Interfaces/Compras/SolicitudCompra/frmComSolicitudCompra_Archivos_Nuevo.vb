...
Public Class frmComSolicitudCompra_Archivos_Nuevo
    ...
    Private Sub Insertar(ByVal registro As SolicitudCompraService.SolicitudCompraArchivos)
        Try
            IdSolicitudArchivo = oSolicitudCompraService.InsertarArchivo(registro)
            type_process = "insert"
            If IdSolicitudArchivo > 0 Then
