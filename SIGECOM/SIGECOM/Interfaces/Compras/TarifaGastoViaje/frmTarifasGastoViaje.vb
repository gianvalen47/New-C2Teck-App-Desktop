...
Public Class frmTarifasGastoViaje
    ...
    Private Sub frmTarifasGastoViaje_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 165)
        '/*************************************************************************************/
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal destino As String, ByVal subrubro As String, ByVal moneda As String)
        Dim rows() As Janus.Windows.GridEX.GridEXRow
        rows = lista.GetRows
        For Each row In rows
            If row.Cells("IdDestino").Value = destino And row.Cells("IdSubRubro").Value = subrubro And row.Cells("CodMon").Value = moneda Then
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmTarifaGastoViaje          
            frm.state_button = True
            frm.IdDestino = dgvDatos.CurrentRow.Cells("IdDestino").Text
            frm.IdRubroViaje = dgvDatos.CurrentRow.Cells("IdRubro").Text
            frm.IdSubRubro = dgvDatos.CurrentRow.Cells("IdSubRubro").Text
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    listaDatos()
                    RowPossesion(dgvDatos, frm.IdDestino, frm.IdSubRubro, frm.CodMon)
                Else
                    listaDatos()
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Tarifa Seleccionada?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oSolicitudGastoDetService.BorrarTarifaGastoViaje(toNumber(dgvDatos.CurrentRow.Cells("IdDestino").Text), toNumber(dgvDatos.CurrentRow.Cells("IdSubRubro").Text), toNumber(dgvDatos.CurrentRow.Cells("IdRubro").Text), toBlank(dgvDatos.CurrentRow.Cells("CodMon").Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
        ...
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "insert" Then
                    cmbDestinoViaje.Value = frm.IdDestino
                    cmbRubroViaje.Value = frm.IdRubroViaje
                    RowPossesion(dgvDatos, frm.IdDestino, frm.IdSubRubro, frm.CodMon)
                    mostrar()
                    Actualizar()
                End If
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oSolicitudGastoDetService.FiltrarTarifaGastoViaje(CInt(cmbDestinoViaje.Value), CInt(cmbRubroViaje.Value)).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, cmbDestinoViaje.ValueChanged, cmbRubroViaje.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            destino = dgvDatos.CurrentRow.Cells("IdDestino").Text
            subrubro = dgvDatos.CurrentRow.Cells("IdSubRubro").Text
            moneda = dgvDatos.CurrentRow.Cells("CodMon").Text
        End If
        dtDatos = Nothing
        listaDatos()
        If dgvDatos.RowCount > 0 And destino.Trim.Length > 0 And subrubro.Trim.Length > 0 And moneda.Trim.Length > 0 Then
            RowPossesion(dgvDatos, destino, subrubro, moneda)
        End If
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Tarifa de Gasto de Viaje actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Tarifa de Gasto de Viaje."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Tarifa de Gasto de Viaje actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Tarifa de Gasto de Viaje actual."
    End Sub
