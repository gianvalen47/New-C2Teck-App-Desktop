...
Public Class frmAgregar_CentroCosto_CPagar
    ...
    Private Sub frmAgregar_CentroCosto_CPagar_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub

    Private Sub frmAgregar_CentroCosto_CPagar_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmAgregar_CentroCosto_CPagar_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub listaSeleccionados()
        Try
            ...
            '=================================== LISTA SELECCIONADOS ===================================          
            dtSeleccionados = oCtasPorPagarService.MostrarCentroCosto(IdCuenta).Tables(0)
    ...
    Private Sub btnBuscar_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscar.Click, cmbArea.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub btnAgregarTodos_Click(sender As System.Object, e As System.EventArgs) Handles btnAgregarTodos.Click
    ...
    Private Sub cbProrratear_CheckedChanged(sender As System.Object, e As System.EventArgs) Handles cbProrratear.CheckedChanged
    ...
    Private Sub SumarMontos()
        Try
            If dgvSeleccionados.Rows.Count > 0 Then
                ...
                Next
                txtMontoTotal.Value = Math.Round((MontoAcum), 2)
            Else
                txtMontoTotal.Value = 0.0
            End If
        Catch ex As Exception
    ...
    Private Function ValidaBalanceMontos() As Boolean
        Try
            ...
            If ContCero > 0 Then
                ...
                Return False
            ElseIf txtMontoTotal.Value <> Monto Then
    ...
    Private Sub dgvSeleccionados_CellEndEdit(sender As Object, e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgvSeleccionados.CellEndEdit
        SumarMontos()
    End Sub
                ...
                If ValidaCampos() Then
                    If ValidaBalanceMontos() Then
                        ...
                        For i As Integer = 0 To dgvSeleccionados.RowCount - 1
                            ...
                            rows(0) = 0
                            rows(1) = 0
                            rows(2) = Session.sCodUsu
                            rows(3) = Session.sNomPc
                            rows(4) = Session.sDirIp
                            rows(5) = dgvSeleccionados.Rows(i).Cells("cCodCentro1").Value
                            rows(6) = dgvSeleccionados.Rows(i).Cells("cDesCentro1").Value
                            rows(7) = dgvSeleccionados.Rows(i).Cells("cMonto").Value
                            rows(8) = dgvSeleccionados.Rows(i).Cells("cObservacion").Value

                            dtTable.Rows.Add(rows)
                        Next

                        Dim state_process As Boolean
                        state_process = oCtasPorPagarService.InsertarCentroCosto(IdCuenta, dtTable, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
