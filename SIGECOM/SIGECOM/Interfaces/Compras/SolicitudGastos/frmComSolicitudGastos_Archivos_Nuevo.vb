...
Public Class frmComSolicitudGastos_Archivos_Nuevo
    ...
    Private Sub frmComSolicitudGastos_Archivos_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmComSolicitudGastos_Archivos_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmComSolicitudGastos_Archivos_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub biGuardar_Click(sender As Object, e As EventArgs) Handles biGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                ...
                Dim solicitudgasto As New SolicitudGastoService.SolicitudGasto
    ...
    Private Sub Insertar(ByVal registro As SolicitudGastoService.SolicitudGastoArchivos)
        Try
            IdGastoArchivo = oSolicitudGastoService.InsertarArchivo(registro)
            type_process = "insert"
            If IdGastoArchivo > 0 Then
