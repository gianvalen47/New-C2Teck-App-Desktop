...
Public Class frmComSolicitudGastoNew
    ...
    '----------------------------------------------------------------------------
    Private Igv As Double = toDouble(oMaestroService.MostrarDato("SIGECOM.Maestro.Empresas", "igv", "CodEmp", Session.sCodEmp))
    ...
    Private Sub frmComSolicitudGasto_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If state_button Then    'Modificar 
            ...
            If iEstado <> 1 Then
                If iEstado = 3 Or iEstado = 5 Or iEstado = 7 Then
                    ...
                    Me.Size = New System.Drawing.Size(1088, 635)
            ...
            Else
                dgvDatos.AllowEdit = Janus.Windows.GridEX.InheritableBoolean.[False]
                Me.Size = New System.Drawing.Size(1088, 842)
        ...
        Else                          'Nuevo
            cmbMoneda.Value = "NS"
            Me.Size = New System.Drawing.Size(1088, 285)
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf (cbGastoViaje.Checked = True And (cmbArea.Value = "05" Or cmbArea.Value = "20")) And txtNumJob.Text = "" Then
                MsgBox("Debe ingresar el número la OT", MsgBoxStyle.Information, "Información")
                txtNumJob.Focus()
                Return False
    ...
    Private Sub ObtenerRegistro()
        Try
            ...
            cbGastoViaje.Checked = IIf(registro.Provisional.IdProvisional > 0, True, False) 'IIf(registro.GastoViaje Or registro.GastoViajeExt, True, False)
            ...
            Else
                ...
                txtTipoProv.Text = registro.Provisional.TipoProvisional.DesTipo
            End If
            ...
            If state_button Then
                lblSubTotal.Text = "Sub Total  " + cmbMoneda.Text
                txtTotSubtotal.Value = registro.TotSubTotal
                lblTotIgv.Text = "Total Impuestos " + cmbMoneda.Text
                txtTotIgv.Value = registro.TotIgv
                lblTotNoAfecto.Text = "Total No Afecto Al Igv  " + cmbMoneda.Text
                txtTotNoAfecto.Value = registro.TotNoAfecto
                lblTotOtroCargo.Text = "Total Otros Cargos " + cmbMoneda.Text
                txtTotOtroCargo.Value = registro.TotOtroCargo
                lblTotNeto.Text = "Total Neto " + cmbMoneda.Text
                txtTotNeto.Value = registro.TotNeto
            End If
    ...
    Private Sub cmbProvisional_ValueChanged(sender As Object, e As EventArgs) Handles cmbProvisional.ValueChanged
        If state_button = False Then
            ObtenerDatosProvisional()
        End If
    End Sub

    Private Sub ObtenerDatosProvisional()
        Try
            If cbGastoViaje.Checked Then

                If cmbProvisional.Value <> 0 Then

                    Dim registro As ProvisionalService.Provisional
                    registro = oProvisionalService.Obtener(cmbProvisional.Value)

                    txtTipoProv.Text = registro.TipoProvisional.DesTipo
                    'IdDestino = registro.DestinoViaje.IdDestino
                    ...
                    If registro.TipoProvisional.IdTipo = 1 Then
                        gbGastoViaje.Enabled = True
                        gbTipo.Enabled = True
                        rbViajeNacional.Checked = True
                    Else
