...
Public Class frmAgregar_CentroCosto_SolGastos
                ...
                For i As Integer = 0 To dgvSeleccionados.RowCount - 1
                    If AfectoIgv Then
                        If IsDBNull(dgvSeleccionados.Rows(i).Cells("cMonto").Value) Then
                            ...
                            dgvSeleccionados.Rows(i).Cells("cMontoNoAfecto").Value = 0.0
                        Else
                            dgvSeleccionados.Rows(i).Cells("cMontoSinIgv").Value = dgvSeleccionados.Rows(i).Cells("cMonto").Value / ((Igv + 100) / 100) + IIf(IsDBNull(dgvSeleccionados.Rows(i).Cells("cMontoNoAfecto").Value), 0, dgvSeleccionados.Rows(i).Cells("cMontoNoAfecto").Value)
    ...
    Private Function ValidaBalanceMontos() As Boolean
        Try
            ...
            If ContCero > 0 And AfectoIgv = True Then
                ...
                '    dgvCentroCosto.Focus()
                '    Return False
                'ElseIf txtMontoSinIgv.Value <> MontoSinIgv Then
                '    MsgBox("Los Montos seleccionados deben ser iguales a los Montos del Detalle.", MsgBoxStyle.Information, "Información")
                '    dgvCentroCosto.Focus()
                '    Return False
