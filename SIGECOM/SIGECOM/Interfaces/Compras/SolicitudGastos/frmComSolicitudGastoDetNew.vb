...
Public Class frmComSolicitudGastoDetNew
    ...
    '-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Private montonoafectoest As Boolean = False
    ...
    Private Sub frmComSolicitudGastoDet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If state_button Then                'Modificar
            ...
            If GastoViaje = True And TipProv = "VIATICO" Then
            ...
            End If
        Else                                      'Nuevo
            Me.Size = New System.Drawing.Size(677, 543)
            ...
            'txtFechaPagoDetraccion.Value = Nothing
    ...
    Private Sub llenarCombos()
        Try
            ...
            '========================================== PLACA ===============================================
            dtPlaca = oVehiculoService.MostrarUnidadesEmpresa(Session.sCodEmp).Tables(0)
    ...
    Private Sub enableOpciones()
        ...
        Else
            ...
            'miEliminarJob.Enabled = IIf(Not edicion And editable And Planilla = False And GastoViaje = False And estado = 1, True, False)      ' Comentado 10-01-24 permitir agregar eliminar ot 
            miEliminarJob.Enabled = IIf(Not edicion And editable And Planilla = False And estado = 1, True, False)
            ...
            dgvJos.RootTable.Columns("ProcesoJob").Visible = IIf((Session.CodPerfil = "01" Or Session.CodPerfil = "24" Or Session.CodPerfil = "12" Or Session.CodPerfil = "14") And (estado = 3 Or estado = 5 Or estado = 7 Or estado = 10), True, False)
            dgvJos.RootTable.Columns("CodJob").Width = IIf((Session.CodPerfil = "01" Or Session.CodPerfil = "24" Or Session.CodPerfil = "12" Or Session.CodPerfil = "14") And (estado = 3 Or estado = 5 Or estado = 7 Or estado = 10), "67", "88")
        End If

        miAsignarCentroCosto.Enabled = IIf(Not edicion And editable And Planilla = False And (GastoViaje = False Or (GastoViaje = True And TipProv <> "VIATICO")) And (estado = 1 Or ((estado = 3 Or estado = 5) And (Session.CodPerfil = "22" Or Session.CodPerfil = "01" Or Session.CodPerfil = "11" Or Session.CodPerfil = "05"))), True, False) 'Se agrega el perfiles Solicitud de Usuario 65887,65888
        ...
        'miAsignarJobs.Enabled = IIf(Not edicion And editable And Planilla = False And (GastoViaje = False Or (GastoViaje = True And TipProv <> "VIATICO")) And (estado = 1 Or ((estado = 3 Or estado = 5) And (Session.CodPerfil = "22" Or Session.CodPerfil = "01" Or Session.CodPerfil = "11" Or Session.CodPerfil = "05"))), True, False) 'Se agrega el perfiles Solicitud de Usuario 65887,65888    ' Comentado 10-01-24 permitir agregar eliminar job 
        miAsignarJobs.Enabled = IIf(Not edicion And editable And Planilla = False And (estado = 1 Or ((estado = 3 Or estado = 5) And (Session.CodPerfil = "22" Or Session.CodPerfil = "01" Or Session.CodPerfil = "11" Or Session.CodPerfil = "05"))), True, False) 'Se agrega el perfiles Solicitud de Usuario 65887,65888    
        ...
        Try
            ...
            If state_button Then    '////////////////////////////////////////////////// ACTUALIZAR ////////////////////////////////////////////////////////////
                ...
                If estado = 1 Then      '===========================  GENERADO==========================
                    ...
                    If Planilla = True Then
                        ...
                        txtMontoIgv.BackColor = System.Drawing.SystemColors.Control
                        ...
                        txtMontoOtrosCargos.BackColor = System.Drawing.SystemColors.Control
                    ...
                    Else
                        ...
                        txtMontoIgv.ReadOnly = False
                        txtMontoIgv.BackColor = System.Drawing.SystemColors.Window
                        txtMontoNoAfecto.ReadOnly = False
                        txtMontoNoAfecto.BackColor = System.Drawing.SystemColors.Window

                        txtMontoOtrosCargos.ReadOnly = False
                        txtMontoOtrosCargos.BackColor = System.Drawing.SystemColors.Window
                        ...
                        If GastoViaje = True And TipProv = "VIATICO" Then
                            If oSolicitudGastoDetService.BuscarJefe(IdPersonaSolicita) Then
                                'comentado para q no se active check
                ...
                Else      '=========================== <> GENERADO==========================
                    ...
                    If (estado = 2 Or estado = 3 Or (estado = 5 And (Session.CodPerfil = "22" Or Session.CodPerfil = "01" Or Session.CodPerfil = "11" Or Session.CodPerfil = "05" Or Session.CodPerfil = "24"))) Then 'Se agrega el perfiles Solicitud de Usuario 65887,65888
                        ...
                        If Session.CodPerfil = "22" Or Session.CodPerfil = "01" Or Session.CodPerfil = "11" Or Session.CodPerfil = "05" Or Session.CodPerfil = "24" Then 'Se agrega el perfiles Solicitud de Usuario 65887,65888
                            txtMonto.ReadOnly = False
                            txtMonto.BackColor = System.Drawing.SystemColors.Window
                            txtMontoIgv.ReadOnly = False
                            txtMontoIgv.BackColor = System.Drawing.SystemColors.Window
            ...
            Else  '////////////////////////////////////////////////// NUEVO ////////////////////////////////////////////////////////////
                ...
                Else
                    ...
                    If GastoViaje = True And TipProv = "VIATICO" Then
                        If oSolicitudGastoDetService.BuscarJefe(IdPersonaSolicita) Then
                            'comentado 06-05 desactivando check de politicas
                            'cbNoAplicaPolitica.Checked = True
                            'cbNoAplicaPolitica.Enabled = False
                            cbNoAplicaPolitica.Checked = False
                            cbNoAplicaPolitica.Enabled = True
    ...
    Private Function ValidaCampos() As Boolean
        ...
        Try
            ...
            'Comentado 27/06/23 +-------------------------------------------------------------------
            'If toNumber(cmbTipoGasto.Value) = 0 And GastoViaje = False Then '-------- 21/09/2016 --------
            '        MsgBox("Debe Ingresar el Tipo de Gasto", MsgBoxStyle.Information, "Información")
            '        cmbTipoGasto.Focus()
            '        Return False
            ...
            If toNumber(cmbTipoGasto.Value) = 0 Then 'And TipProv <> "VIATICO" Then 'comentado x pedido de equimap , guardar compras en un gasto viatico    '-------- 21/09/2016 --------
                MsgBox("Debe Ingresar el Tipo de Gasto", MsgBoxStyle.Information, "Información")
                cmbTipoGasto.Focus()
                Return False
            ElseIf toNumber(cmbRubro.Value) = 0 And dtTable.Rows.Count > 0 Then 'And TipProv <> "VIATICO"  And dtTable.Rows.Count > 0 Then '-------- 04/07/2018 --------         
                MsgBox("Debe Ingresar el Rubro", MsgBoxStyle.Information, "Información")
                cmbRubro.Focus()
                Return False
            ...
            ElseIf txtIgv.Value < 0 Then
                ...
                txtIgv.Focus()
                Return False
            ElseIf toDouble(txtMonto.Value) <= 0 And cbAfectoIgv.Checked Then    'toDouble(txtMonto.Value) <= 0 Then  ' Modificado 26-02
                MsgBox("El monto debe ser mayor a CERO.", MsgBoxStyle.Information, "Información")
                txtMonto.Focus()
                Return False
            ElseIf toDouble(txtMontoIgv.Value) <= 0 And cbAfectoIgv.Checked Then    'toDouble(txtMonto.Value) <= 0 Then  ' Modificado 26-02
                MsgBox("El monto Igv debe ser mayor a CERO.", MsgBoxStyle.Information, "Información")
                txtMontoIgv.Focus()
                Return False
            ...
            ElseIf GastoViaje = True And toNumber(cmbRubroViaje.Value) = 0 And TipProv = "VIATICO" And cmbTipoGasto.Value = 9 Then
                MsgBox("Debe Ingresar el Rubro de Viaje.", MsgBoxStyle.Information, "Información")
                cmbRubroViaje.Focus()
                Return False

            ElseIf GastoViaje = True And toNumber(cmbRubroViaje.Value) = 0 And TipProv = "VIATICO" And cmbTipoGasto.Value = 9 Then 'And oSolicitudGastoDetService.BuscarJefe(IdPersonaSolicita) = False 
                MsgBox("Debe Ingresar el SubRubro de Viaje.", MsgBoxStyle.Information, "Información")
                cmbSubRubroViaje.Focus()
                Return False
                '----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    Private Sub ObtenerRegistro()
        Try
            ...
            Else
                cmbTipoDoc.SelectedIndex = 0
            End If
            txtMonto.Value = registro.TotSubTotal
            txtMontoSinIgv.Value = registro.MontoSinIgv
            txtMontoIgv.Value = registro.TotIgv
            txtMontoNoAfecto.Value = registro.TotNoAfecto
            txtMontoOtrosCargos.Value = registro.TotOtroCargo
            txtMontoTotal.Value = registro.TotNeto
            montonoafectoest = True
            cbAfectoIgv.Checked = registro.Afecto
            montonoafectoest = False
    ...
    Private Sub NuevoCentroCosto()
        Try
            ...
            frm.IdGasto = IdGasto
            frm.Monto = txtMontoTotal.Value  'txtMonto.Value
            ...
            frm.SubTotal = txtMonto.Value
            frm.totalIgv = txtMontoIgv.Value
            frm.totalNoAfecto = txtMontoNoAfecto.Value
            frm.totalOtroCargo = txtMontoOtrosCargos.Value
            frm.totalNeto = txtMontoTotal.Value
            frm.IdDocumento = cmbTipoDoc.Value
    ...
    Private Sub NuevoJob()
        Try
            ...
            Dim MontoServicio As Double = 0.0
                ...
                Dim TotSubTotalServicio As Double = 0.00
                Dim TotIgvServicio As Double = 0.0
                Dim TotNoAfectoServicio As Double = 0.0
                Dim TotOtroCargoServicio As Double = 0.0
                ...
                For i = 0 To Me.dgvCentrosCosto.RowCount - 1
                    ...
                    ' If row.Cells("IdUnidad").Value = 2 Or row.Cells("IdUnidad").Value = 3 Then
                    MontoServicio = MontoServicio + toDouble(row.Cells("Monto").Value)
                        ...
                        TotSubTotalServicio = TotSubTotalServicio + toDouble(row.Cells("TotSubTotal").Value)
                        TotIgvServicio = TotIgvServicio + toDouble(row.Cells("TotIgv").Value)
                        TotNoAfectoServicio = TotNoAfectoServicio + toDouble(row.Cells("TotNoAfecto").Value)
                        TotOtroCargoServicio = TotOtroCargoServicio + toDouble(row.Cells("TotOtroCargo").Value)
                ...
                frm.IdDocumento = cmbTipoDoc.Value
                frm.SubTotal = TotSubTotalServicio
                frm.totalIgv = TotIgvServicio
                frm.totalNoAfecto = TotNoAfectoServicio
                frm.totalOtroCargo = TotOtroCargoServicio
                frm.totalNeto = TotSubTotalServicio + (TotIgvServicio * IIf(cmbTipoDoc.Value = 38, -1, 1)) + TotNoAfectoServicio + TotOtroCargoServicio
                ...
                End If
            'Else
            '    MsgBox("Debe ingresar un Centro de Costo de Servicios....", MsgBoxStyle.Information, "Información")
            'End If
        Catch ex As Exception
            MsgBox("ERROR AL ASIGNAR OT: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub ActualizarDetallesJob()
        Try
            ...
            enableOpciones()
        Catch ex As Exception
            MsgBox("ERROR AL ACTUALIZAR DETALLES OT: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    Dim tipoDetraccion As New SolicitudGastoDetService.TipoDetraccion
                    ...
                    '                    TipoGasto.IdTipoGasto = IIf(GastoViaje And TipProv = "VIATICO", 7, cmbTipoGasto.Value) '28/06/23
                    ...
                    registro.Monto = txtMontoTotal.Value - txtMontoNoAfecto.Value
                    registro.MontoSinIgv = txtMontoSinIgv.Value
                    registro.MontoNoAfecto = txtMontoNoAfecto.Value

                    registro.TotSubTotal = txtMonto.Value
                    registro.TotIgv = txtMontoIgv.Value
                    registro.TotOtroCargo = txtMontoOtrosCargos.Value
    ...
    Private Sub CalcularMontos()
        ...
        Dim montoIgv As Double = 0
        If cmbTipoDoc.Value = 38 Then
            Dim igvhn As Integer = 8
            montoIgv = IIf(cbAfectoIgv.Checked = True, Math.Round(txtMonto.Value * (igvhn / 100), 2), 0)
            MontoSinIgv = txtMonto.Value + txtMontoNoAfecto.Value 'IIf(cbAfectoIgv.Checked = True, txtMonto.Value + txtMontoNoAfecto.Value, txtMontoNoAfecto.Value)
        Else
            montoIgv = IIf(cbAfectoIgv.Checked = True, Math.Round(txtMonto.Value * (txtIgv.Value / 100), 2), 0)
            MontoSinIgv = txtMonto.Value + txtMontoNoAfecto.Value + txtMontoOtrosCargos.Value  'IIf(cbAfectoIgv.Checked = True, txtMonto.Value + txtMontoNoAfecto.Value, txtMontoNoAfecto.Value)
        End If
        ...
        txtMontoTotal.Value = IIf(cmbTipoDoc.Value = 38, txtMonto.Value + txtMontoNoAfecto.Value - txtMontoIgv.Value, txtMonto.Value + txtMontoNoAfecto.Value + txtMontoIgv.Value + txtMontoOtrosCargos.Value)
        'txtMontoIgv.Value = txtMonto.Value - txtMontoSinIgv.Value                                                      'Comentado 26-02
        txtMontoIgv.Value = montoIgv
    ...
    Private Sub cmbTipoDoc_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbTipoDoc.ValueChanged
        ...
        If cmbTipoDoc.Value = 38 Then
            lblGrabadas.Location = New Point(410, 15)
            lblGrabadas.Text = "Total por Honorarios"
            lblImpuesto.Location = New Point(419, 36)
            lblImpuesto.Text = "Retención (8 %) IR"
            lblTotalNeto.Location = New Point(412, 99)
            lblTotalNeto.Text = "Total Neto Recibido"
        Else
            lblGrabadas.Location = New Point(460, 15)
            lblGrabadas.Text = "Total Venta"
            lblImpuesto.Location = New Point(471, 36)
            lblImpuesto.Text = "Total IGV"
            lblTotalNeto.Location = New Point(466, 99)
    ...
    Private Sub cbAfectoIgv_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbAfectoIgv.CheckedChanged
        If cbAfectoIgv.Checked = False Then
            ...
            If montonoafectoest = False Then
                txtMontoNoAfecto.Value = 0
            End If
        ...
        ElseIf cbAfectoIgv.Checked = True Then
            ...
            Dim Igv As Double = toDouble(oMaestroService.MostrarDato("SIGECOM.Maestro.Empresas", "igv", "CodEmp", Session.sCodEmp))

            txtIgv.Value = IIf(iIgv = 0, Igv, iIgv)
    ...
    Private Sub txtMontoNoAfecto_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMontoNoAfecto.TextChanged
        txtMontoTotal.Value = txtMonto.Value + txtMontoIgv.Value + txtMontoNoAfecto.Value + txtMontoOtrosCargos.Value
        'Agregado 26-02-15
        'If cbAfectoIgv.Checked = False Then
        txtMontoSinIgv.Value = txtMontoNoAfecto.Value + txtMonto.Value + txtMontoOtrosCargos.Value
        'End If
    End Sub
    ...
    Private Sub btnAgregarProveedor_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAgregarProveedor.Click
        ...
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                IdProveedor = frm.IdProveedor
                txtProveedor.Text = frm.txtDesCli.Text
            End If
        Catch ex As Exception
    ...
    Private Sub cbAfectoIgv_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If e.KeyChar = ChrW(Keys.Enter) Or e.KeyChar = ChrW(Keys.Tab) Then
            e.Handled = True
            txtMonto.Focus()
        End If
    ...
    Private Sub txtXmlFE_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtXmlFE.KeyDown
        If e.KeyCode = Keys.F12 Then
            If btnBuscarXml.Enabled = True Then
                e.Handled = True
                btnBuscarXml_Click(sender, e)
            End If
        End If
    End Sub

    Private Sub txtPdfFE_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtPdfFE.KeyDown
        If e.KeyCode = Keys.F12 Then
            If btnBuscarPdf.Enabled = True Then
                e.Handled = True
                btnBuscarPdf_Click(sender, e)
            End If
        End If
    End Sub
    ...
    Private Sub mostrarJob()
        Try
            ...
            RowPossesionJob(dgvJos, frm.CodJob)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR OT: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminarJob()
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR OT:" + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrarComprasJob()
        Try
            ...
            If iCodJob <> "" Or iCodJob <> Nothing Then
                ...
                End If
            Else
                MsgBox("¡Este detalle no presenta Nro de OT....!")
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR COMPRAS DE OT: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
        ...
        Try
            ...
            If txtXmlFE.Text <> "" Then
                ...
                If (TipoDocumento = "E" Or TipoDocumento = "R") And SerNumDoc7 = "" Then  '' Recibo por Honorarios
                    cmbTipoDoc.Value = 38 'Recibo por Honorarios
                Else
                ...
                Dim xPathChargeTotalAmountString = "/ns:Invoice/cac:LegalMonetaryTotal/cbc:ChargeTotalAmount"
                Dim oNodeChargeTotalAmount = xmlDocR.SelectSingleNode(xPathChargeTotalAmountString, namespaces)
                ' Dim ChargeTotalAmount As Double = CDbl(oNodeChargeTotalAmount.InnerText)
                Dim ChargeTotalAmount As Double
                If oNodeChargeTotalAmount Is Nothing Then
                    ChargeTotalAmount = 0
                Else
                    ChargeTotalAmount = CDbl(oNodeChargeTotalAmount.InnerText)
                End If


                '===================================================
                'Obtener Porcentaje IGV
                Dim xPathTaxAmountPercentString = "/ns:Invoice/cac:InvoiceLine/cac:TaxTotal/cac:TaxSubtotal/cac:TaxCategory/cbc:Percent"
                Dim oNodeTaxAmountPercent = xmlDocR.SelectSingleNode(xPathTaxAmountPercentString, namespaces)
                Dim Percent As Double = CDbl(oNodeTaxAmountPercent.InnerText)
                ...
                If cmbTipoDoc.Value = 2 Or cmbTipoDoc.Value = 3 Then

                    txtMonto.Value = LineExtensionAmount
                    txtMontoIgv.Value = TaxAmount
                    txtMontoNoAfecto.Value = PayableAmount - (TaxAmount + ChargeTotalAmount + LineExtensionAmount)
                    txtMontoOtrosCargos.Value = ChargeTotalAmount
                    txtMontoTotal.Value = txtMonto.Value + txtMontoIgv.Value + txtMontoNoAfecto.Value + txtMontoOtrosCargos.Value
                    txtIgv.Value = Percent

                ElseIf cmbTipoDoc.Value = 38

                    txtMonto.Value = PayableAmount + TaxAmount
                    txtMontoIgv.Value = TaxAmount
                    txtMontoNoAfecto.Value = 0 'PayableAmount - (TaxAmount + ChargeTotalAmount + LineExtensionAmount)
                    txtMontoOtrosCargos.Value = 0 ' ChargeTotalAmount
                    txtMontoTotal.Value = PayableAmount
    ...
    Private Sub ObtenerDatosXMLRHE()

     End Sub

    Private Sub ObtenerDatosXML()
    ...
    Private Sub txtMontoIgv_TextChanged(sender As Object, e As EventArgs) Handles txtMontoIgv.TextChanged
        txtMontoTotal.Value = IIf(cmbTipoDoc.Value = 38, txtMonto.Value + txtMontoNoAfecto.Value - txtMontoIgv.Value, txtMonto.Value + txtMontoNoAfecto.Value + txtMontoIgv.Value + txtMontoOtrosCargos.Value)
        txtMontoSinIgv.Value = txtMonto.Value + txtMontoNoAfecto.Value + txtMontoOtrosCargos.Value
    End Sub

    Private Sub txtMontoOtrosCargos_TextChanged(sender As Object, e As EventArgs) Handles txtMontoOtrosCargos.TextChanged
        txtMontoTotal.Value = txtMonto.Value + txtMontoIgv.Value + txtMontoNoAfecto.Value + txtMontoOtrosCargos.Value
