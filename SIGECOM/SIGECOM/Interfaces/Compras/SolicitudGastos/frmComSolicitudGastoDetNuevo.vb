...
Public Class frmComSolicitudGastoDetNuevo
    ...
    Private Sub frmComSolicitudGastoDet_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If state_button Then                'Modificar
            ...
            End If
        Else                                      'Nuevo
            Me.Size = New System.Drawing.Size(674, 524)
    ...
    Private Function ValidaCampos() As Boolean
        ...
        Try
            ...
            ElseIf txtIgv.Value < 0 Then
                ...
                txtIgv.Focus()
                Return False
                'ElseIf toDouble(txtMonto.Value) <= 0 Then    'toDouble(txtMonto.Value) <= 0 Then  ' Modificado 26-02
    ...
    Private Sub ObtenerRegistro()
        Try
            ...
            Else
                cmbTipoDoc.SelectedIndex = 0
            End If
            txtMonto.Value = registro.MontoSinIgv - registro.MontoNoAfecto   'registro.Monto 
            ...
            txtMontoIgv.Value = IIf(toNumber(cmbTipoDoc.Value) = 38, registro.MontoSinIgv - registro.Monto, registro.Monto - (registro.MontoSinIgv - registro.MontoNoAfecto))
    ...
    Private Sub NuevoCentroCosto()
        Try
            Dim frm As New frmAgregar_CentroCosto_SolGastos
            frm.IdGastoDet = IdGastoDet
            frm.IdGasto = IdGasto
            frm.Monto = txtMontoTotal.Value - txtMontoNoAfecto.Value      'txtMonto.Value
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    End If
                    '-------------------------------------------------------------------------------------------
                    tipoDetraccion.CodDetraccion = Nothing
    ...
    Private Sub CalcularMontos()
        ...
        txtMontoTotal.Value = IIf(cmbTipoDoc.Value = 38, txtMonto.Value + txtMontoNoAfecto.Value - txtMontoIgv.Value, txtMonto.Value + txtMontoNoAfecto.Value + txtMontoIgv.Value)
    ...
    Private Sub txtMontoNoAfecto_TextChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMontoNoAfecto.TextChanged
        txtMontoTotal.Value = txtMonto.Value + txtMontoIgv.Value + txtMontoNoAfecto.Value
        'Agregado 26-02-15
        'If cbAfectoIgv.Checked = False Then
        txtMontoSinIgv.Value = txtMontoNoAfecto.Value + txtMonto.Value
        'End If
    End Sub
    ...
    Private Sub txtMontoIgv_TextChanged(sender As Object, e As EventArgs) Handles txtMontoIgv.TextChanged
        txtMontoTotal.Value = IIf(cmbTipoDoc.Value = 38, txtMonto.Value + txtMontoNoAfecto.Value - txtMontoIgv.Value, txtMonto.Value + txtMontoNoAfecto.Value + txtMontoIgv.Value)
        txtMontoSinIgv.Value = txtMonto.Value + txtMontoNoAfecto.Value
    End Sub

    Private Sub txtMontoOtrosCargos_TextChanged(sender As Object, e As EventArgs)
        txtMontoTotal.Value = txtMonto.Value + txtMontoIgv.Value + txtMontoNoAfecto.Value
