...
Public Class frmCapacitaciones
    ...
    '==========================Evento Load===================================================
    Private Sub frmCapacitaciones_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 238)
        '/*************************************************************************************/
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdCapacitacion").Value = codigo Then
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdCapacitacion = dgvDatos.CurrentRow.Cells("IdCapacitacion").Text
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    RowPossesion(dgvDatos, frm.IdCapacitacion)
                Else
            ...
            RowPossesion(dgvDatos, frm.IdCapacitacion)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR LA CAPACITACIÓN: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Capacitación seleccionada?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oCapacitacionService.Borrar(toNumber(dgvDatos.CurrentRow.Cells("IdCapacitacion").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR LA CAPACITACIÓN: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Nuevo()
        Try
            ...
            End While
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR NUEVA CAPACITACIÓN: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub llenarCombos()
        Try
            ...
            '======================================== TIPO =================================================
            dtTipo = oCapacitacionService.MostrarTipos()
            dtTipo.Rows.InsertAt(getRowTodos1(dtTipo), 0)
            cmbTipoCapac.DataSource = dtTipo
            cmbTipoCapac.DropDownList.DataMember = dtTipo.Columns("Descripcion").ToString
            cmbTipoCapac.DropDownList.DisplayMember = dtTipo.Columns("Descripcion").ToString
            cmbTipoCapac.DropDownList.ValueMember = dtTipo.Columns("Descripcion").ToString
            cmbTipoCapac.DropDownList.Columns(0).DataMember = dtTipo.Columns("Descripcion").ToString
            cmbTipoCapac.DropDownList.Columns(1).DataMember = dtTipo.Columns("Descripcion").ToString
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oCapacitacionService.Filtrar(Session.sCodEmp, toNumber(txtanio.Value), cmbCodArea.Value, cmbCentroCosto.Value, IIf(cmbTipoCapac.SelectedIndex = 0, "", cmbTipoCapac.Value), txtNomCurso.Text, IdProveedor, IdPersona).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtanio.ValueChanged, cmbCentroCosto.ValueChanged, txtColaborador.TextChanged, txtProveedor.TextChanged, cmbTipoCapac.ValueChanged, txtNomCurso.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdCapacitacion").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Capacitación de Personal actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Capacitación de Personal."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Capacitación de Personal actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Capacitación de Personal actual."
    End Sub
    Private Sub AprobarMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biAprobarMasivo.MouseEnter, miAprobarMasivo.MouseEnter
        sslError.Text = "Ingresar Capacitaciones de Personal Masivo."
    End Sub
