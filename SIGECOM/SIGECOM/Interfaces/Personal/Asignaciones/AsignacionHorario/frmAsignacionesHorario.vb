...
Public Class frmAsignacionesHorario
    ...
    '==========================Evento Load===================================================
    Private Sub frmAsignacionesHorario_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 215)
        '/*************************************************************************************/
    ...
    '==========================Evento FormClosed=============================================
    Private Sub frmAsignacionesHorario_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    '==========================Evento KeyDown===============================================
    Private Sub frmAsignacionesHorario_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oAsignacionHorarioService.Filtrar(Session.sCodEmp, cmbCodArea.Value, cmbCentroCosto.Value, cmbHorario.Value, IdPersona).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, cmbHorario.ValueChanged, cmbCentroCosto.ValueChanged, txtColaborador.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmAsignacionHorario
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oAsignacionHorarioService.Borrar(toNumber(dgvDatos.CurrentRow.Cells("IdPer").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Asignación de Horario actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Asignación de Horario."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Asignación de Horario actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Asignación de Horario actual."
    End Sub
    ...
    Private Sub biImprimir_Click(sender As Object, e As EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            Dim frm As New frmAsignacionHorario_Imprimir
            frm.CodHor = IIf(toBlank(cmbHorario.Value) = "", "", cmbHorario.Value)
            frm.CodArea = IIf(toBlank(cmbCodArea.Value) = "", "", cmbCodArea.Value)
            frm.CodCentro = IIf(toBlank(cmbCentroCosto.Value) = "", "", cmbCentroCosto.Value)
            frm.IdPersona = IdPersona
            frm.ShowDialog()
        Catch ex As Exception
            MsgBox("Error al IMPRIMIR Listado de Asignación de Horarios : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
End Class