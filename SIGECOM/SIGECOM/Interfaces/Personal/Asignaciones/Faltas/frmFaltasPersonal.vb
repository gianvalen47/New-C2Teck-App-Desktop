...
Public Class frmFaltasPersonal
    ...
    Private IdFalta As Integer
    Private dtDatos As DataTable
    Private dtAreas As DataTable
    Private dtMotivo As DataTable
    Private dtCentroCosto As DataTable
    Private dtMeses As New DataTable
    Private iPagado As Boolean                'Check de pagado

    '==========================Evento Load===================================================
    Private Sub FaltasPersonal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 206)
        '/*************************************************************************************/
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdFalta").Value = codigo Then
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmFaltaPersonal
            frm.state_button = True
            frm.IdFalta = dgvDatos.CurrentRow.Cells("IdFalta").Text
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    RowPossesion(dgvDatos, frm.IdFalta)
                Else
            ...
            RowPossesion(dgvDatos, frm.IdFalta)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR LA FALTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Falta seleccionada?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oFaltasService.Borrar(toNumber(dgvDatos.CurrentRow.Cells("IdFalta").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR LA FALTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Nuevo()
        Try
            ...
            End While
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR NUEVA FALTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biAprobarMasivo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biAprobarMasivo.Click, miAprobarMasivo.Click
        Try
            Dim frm As New frmFaltaPersonalMasivo
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            MsgBox("Error al generar FALTAS MASIVO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oFaltasService.Filtrar(Session.sCodEmp, txtanio.Value, cmbMes.Value, cmbCodArea.Value, cmbCentroCosto.Value, cmbMotivo.Value, IdPersona, Session.sCodUsu).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtanio.ValueChanged, cmbCentroCosto.ValueChanged, cmbMotivo.ValueChanged, txtColaborador.TextChanged, cmbMes.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdFalta").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub biImprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            If ValidaCodigoSeleccionado() Then
                ...
                Dim reporte As New rptFaltaPersonal

                dtReporte = oFaltasService.Imprimir(toNumber(dgvDatos.CurrentRow.Cells("IdFalta").Value)).Tables(0)
                ...
                Else
                    ...
                    End If
                    forma.Text = "Reporte de Falta de Personal"
                    forma.ShowDialog()
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub biImprimirMasivo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biImprimirMasivo.Click, miImprimirMasivo.Click
        Try
            Dim frm As New frmFaltaPersonal_Imprimir
            frm.iCodArea = cmbCodArea.Value
            frm.iCodCentro = cmbCentroCosto.Value
            frm.iCodMotivo = cmbMotivo.Value
            frm.ShowDialog()
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub Limpiar_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
                              ...
                              biImprimirMasivo.MouseLeave, miImprimirMasivo.MouseLeave, biImpCronogramaMinas.MouseLeave, miImpCronogramaMinas.MouseLeave
        sslError.Text = ""
    End Sub
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Falta de Personal actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Falta de Personal."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Falta de Personal actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Falta de Personal actual."
    End Sub
    Private Sub AprobarMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biAprobarMasivo.MouseEnter, miAprobarMasivo.MouseEnter
        sslError.Text = "Ingresar Faltas de Personal Masivo."
    End Sub
    Private Sub ImprimirMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biImprimirMasivo.MouseEnter, miImprimirMasivo.MouseEnter
        sslError.Text = "Imprimir Faltas de Personal Masivo."
    End Sub
    ...
    End Sub
    Private Sub ImportarCronograma_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biImpCronogramaMinas.MouseEnter, miImpCronogramaMinas.MouseEnter
        sslError.Text = "Importar Cronograma de Minas."
    End Sub

    Private Sub miImpCronogramaMinas_Click(sender As System.Object, e As System.EventArgs) Handles miImpCronogramaMinas.Click, biImpCronogramaMinas.Click
        Try
            Dim frm As New frmImpCronogramaMina
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            MsgBox("Error al IMPORTAR Cronograma Minas: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub miActivar_Click(sender As Object, e As EventArgs) Handles miActivar.Click, biActivar.Click
        Try
            cmbOpciones.Visible = False
            If MsgBox("¿Está seguro de ACTIVAR la Falta seleccionada?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oFaltasService.RevertirPagado(toNumber(dgvDatos.CurrentRow.Cells("IdFalta").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                If estado_process = True Then
                    dtDatos = Nothing
                    Actualizar()
                    MsgBox("Se eliminó el registro correctamente.", MsgBoxStyle.Information)
    ...
    Private Sub biCompensarHoras_Click(sender As Object, e As EventArgs) Handles biCompensarHoras.Click, miCompensarHoras.Click
        Try
            Dim lLog As Boolean = True
            While lLog
                Dim frm As New frmFaltaPersonalConpensarHoras
                frm.state_button = False
                frm.iIdPersona = IdPersona
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    dtDatos = Nothing
