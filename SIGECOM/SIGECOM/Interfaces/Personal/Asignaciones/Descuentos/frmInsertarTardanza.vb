...
Public Class frmInsertarTardanza
    ...
    Private Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            If MsgBox("¿Está seguro de INSERTAR los permisos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    Dim estado_process As Boolean
                    estado_process = oDescuentoPersonalService.InsertarTardanzas(Session.sCodEmp, toBlank(cmbClase.Value), txtFecha.Value, txtFecInicio.Value, txtFecFinal.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    If estado_process = True Then
                        MsgBox("Se Insertó las tardanzas correctamente.")
            ...
            End If
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "Error al Insertar Tardanzas")
        End Try
    End Sub
End Class