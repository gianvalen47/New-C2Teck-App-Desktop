...
Public Class frmInsertarPermisos
        ...
        Try
            If MsgBox("¿Está seguro de INSERTAR los permisos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oDescuentoPersonalService.InsertarPermisos(Session.sCodEmp, toBlank(cmbClase.Value), txtFecInicio.Value, txtFecFinal.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                    If estado_process = True Then
                        MsgBox("Se Insertó los permisos correctamente.")
            ...
            End If
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Critical, "Error al Insertar Permisos")
        End Try
    End Sub
End Class