...
Public Class frmIngresosPersonal
    ...
    '==========================Evento Load===================================================
    Private Sub frmIngresosPersonal_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Try

            '/************************** Insertar Opciones de Session ************************/
            oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 212)
            '/*************************************************************************************/
    ...
    '==========================Evento FormClosed=============================================
    Private Sub frmIngresosPersonal_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdIngreso").Value = codigo Then
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oIngresoPersonalService.Filtrar(Session.sCodEmp, txtanio.Value, cmbCodArea.Value, cmbCentroCosto.Value, toNumber(cmbIngreso.Value), IdPersona).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, cmbIngreso.ValueChanged, cmbCentroCosto.ValueChanged, txtColaborador.TextChanged, txtanio.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdIngreso").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmIngresosPersonal_Nuevo
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdIngreso)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVO INGRESO DE PERSONAL: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR INGRESO DE PERSONAL: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdIngreso = dgvDatos.CurrentRow.Cells("IdIngreso").Text
            ...
            RowPossesion(dgvDatos, frm.IdIngreso)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR INGRESO DE PERSONAL: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub biIngresarMasivo_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biIngresarMasivo.Click, miIngresoMasivo.Click
        Try
            Dim frm As New frmIngresosPersonal_Masivo
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            ...
            MsgBox("Error al generar INGRESO MASIVO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Limpiar_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
                        ...
                        biEliminar.MouseLeave, miEliminar.MouseLeave, biIngresarMasivo.MouseLeave, miIngresoMasivo.MouseLeave, _
                        biActualizar.MouseLeave, miActualizar.MouseLeave, biSalir.MouseLeave, miSalir.MouseLeave, _
                        biFormatoExcel.MouseLeave, miFormatoExcel.MouseLeave, biImportarExcel.MouseLeave, miImportarExcel.MouseLeave, _
                        biIngresarBonosMina.MouseLeave, biIngresarBonosMina.MouseLeave
        sslError.Text = ""
    End Sub
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Ingreso de Personal actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo Ingreso de Personal."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Ingreso de Personal actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Ingreso de Personal actual."
    End Sub
    Private Sub IngresoMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biIngresarMasivo.MouseEnter, miIngresoMasivo.MouseEnter
        sslError.Text = "Ingreso de Personal masivo."
    End Sub
    ...
    End Sub
    Private Sub IngresosBonoMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biIngresarBonosMina.MouseEnter, miIngresarBonosMina.MouseEnter
        sslError.Text = "Ingresar Bonos / Vales de Alimentos de Mina."
    End Sub
    Private Sub IngresosCuotas_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biCuotas.MouseEnter, miCuotas.MouseEnter
        sslError.Text = "Ingresar Cuotas"
    End Sub
    ...
    Private Sub FormatoExcel()
        ...
        dtExcel.Columns.Add(New DataColumn("IdRubroIng", Type.GetType("System.String")))
            ...
            If MsgBox("¿Está seguro de IMPORTAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                ...
                If dgvImportarExcel.RowCount > 0 Then
                    For Each fila As DataGridViewRow In dgvImportarExcel.Rows
                        ...
                        registro.IdIngreso = 0
                        Persona.IdPer = toNumber(fila.Cells("IdPersona").Value)
                        registro.Persona = Persona
                        RubroIngreso.IdRubroIng = Convert.ToInt16(fila.Cells("IdRubroIng").Value)
                        ...
                        registro.Monto = IIf(Convert.ToString(fila.Cells("Monto").Value) = "", Nothing, Convert.ToDouble(fila.Cells("Monto").Value))
    ...
    Private Sub biIngresarBonosMina_Click(sender As System.Object, e As System.EventArgs) Handles biIngresarBonosMina.Click, miIngresarBonosMina.Click
        Try
            Dim frm As New frmIngresoPersonal_BonosMina
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            MsgBox("Error al INSERTAR BONOS / VALES DE ALIMENTOS DE MINA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub biCuotas_Click(sender As Object, e As EventArgs) Handles biCuotas.Click, miCuotas.Click
        Try
            Dim frm As New frmIngresoPersonal_Cuotas
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            MsgBox("Error al INSERTAR CUOTAS: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub miDescandoMedico_Click(sender As Object, e As EventArgs) Handles miDescandoMedico.Click
        Try
            Dim frm As New frmIngresoPersonal_IngresoDescansoMedico
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
    ...
    Private Sub miIngresosubsidios_Click(sender As Object, e As EventArgs) Handles miIngresosubsidios.Click
        Try
            Dim frm As New frmIngresoPersonal_IngresoSubsidios
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
