...
Public Class rptAsignacionJefe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptAsignacionJefe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsignacionJefe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsignacionJefe = New rptAsignacionJefe()
        rpt.Site = Me.Site
        Return rpt
    End Function
