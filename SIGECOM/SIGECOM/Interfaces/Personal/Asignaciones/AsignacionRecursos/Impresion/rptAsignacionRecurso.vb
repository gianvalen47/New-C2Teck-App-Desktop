...
Public Class rptAsignacionRecurso
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptAsignacionRecurso.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptAsignacionRecurso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsignacionRecurso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsignacionRecurso = New rptAsignacionRecurso()
        rpt.Site = Me.Site
        Return rpt
    End Function
