...
Public Class frmRepContratos
    ...
    Private Sub frmRepContratos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub frmRepContratos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 240)
        '/*************************************************************************************/
    ...
    Private Sub frmRepContratos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub ListarColumnas()
        Try
            ...
            dtColumnas = oContratoPersonaService.MostrarAtributos
    ...
    Private Sub btnAceptarP_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptarP.Click
        Try
            If ValidaCampos() Then
                oSeguridadService.RegistrarVisitaOpciones(240, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                If rbPrincipal.Checked = True Then

                    Dim forma As New frmReportes
                    Dim reporte As New rptRepContratos
                    Dim dtReporte As New DataTable

                    dtReporte = oContratoPersonaService.Reporte(Session.sCodEmp, toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), _
                                                                                        toBlank(cmbClase.Value), IIf(cbVigente.Checked = True, True, False)).Tables(0)
                    ...
                    Else
                        ...
                        End If
                        forma.Text = "Reporte de Contrato de Personal"
            ...
            If ValidaCampos() Then
                ...
                If rbDinamico.Checked = True Then
                    ...
                    If oSeguridadService.ObtenerExpDatos(Session.sCodUsu) = False Then
                        MsgBox("No tienes permisos para exportar datos!!!!!!!")
                        Return
                    End If
                    ...
                    If rows.Count > 0 Then
                        ...
                        dtDatosExcel = oContratoPersonaService.ReporteDinamico(Session.sCodEmp, toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value),
