...
Public Class rptRepTardanzasRef
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepTardanzasRef.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepTardanzasRef
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepTardanzasRef = New rptRepTardanzasRef()
        rpt.Site = Me.Site
        Return rpt
    End Function
