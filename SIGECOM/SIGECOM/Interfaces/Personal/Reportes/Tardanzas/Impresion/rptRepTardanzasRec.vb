...
Public Class rptRepTardanzasRec
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepTardanzasRec.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepTardanzasRec
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepTardanzasRec = New rptRepTardanzasRec()
        rpt.Site = Me.Site
        Return rpt
    End Function
