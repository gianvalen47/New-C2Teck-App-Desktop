...
Public Class rptOnomasticos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptOnomasticos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOnomasticos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOnomasticos = New rptOnomasticos()
        rpt.Site = Me.Site
        Return rpt
    End Function
