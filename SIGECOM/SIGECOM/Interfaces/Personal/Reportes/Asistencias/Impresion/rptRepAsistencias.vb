...
Public Class rptRepAsistencias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepAsistencias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepAsistencias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepAsistencias = New rptRepAsistencias()
        rpt.Site = Me.Site
        Return rpt
    End Function
