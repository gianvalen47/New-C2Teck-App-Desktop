...
Public Class rptRepPersonal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepPersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepPersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepPersonal = New rptRepPersonal()
        rpt.Site = Me.Site
        Return rpt
    End Function
