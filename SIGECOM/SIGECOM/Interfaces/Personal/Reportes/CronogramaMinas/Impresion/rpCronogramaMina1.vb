...
Public Class rpCronogramaMina
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpCronogramaMina.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpCronogramaMina
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpCronogramaMina = New rpCronogramaMina()
        rpt.Site = Me.Site
        Return rpt
    End Function
