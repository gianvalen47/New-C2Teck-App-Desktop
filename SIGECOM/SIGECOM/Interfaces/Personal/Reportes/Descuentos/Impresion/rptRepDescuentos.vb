...
Public Class rptRepDescuentos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepDescuentos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepDescuentos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepDescuentos = New rptRepDescuentos()
        rpt.Site = Me.Site
        Return rpt
    End Function
