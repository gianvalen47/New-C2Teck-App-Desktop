...
Public Class rpRepGerGastosJob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepGerGastosJob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepGerGastosJob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepGerGastosJob = New rpRepGerGastosJob()
        rpt.Site = Me.Site
        Return rpt
    End Function
