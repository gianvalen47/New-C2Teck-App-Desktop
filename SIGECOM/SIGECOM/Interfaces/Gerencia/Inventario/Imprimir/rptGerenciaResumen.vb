...
Public Class rptGerenciaResumen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptGerenciaResumen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGerenciaResumen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGerenciaResumen = New rptGerenciaResumen()
        rpt.Site = Me.Site
        Return rpt
    End Function
