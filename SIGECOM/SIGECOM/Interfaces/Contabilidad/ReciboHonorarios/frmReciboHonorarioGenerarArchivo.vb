...
Public Class frmReciboHonorarioGenerarArchivo

    '===========================Servicios====================================================
    Private oPlanillaSueldosService As New ReciboHonorarioService.ReciboHonorarioServiceClient
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        Try
            ...
            If Seleccion.ShowDialog() = DialogResult.OK Then
                ...
                dtdetalle = oPlanillaSueldosService.GenerarArchivoProveedores(Session.sCodEmp, cbFecha1.Value, cbFecha2.Value, cmbBancos.Value, cmbCuentas.Value).Tables(0)
                ...
                'For Each Fila As DataRow In dtdetalle.Rows
                '    texto = Fila.Item("DetalleDocumentos")
                '    a.WriteLine(texto)
                'Next
