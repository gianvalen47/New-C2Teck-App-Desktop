...
Public Class frmAsientos
    ...
    Private Sub LlenarCombos()
        Try
            ...
            '====================================CUENTA BANCOS ============================================
            dtCuentaBancos = oTesoreriaService.MostrarCuentaBancos.Tables(0)
    ...
    Private Function ValidaBalanceAsiento() As Boolean
        Try
            If txtDiferenciaSol.Value <> 0 And txtDiferenciaDol.Value <> 0 Then
                MsgBox("¡El Registro no se encuentra balanceado, verificar...!", MsgBoxStyle.Information, "Información")
                Return False
            Else
                Return True
            End If
