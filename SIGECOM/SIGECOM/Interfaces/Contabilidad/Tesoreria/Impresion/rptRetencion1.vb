...
Public Class rptRetencion1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRetencion1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRetencion1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRetencion1 = New rptRetencion1()
        rpt.Site = Me.Site
        Return rpt
    End Function
