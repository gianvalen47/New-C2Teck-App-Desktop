...
Public Class rptCheque_Credito
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptCheque_Credito.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheque_Credito
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheque_Credito = New rptCheque_Credito()
        rpt.Site = Me.Site
        Return rpt
    End Function
