...
Public Class frmBuscarAsientos
    ...
    Private Sub frmBuscarAsientos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub txtMesRegistro_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtMesRegistro.KeyPress
        If e.KeyChar = ChrW(Keys.Enter) Or e.KeyChar = ChrW(Keys.Tab) Then
            ...
            If Len(Trim(txtMesRegistro.Text)) > 0 Then
                If toNumber(txtMesRegistro.Text) < 13 Or toNumber(txtMesRegistro.Text) = 0 Then
    ...
    Private Sub frmBuscarAsientos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdTesoreria").Text = Nothing Then
    ...
    Private Sub Seleccionar()
        Try
            IdTesoreria = dgvDatos.CurrentRow.Cells("IdTesoreria").Text
            NumRegistro = dgvDatos.CurrentRow.Cells("NumRegistro").Text
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTesoreriaService.Filtrar(Session.sCodEmp, txtPeriodo.Value, txtMesRegistro.Text, txtNumRegistro.Text, txtNombre.Text).Tables(0)
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdTesoreria").Text
        End If
        dtDatos = Nothing
        listaDatos()
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "IdTesoreria", codigo)
        End If
    End Sub
