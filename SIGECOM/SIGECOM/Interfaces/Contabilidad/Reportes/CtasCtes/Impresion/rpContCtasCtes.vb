...
Public Class rpContCtasCtes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpContCtasCtes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpContCtasCtes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpContCtasCtes = New rpContCtasCtes()
        rpt.Site = Me.Site
        Return rpt
    End Function
