...
Public Class rpRepCajaBancos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepCajaBancos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepCajaBancos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepCajaBancos = New rpRepCajaBancos()
        rpt.Site = Me.Site
        Return rpt
    End Function
