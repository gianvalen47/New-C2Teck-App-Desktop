...
Public Class rptRepProvisional
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepProvisional.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepProvisional
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepProvisional = New rptRepProvisional()
        rpt.Site = Me.Site
        Return rpt
    End Function
