...
Public Class frmRepCtasxPagarConta
    ...
    Private Sub frmRepCtasxPagar_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cbFecInicio.Value = "01/01/2020" 'CDate("01/" & utils.toBlank(Month(Today)) & "/" & utils.toBlank(Year(Today)))
    ...
    Private Sub MostrarReporteDetallado()
        Try
            ...
            Dim reporte As New rpCtasxPagarDetalladoConta
    ...
    Private Sub MostrarReporteResumido()
        Try
            ...
            Dim reporte As New rpCtasxPagarResumidoConta
