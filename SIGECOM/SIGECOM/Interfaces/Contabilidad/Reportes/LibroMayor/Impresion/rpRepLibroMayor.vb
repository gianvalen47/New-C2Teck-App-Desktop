...
Public Class rpRepLibroMayor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepLibroMayor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepLibroMayor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepLibroMayor = New rpRepLibroMayor()
        rpt.Site = Me.Site
        Return rpt
    End Function
