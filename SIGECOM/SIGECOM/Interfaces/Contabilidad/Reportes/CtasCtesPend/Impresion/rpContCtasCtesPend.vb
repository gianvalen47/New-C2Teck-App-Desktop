...
Public Class rpContCtasCtesPend
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpContCtasCtesPend.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpContCtasCtesPend
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpContCtasCtesPend = New rpContCtasCtesPend()
        rpt.Site = Me.Site
        Return rpt
    End Function
