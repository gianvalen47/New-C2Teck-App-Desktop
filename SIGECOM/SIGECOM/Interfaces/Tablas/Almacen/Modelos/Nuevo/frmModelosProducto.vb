Public Class frmModelosProducto
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmModeloProducto
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("ModMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                Dim modmer As String
                modmer = dgvDatos.CurrentRow.Cells("ModMer").Text
                estado_process = oModeloService.Borrar(modmer, Session.sCodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                ...
                dtDatos = oModeloService.Filtrar(toBlank(txtModMer.Text), Session.sCodEmp, toBlank(txtDescripcion.Text)).Tables(0)
    ...
    Private Sub miNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miNuevo.Click
        Nuevo()
    End Sub
    Private Sub cmbCodSerie_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
        listaDatos()
    End Sub
