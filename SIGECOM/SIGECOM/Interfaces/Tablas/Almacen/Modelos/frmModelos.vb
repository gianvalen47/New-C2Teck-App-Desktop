Public Class frmModelos
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        Try
            ...
            For Each row In rows
                ...
                If CStr(row.Cells("ModMer").Value) = codigo Then
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 71)
        '/*************************************************************************************/
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmModelo
            frm.state_button = True
            frm.txtModMer.Text = dgvDatos.CurrentRow.Cells("ModMer").Text

            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                limpiaOpcionesBusqueda("update", frm.txtModMer.Text.Trim)
                listaDatos()
                If frm.type_process = "update" Then
                    RowPossesion(dgvDatos, frm.txtModMer.Text.Trim)
                Else
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("ModMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean

                Dim registro As New ModeloService.Modelo
                registro.ModMer = dgvDatos.CurrentRow.Cells("ModMer").Text
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                ...
                registro.ModMer = toBlank(txtModMer.Text)
                registro.Descripcion = toBlank(txtDescripcion.Text)
                serie.CodSerie = toBlank(cmbCodSerie.Value)
                registro.Serie = serie

                dtDatos = oModeloService.Filtrar(registro).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                limpiaOpcionesBusqueda("insert", frm.txtModMer.Text.Trim)
                listaDatos()
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("ModMer").Text = Nothing Then
    ...
    Private Sub llenarCombos()
        Try
            ...
            dtSeries.Rows.InsertAt(getRowTodos(dtSeries), 0)
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("ModMer").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub miNuevo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miNuevo.Click
        Nuevo()
    End Sub
    Private Sub cmbCodSerie_ValueChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbCodSerie.ValueChanged
        listaDatos()
    End Sub
