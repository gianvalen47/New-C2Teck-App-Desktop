...
Public Class frmMercaderia
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf cmbCodRub.Value = 4 And cmbModMer.Value = "" Then
                MsgBox("Debe Ingresar el modelo de la Mercadería", MsgBoxStyle.Information, "Información")
    ...
    Private Sub Insertar(ByVal registro As MercaderiaService.Mercaderia)
        Try
            ...
            If estado_process = True Then
                If MsgBox("¿Desea que la mercaderia sea ingresada a una locación?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                    Dim frm As New frmMercaderiaLocacion
        ...
        Try
            ...
            If Len(Trim(txtCodMer.Text)) > 0 Then
                ...
                Else
                    ...
                    If oPrecioService.BuscarListaPrecioFabrica(Marca, txtCodMer.Text) Then
                        Dim registro As New PrecioService.PrecioFabrica

                        registro = oPrecioService.ObtenerListaPrecioFabrica(Marca, txtCodMer.Text)
                        txtDesMer1.Text = registro.Mercaderia.DesMer1
                        txtDesMer2.Text = registro.Mercaderia.DesMer2
                        CodGru = registro.Mercaderia.GrupoMerca.CodGru
                        txtGrupo.Text = registro.Mercaderia.GrupoMerca.DesGru
                        CodPais = registro.Pais.CodPais
                        txtPais.Text = registro.Pais.DesPais
                        CodApl = registro.Mercaderia.AplicacionMerca.CodApl
                        txtAplicacion.Text = registro.Mercaderia.AplicacionMerca.DesApl
                        CodMar = registro.Mercaderia.Marca.CodMar
                        txtMarca.Text = registro.Mercaderia.Marca.DesMar
                        txtDeaMer.Text = registro.Dealer
                        txtCorMer.Text = registro.PreCore                        
                        txtPesMer.Text = registro.Weight
                        cmbUnidMedPeso.Value = registro.UnitWeight
    ...
    Private Sub biGuardarCodBarra_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biGuardarCodBarra.Click
    ...
    Private Sub biGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biGuardar.Click
        ...
        If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
           And ValidaCampos() Then
            ...
            Dim UnidadMedidaPeso As New MercaderiaService.UnidadMedidaPeso
            Dim Proveedor As New MercaderiaService.Proveedor        ' Agregado el 14/02/2012
            Dim ListaPrecio As New MercaderiaService.ListaPrecios
    ...
    Private Sub btnEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnEliminar.Click
        If MsgBox("¿Está seguro de ELIMINAR el registro?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
            If txtCodMer.Text.Trim.Length > 0 Then
                Dim registro As New MercaderiaService.Mercaderia
                registro.CodMer = txtCodMer.Text.Trim
