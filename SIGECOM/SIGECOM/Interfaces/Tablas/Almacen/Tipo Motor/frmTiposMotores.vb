Public Class frmTiposMotores
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        Try
            ...
            For Each row In rows
                ...
                If CStr(row.Cells("TipMot").Value) = codigo Then
    ...
    Private Sub frmTiposMotores_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 70)
        '/*************************************************************************************/
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmTipoMotor
            frm.state_button = True
            frm.TipoMot = dgvDatos.CurrentRow.Cells("TipMot").Text

            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                limpiaOpcionesBusqueda("update", frm.txtTipMot.Text.Trim)
                listaDatos()
                If frm.type_process = "update" Then
                    RowPossesion(dgvDatos, frm.txtTipMot.Text.Trim)
                Else
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("TipMot").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean

                Dim registro As New TipoMotorService.TipoMotor
                registro.TipMot = dgvDatos.CurrentRow.Cells("TipMot").Text
    ...
    Private Sub listaDatos()
        Try
            Dim registro As New TipoMotorService.TipoMotor
            registro.TipMot = toBlank(txtTipMot.Text)
            registro.Descripcion = toBlank(txtDescripcion.Text)

            dtDatos = oTipoMotorService.Filtrar(registro).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                limpiaOpcionesBusqueda("insert", frm.txtTipMot.Text.Trim)
                listaDatos()
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("TipMot").Text = Nothing Then
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("TipMot").Text
        End If
        dtDatos = Nothing
        listaDatos()
