...
Public Class frmHorarios
    ...
    Private Sub frmHorarios_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 227)
        '/*************************************************************************************/
    ...
    '==========================Evento FormClosed=============================================
    Private Sub frmHorarios_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    '==========================Evento KeyDown===============================================
    Private Sub frmHorarios_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("CodHor").Value = codigo Then
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmHorario_Nuevo
            frm.state_button = True
            frm.CodHor = dgvDatos.CurrentRow.Cells("CodHor").Text
            frm.editable = True
            frm.edicion = False
            ...
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                ...
                If frm.type_process = "update" Then
                    listaDatos()
                    RowPossesion(dgvDatos, frm.CodHor)
                Else
                    listaDatos()
            ...
            enableOpciones()
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR HORARIO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oHorarioService.Borrar(dgvDatos.CurrentRow.Cells("CodHor").Text, Session.sCodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub Nuevo()
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR NUEVO HORARIO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oHorarioService.Filtrar(Session.sCodEmp, cmbHorario.Value).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, cmbHorario.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Listado de Horarios."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo Horario."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Horario actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Horario actual."
    End Sub
    ...
    Private Sub biImprimir_Click(sender As Object, e As EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            Dim frm As New frmHorario_Imprimir
            frm.CodHor = IIf(toBlank(cmbHorario.Value) = "", "", cmbHorario.Value)
            frm.ShowDialog()
        Catch ex As Exception
            MsgBox("Error al IMPRIMIR Listado de Horarios : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
End Class