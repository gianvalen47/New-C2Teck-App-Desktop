...
Public Class rpListado_Horario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpListado_Horario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpListado_Horario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpListado_Horario = New rpListado_Horario()
        rpt.Site = Me.Site
        Return rpt
    End Function
