...
Public Class frmEquiposMarcacion
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmEquipoMarcacion
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oTablasPersonalService.BorrarEquipoMarcacion(toNumber(dgvDatos.CurrentRow.Cells("IdEquipo").Value))
