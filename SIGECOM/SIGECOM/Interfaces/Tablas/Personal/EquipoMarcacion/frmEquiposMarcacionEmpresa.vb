...
Public Class frmEquiposMarcacionEmpresa
    ...
    Private Sub frmEquiposMarcacion_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmEquiposMarcacion_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 233)
        '/*************************************************************************************/
    ...
    '==========================Evento KeyDown===============================================
    Private Sub frmEquiposMarcacion_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTablasPersonalService.MostrarLectoresEmpresa(Session.sCodEmp).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmEquipoMarcacionEmpresa
            ...
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVO EQUIPO DE MARCACIÓN: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oTablasPersonalService.BorrarLectorEmpresa(toNumber(dgvDatos.CurrentRow.Cells("IdEquipo").Value), Session.sCodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR EL LECTOR : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdEquipo = toNumber(dgvDatos.CurrentRow.Cells("IdEquipo").Value)
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
            ...
            RowPossesion(dgvDatos, frm.IdEquipo)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR EL EQUIPO DE MARCACIÓN: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Equipo de Marcación actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo Equipo de Marcación."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Equipo de Marcación actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Equipo de Marcación actual."
    End Sub
