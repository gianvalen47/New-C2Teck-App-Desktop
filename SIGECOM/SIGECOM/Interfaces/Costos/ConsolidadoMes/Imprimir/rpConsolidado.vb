...
Public Class rpConsolidado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpConsolidado.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SaldoAlmacen() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrpConsolidado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpConsolidado = New rpConsolidado()
        rpt.Site = Me.Site
        Return rpt
    End Function
