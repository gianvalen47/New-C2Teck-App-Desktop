...
Public Class frmRecalcularFIMasivo
    ...
    Private Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            If MsgBox("¿Está seguro de hacer un RECALCULO previo de costos a la(s) Factura(s) seleccionada(s)?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                ...
                For i As Integer = 0 To dgvSeleccionados.Rows.Count - 1
                    ...
                    If oImportacionService.Recalcular(codigo) Then
                        cont = cont + 1
                    End If
                Next

                If cont > 0 Then
                    MsgBox("Se Realizó el recalculo previo de los costos de la(s) Factura(s) seleccionada(s)", MsgBoxStyle.Information, "Recalculo Exitoso")
