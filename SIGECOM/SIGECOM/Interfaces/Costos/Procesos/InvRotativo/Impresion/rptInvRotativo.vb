...
Public Class rptInvRotativo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptInvRotativo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptInvRotativo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptInvRotativo = New rptInvRotativo()
        rpt.Site = Me.Site
        Return rpt
    End Function
