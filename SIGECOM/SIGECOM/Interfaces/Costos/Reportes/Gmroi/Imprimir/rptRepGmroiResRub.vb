...
Public Class rptRepGmroiResRub
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepGmroiResRub.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepGmroiResRub
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepGmroiResRub = New rptRepGmroiResRub()
        rpt.Site = Me.Site
        Return rpt
    End Function
