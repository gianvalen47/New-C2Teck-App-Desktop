...
Public Class rpKardexMotor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpKardexMotor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpKardexMotor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpKardexMotor = New rpKardexMotor()
        rpt.Site = Me.Site
        Return rpt
    End Function
