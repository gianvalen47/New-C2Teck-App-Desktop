...
Public Class rpStockGerencial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpStockGerencial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpStockGerencial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpStockGerencial = New rpStockGerencial()
        rpt.Site = Me.Site
        Return rpt
    End Function
