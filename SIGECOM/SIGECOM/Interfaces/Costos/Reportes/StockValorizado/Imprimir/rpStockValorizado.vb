...
Public Class rpStockValorizado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpStockValorizado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpStockValorizado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpStockValorizado = New rpStockValorizado()
        rpt.Site = Me.Site
        Return rpt
    End Function
