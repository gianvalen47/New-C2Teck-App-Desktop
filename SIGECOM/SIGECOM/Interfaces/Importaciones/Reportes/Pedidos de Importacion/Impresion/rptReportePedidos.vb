...
Public Class rptReportePedidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptReportePedidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReportePedidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReportePedidos = New rptReportePedidos()
        rpt.Site = Me.Site
        Return rpt
    End Function
