...
Public Class frmEmbarque_GastosImportacion
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oEmbarqueService.MostrarGasto(CodEmbarque).Tables(0)
    ...
    Private Sub mostrarDetalle()
        Try
            ...
            frm.IdGastoEmb = dgvDatos.CurrentRow.Cells("IdGastoEmb").Text
    ...
    Private Sub eliminarDetalle()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el Gasto?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oEmbarqueService.BorrarGasto(dgvDatos.CurrentRow.Cells("IdGastoEmb").Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
