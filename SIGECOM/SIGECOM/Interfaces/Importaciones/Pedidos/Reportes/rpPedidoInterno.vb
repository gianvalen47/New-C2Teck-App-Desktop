...
Public Class rpPedidoInterno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpPedidoInterno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpPedidoInterno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpPedidoInterno = New rpPedidoInterno()
        rpt.Site = Me.Site
        Return rpt
    End Function
