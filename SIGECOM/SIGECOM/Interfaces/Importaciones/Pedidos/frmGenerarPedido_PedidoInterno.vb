...
Public Class frmGenerarPedido_PedidoInterno
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf rbGenerarPedido.Checked = True And toBlank(txtFecha.Text) = "" Then
                ...
                txtFecha.Focus()
                Return False
            ElseIf rbGenerarPedido.Checked = True And toBlank(txtFechaPromesa.Text) = "" Then
                MsgBox("Debe ingresar la fecha promesa del pedido de importación. ", MsgBoxStyle.Information, "Información")
                txtFechaPromesa.BackColor = Color.Red
                txtFechaPromesa.Focus()
                Return False
            ...
            ElseIf rbAgregarPedido.Checked = True And toNumber(IdLocacion) = 0 Then
                ...
                btnBuscarAlmacen.Focus()
                Return False
            ElseIf rbAgregarPedido.Checked = True And CodMon <> CodMonPedImp Then
                MsgBox("El Pedido Interno y la Orden de Importacion deben tener la misma moneda  ", MsgBoxStyle.Information, "Información")
                'txtalmacen.BackColor = Color.Red
                btnBuscarFacturaImportacion.Focus()
                Return False
    ...
    Private Sub Generar(ByVal registro As PedidoService.PedidoImport, ByVal listaDetalles As DataTable, ByVal isNuevo As Boolean)
        Try
            ...
            estado_process = oPedidoService.GenerarPedidoImport(registro, listaDetalles, Session.sCodUsu, Session.sNomPc, Session.sDirIp, isNuevo)
            type_process = "insert"
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        For Each row As DataRow In dtListaDetalles.Rows
            ...
            If oMercaderiaService.Buscar(codmer, Session.sCodEmp) Then
    ...
    Private Sub Guardar()
        ...
        If MsgBox(mensaje, MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
            ...
            registro.FecPromesa = toNull(txtFechaPromesa.Text)
