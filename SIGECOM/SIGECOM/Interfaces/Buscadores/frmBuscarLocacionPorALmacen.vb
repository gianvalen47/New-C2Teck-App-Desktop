...
Public Class frmBuscarLocacionPorALmacen
    ...
    Public CodigoAlmacén As String
    ...
    Private Sub frmBuscarLocacionPorALmacen_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oMaestroService.MostrarLocacionPorAlmacen(Session.sCodEmp, cmbOficinas.Value, CodigoAlmacén, Session.sCodUsu).Tables(0)
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtDesAlm.TextChanged, txtIdLocacion.TextChanged, cmbOficinas.ValueChanged
        listaDatos()
    End Sub
