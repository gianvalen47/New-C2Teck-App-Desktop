...
Public Class frmBuscarMarca
    ...
    Private Sub frmBuscarMarca_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Seleccionar()
        Try
            codigo = dgvDatos.CurrentRow.Cells("CodMar").Text
            descripcion = dgvDatos.CurrentRow.Cells("DesMar").Text
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub listaDatos()
        Try
            ...
            'registro.CodMar = toBlank(txtCodMar.Text)
            'registro.DesMar = toBlank(txtDesMar.Text)

            dtDatos = oMarcaService.Filtrar(Session.sCodEmp, toBlank(txtCodMar.Text), toBlank(txtDesMar.Text)).Tables(0)
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("CodMar").Text = Nothing Then
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtDesMar.TextChanged, txtCodMar.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "CodMar", codigo)
        End If
    End Sub
End Class
