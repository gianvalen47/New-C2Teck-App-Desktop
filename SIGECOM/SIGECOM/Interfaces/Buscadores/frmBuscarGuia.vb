Public Class frmBuscarGuia
    ...
    Public idseriedoc As String
    Public codserie As String
    Public numdoc As String
    Public idcli As String
    Public descli As String

    Private Sub frmBuscarGuia_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown

    End Sub

    Private Sub frmBuscarGuia_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmBuscarGuia_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtanio.ValueChanged, cmbMes.ValueChanged, cmbOficinas.ValueChanged, cmbIdLocacion.ValueChanged, txtIdCliente.TextChanged, txtNumero.TextChanged, cmbEstado.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oGuiaRemisionService.Filtrar(txtanio.Value, cmbMes.Value, IIf(toNumber(cmbIdLocacion.Value) = 0, -1, cmbIdLocacion.Value), 1, toNumber(IdCliente), cmbEstado.Value, utils.toNumber(txtNumero.Text)).Tables(0)
    ...
    Private Sub Seleccionar()
        Try
            ...
            idcli = dgvDatos.CurrentRow.Cells("IdCliente").Text
