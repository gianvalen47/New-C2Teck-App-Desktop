...
Public Class frmJob_Archivos
    ...
    Private Sub frmJob_Archivos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listaDatos()
    ...
    Private Sub frmJob_Archivos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmJob_Archivos_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
            oJobService.Close()
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oJobService.MostrarArchivos(CodJob).Tables(0)
    ...
    Private Sub biNuevo_Click(sender As Object, e As EventArgs) Handles biNuevo.Click, miNuevo.Click
        ...
        While lLog
            Dim frm As New frmJob_Archivos_Nuevo
    ...
    Private Sub mostrar()
        ...
        If Not Directory.Exists("D:\OTArchivos\" & Nombre) Then
            Directory.CreateDirectory("D: \OTArchivos\" & Nombre)
        End If

        Dim registro As JobService.JobArchivos
        registro = oJobService.ObtenerArchivos(dgvDatos.CurrentRow.Cells("IdArchivo").Text)
        ...
        System.IO.File.WriteAllBytes("D:\OTArchivos\" & Nombre & "\" & NombreArchivo & Extension, pdfDoc)
        System.Diagnostics.Process.Start("D:\OTArchivos\" & Nombre & "\" & NombreArchivo & Extension)
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el archivo seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oJobService.BorrarArchivos(toNumber(dgvDatos.CurrentRow.Cells("IdArchivo").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub ModificarArchivo()
        ...
        Dim frm As New frmJob_Archivos_Actualizar
