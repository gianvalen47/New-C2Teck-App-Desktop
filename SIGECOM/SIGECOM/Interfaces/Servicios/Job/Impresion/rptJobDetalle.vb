...
Public Class rptJobDetalle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptJobDetalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobDetalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobDetalle = New rptJobDetalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
