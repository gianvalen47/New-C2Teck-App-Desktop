...
Public Class rptReclamo_Cliente
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptReclamo_Cliente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReclamo_Cliente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReclamo_Cliente = New rptReclamo_Cliente()
        rpt.Site = Me.Site
        Return rpt
    End Function
