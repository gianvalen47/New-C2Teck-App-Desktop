...
Public Class rptProgramacionJob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptProgramacionJob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptProgramacionJob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProgramacionJob = New rptProgramacionJob()
        rpt.Site = Me.Site
        Return rpt
    End Function
