...
Public Class rptImpHorasMotor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptImpHorasMotor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptImpHorasMotor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptImpHorasMotor = New rptImpHorasMotor()
        rpt.Site = Me.Site
        Return rpt
    End Function
