...
Public Class rptHorasMotor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptHorasMotor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHorasMotor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHorasMotor = New rptHorasMotor()
        rpt.Site = Me.Site
        Return rpt
    End Function
