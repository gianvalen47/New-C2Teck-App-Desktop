...
Public Class frmRepHorasMotor
    ...
    Private Sub frmRepHorasMotor_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRepHorasMotor_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRepHorasMotor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 251)
        '/*************************************************************************************/
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        oSeguridadService.RegistrarVisitaOpciones(251, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
        mostrarReporte()
    End Sub
    ...
    Private Sub mostrarReporte()
        Try
            ...
            Dim reporte As New rptHorasMotor

            If rbTodos.Checked Then
                dtReporte = oHorasMotorService.ReporteHorasMotor(Session.sCodEmp, toBlank(cmbUbicacion.Value), 1).Tables(0)
            ElseIf rbProduccion.Checked Then
                dtReporte = oHorasMotorService.ReporteHorasMotor(Session.sCodEmp, toBlank(cmbUbicacion.Value), 2).Tables(0)
            End If
