...
Public Class rptRepConsumir
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepConsumir.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepConsumir
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepConsumir = New rptRepConsumir()
        rpt.Site = Me.Site
        Return rpt
    End Function
