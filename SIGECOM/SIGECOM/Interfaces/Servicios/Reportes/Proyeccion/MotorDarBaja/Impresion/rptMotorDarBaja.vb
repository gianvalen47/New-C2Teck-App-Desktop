...
Public Class rptMotorDarBaja
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptMotorDarBaja.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMotorDarBaja
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMotorDarBaja = New rptMotorDarBaja()
        rpt.Site = Me.Site
        Return rpt
    End Function
