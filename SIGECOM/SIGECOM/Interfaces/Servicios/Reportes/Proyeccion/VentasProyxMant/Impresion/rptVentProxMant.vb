...
Public Class rptVentProxMant
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptVentProxMant.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptVentProxMant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptVentProxMant = New rptVentProxMant()
        rpt.Site = Me.Site
        Return rpt
    End Function
