...
const columns = ["Fabricante", "Lista", "Mon.", "Observación", "Fec. Inicio", "Fec. Venc.", "Vigente"];
  ...
  return (
    <div className="relative h-full min-h-0 flex flex-col overflow-hidden bg-[#F3F6FA]">
      ...
      <div className="flex flex-wrap items-end gap-2 px-2 py-1.5 bg-[#F0F4F8] border-b border-slate-300">
        ...
        <Field label="Lista Precio" className="w-56"><select className={inp} defaultValue="(Todos)"><option>(Todos)</option><option>FABRICANTE A</option><option>FABRICANTE B</option></select></Field>
