...
Public Class frmPerfil_Opcion
    ...
    Private Sub Modificar()
        Try
            ...
            estado_process = oSeguridadService.ActualizarPerfilOpciones(IdOpcion, CodPerfil, CodEmp, cbLectura.Checked)
            type_process = "update"
    ...
    Private Sub ObtenerRegistro()
        Try
            ...
            registro = oSeguridadService.ObtenerPerfilOpciones(IdOpcion, CodPerfil, CodEmp)
