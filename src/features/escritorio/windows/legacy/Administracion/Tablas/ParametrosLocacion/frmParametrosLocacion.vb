...
Public Class frmParametrosLocacion

    Private oParametrosSerice As New ParametrosService.ParametrosServiceClient
    ...
    Private Sub frmParametrosLocacion_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
            oParametrosSerice.Close()
            oMaestroService.Close()
        Catch ex As TimeoutException
            oParametrosSerice.Abort()
    ...
    Private Sub frmParametrosLocacion_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmParametrosLocacion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub listaDatos()
        Try
            ...
            dtDatos = oParametrosSerice.Filtrar(Session.sCodEmp).Tables(0)
    ...
    Private Sub mostrar()
        ...
        Try
            Dim frm As New frmParametroLocacion
            ...
            'Actualizar()
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR EL PARAMETRO DE LA LOCACION: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub eliminar()
        ...
        Try
            If MsgBox("¿Está seguro de ELIMINAR el Parametro Locacion seleccionada?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean

                estado_process = oParametrosSerice.Borrar(dgvDatos.CurrentRow.Cells("IdLocacion").Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR EL PARAMETRO LOCACION:" + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub Nuevo()
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR UN PARAMETRO LOCACION: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
