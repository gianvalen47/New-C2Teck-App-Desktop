...
Public Class frmRubrosxEmpresa_Nuevo
    ...
    Private Sub frmRubrosxEmpresa_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub frmRubrosxEmpresa_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRubrosxEmpresa_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub listaDatos()
        ...
        Try
            dtDatos = oRubrosService.MostrarRubrosEmpresa(CodEmp).Tables(0)
    ...
    Private Sub eliminar()
        ...
        Try
            If MsgBox("¿Está seguro de ELIMINAR el Rubro de la Empresa seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean

                estado_process = oRubrosService.BorrarRubrosEmpresa(dgvRubros.CurrentRow.Cells("CodRub").Text, CodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR EL RUBRO X EMPRESA:" + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub NuevoDetalle()
        Try
            Dim frm As New frmRubrosxEmpresa_DetalleM
            frm.CodEmpV = CodEmp
