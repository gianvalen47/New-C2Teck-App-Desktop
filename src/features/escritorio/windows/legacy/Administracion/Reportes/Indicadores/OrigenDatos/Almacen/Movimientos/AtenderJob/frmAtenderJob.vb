Public Class frmAtenderJob
    ...
    Private Sub llenarCombos()
        Try
            '======================================= LOCACIONES ===========================================
            dtLocaciones = oMaestroService.MostrarLocacionJob.Tables(0)
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTransferenciaService.MostrarJobPendientes(cmbLocacion.Value, txtNumDoc.Text, IdCliente).Tables(0)
    ...
    Private Sub biMostrar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.Click, miMostrar.Click
        Try
            ...
            frm.Text = "Pedidos de Mercadería para Servicios JOB :" & dgvDatos.CurrentRow.Cells("CodJob").Text
            If frm.ShowDialog = Windows.Forms.DialogResult.OK Then
