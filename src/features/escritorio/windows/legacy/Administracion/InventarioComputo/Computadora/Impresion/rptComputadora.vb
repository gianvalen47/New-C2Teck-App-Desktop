...
Public Class rptComputadora
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptComputadora.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptComputadora
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptComputadora = New rptComputadora()
        rpt.Site = Me.Site
        Return rpt
    End Function
