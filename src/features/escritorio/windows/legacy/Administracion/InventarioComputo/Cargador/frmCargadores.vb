...
Public Class frmCargadores
    ...
    Private Sub frmCargadores_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmCargadores_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmCargadores_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesCargador.TextChanged, txtMarca.TextChanged, txtModelo.TextChanged, txtSerie.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                'dtDatos = oComputadoraService.FiltrarCargador(toBlank(txtDesCargador.Text), toBlank(txtMarca.Text), toBlank(txtModelo.Text), toBlank(txtSerie.Text)).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                ...
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    ...
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.IdCargador)
                    End If
                Else
                    lLog = False
                End If
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR EL CARGADOR: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdCargador = dgvDatos.CurrentRow.Cells("IdCargador").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oComputadoraService.BorrarCargador(dgvDatos.CurrentRow.Cells("IdCargador").Value)
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdCargador").Text
        End If
        dtDatos = Nothing
        listaDatos()
