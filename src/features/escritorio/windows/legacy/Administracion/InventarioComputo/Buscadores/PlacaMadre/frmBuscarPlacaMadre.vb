...
Public Class frmBuscarPlacaMadre
    ...
    Private Sub frmBuscarPlacaMadre_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'llenarCombos()
        state_Search = True
        cbVideoIntegrado.Checked = True
        listaDatos()
    End Sub

    Private Sub frmBuscarPlacaMadre_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBuscarPlacaMadre_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesPlacaMadre").Text
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdPlacaMadre").Text = Nothing Then
