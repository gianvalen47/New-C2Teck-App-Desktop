...
Public Class frmBuscarSoftware
    ...
    Private Sub frmBuscarSoftware_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmBuscarSoftware_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmBuscarSoftware_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, cmbTipoSoftware.ValueChanged, txtNomAplicacion.TextChanged, cbLicenciaAplica.CheckedChanged, cbVigente.CheckedChanged
        listaDatos()
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("NomAplicacion").Text
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdSoftware").Text = Nothing Then
