...
Public Class frmBuscarDiscoDuro
    ...
    Private Sub frmBuscarDiscoDuro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmBuscarDiscoDuro_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBuscarDiscoDuro_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesDiscoDuro.TextChanged, txtMarca.TextChanged, txtModelo.TextChanged, txtSerie.TextChanged, cmbTipoConector.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesDiscoDuro").Text
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdDiscoDuro").Text = Nothing Then
