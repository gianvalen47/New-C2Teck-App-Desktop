...
Public Class frmBuscarLectora
    ...
    Private Sub frmBuscarLectora_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmBuscarLectora_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBuscarLectora_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesLectora.TextChanged, txtMarca.TextChanged, txtModelo.TextChanged, txtSerie.TextChanged, cmbTipoConector.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesLectora").Text
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdLectora").Text = Nothing Then
