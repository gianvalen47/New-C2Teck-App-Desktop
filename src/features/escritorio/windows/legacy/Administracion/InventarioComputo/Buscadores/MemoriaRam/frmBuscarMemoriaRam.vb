...
Public Class frmBuscarMemoriaRam
    ...
    Private Sub frmBuscarMemoriaRam_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmBuscarMemoriaRam_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBuscarMemoriaRam_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub btnBuscar_Click(sender As Object, e As EventArgs) Handles btnBuscar.Click, txtDesMemRam.TextChanged, txtMarca.TextChanged, txtModelo.TextChanged, txtSerie.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesMemRam").Text
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdMemRam").Text = Nothing Then
