...
Public Class frmBuscarTarjetaVideo
    ...
    Private Sub frmBuscarTarjetaVideo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmBuscarTarjetaVideo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBuscarTarjetaVideo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesTarjetaVideo").Text
    ...
    Private Sub Salir_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
                 txtDesTarjeta.KeyPress _
              , txtMarca.KeyPress _
              , txtModelo.KeyPress _
              , txtSerie.KeyPress _
              , txtTipoMemoria.KeyPress
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdTarjetaVideo").Text = Nothing Then
