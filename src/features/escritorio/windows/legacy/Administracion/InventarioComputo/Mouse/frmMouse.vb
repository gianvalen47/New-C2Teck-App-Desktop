...
Public Class frmMouse
    ...
    Private Sub frmMouse_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmMouse_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ComputadoraService.Mouse
            registro = oComputadoraService.ObtenerMouse(IdMouse)

            IdMouse = registro.IdMouse
            txtIdMouse.Text = registro.IdMouse
            txtDesMouse.Text = registro.DesMouse
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                Dim registro As New ComputadoraService.Mouse
                ...
                registro.IdMouse = IdMouse
                registro.DesMouse = txtDesMouse.Text
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GUARDAR EL MOUSE: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub


    Private Sub Insertar(ByVal registro As ComputadoraService.Mouse)
        Try
            Dim estado_process As Integer
            estado_process = oComputadoraService.InsertarMouse(registro)
            type_process = "insert"
            If estado_process > 0 Then
                IdMouse = estado_process
                Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Else
                MsgBox("¡Error en el proceso, comuníquese con el departamento de sistemas...!", MsgBoxStyle.Critical)
            End If
        Catch ex As Exception
            MsgBox("ERROR AL INSERTAR EL MOUSE: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub Modificar(ByVal registro As ComputadoraService.Mouse)
        Try
            Dim estado_process As Boolean
            estado_process = oComputadoraService.ActualizarMouse(registro)
            type_process = "update"
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MODIFICAR EL MOUSE: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Function ValidaCampos() As Boolean
        Try
            If toBlank(txtDesMouse.Text) = "" Then
