...
Public Class frmLectora
    ...
    Private Sub frmLectora_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmLectora_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmLectora_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ComputadoraService.Lectora
            registro = oComputadoraService.ObtenerLectora(IdLectora)

            IdLectora = registro.IdLectora
            txtIdLectora.Text = registro.IdLectora
            txtDesLectora.Text = registro.DesLectora
            ...
            cmbTipoConector.Value = registro.TipoConector.IdTipoConector
            txtVelocidadOper.Text = registro.VelocidadOper
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        Try
            ...
            And ValidaCampos() Then
                Dim registro As New ComputadoraService.Lectora
                ...
                registro.IdLectora = IdLectora
                registro.DesLectora = txtDesLectora.Text
                ...
                registro.TipoConector = tipoconector
                registro.VelocidadOper = txtVelocidadOper.Text
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GUARDAR LA LECTORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub


    Private Sub Insertar(ByVal registro As ComputadoraService.Lectora)
        Try
            Dim estado_process As Integer
            estado_process = oComputadoraService.InsertarLectora(registro)
            type_process = "insert"
            If estado_process > 0 Then
                IdLectora = estado_process
                Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Else
                MsgBox("¡Error en el proceso, comuníquese con el departamento de sistemas...!", MsgBoxStyle.Critical)
            End If
        Catch ex As Exception
            MsgBox("ERROR AL INSERTAR LA LECTORA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Sub Modificar(ByVal registro As ComputadoraService.Lectora)
        Try
            Dim estado_process As Boolean
            estado_process = oComputadoraService.ActualizarLectora(registro)
            type_process = "update"
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MODIFICAR LA LECTORA " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub

    Private Function ValidaCampos() As Boolean
        Try
            If toBlank(txtDesLectora.Text) = "" Then
                MsgBox("Debe ingresar la descripción de la lectora", MsgBoxStyle.Information, "Información")
                txtDesLectora.Focus()
                Return False
            ...
            ElseIf toBlank(cmbTipoConector.text) = "" Then
                ...
                Return False
            ElseIf toBlank(txtVelocidadOper.text) = "" Then
                MsgBox("Debe ingresar la velocidad de operacion", MsgBoxStyle.Information, "Información")
                txtVelocidadOper.Focus()
                Return False
    ...
    Private Sub SendFocus_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
                     txtDesLectora.KeyPress _
 _
                   , txtModelo.KeyPress _
                   , txtSerie.KeyPress _
                   , cmbTipoConector.KeyPress _
                   , txtVelocidadOper.KeyPress _
