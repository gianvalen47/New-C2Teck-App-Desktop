...
Public Class frmQuintaCategoriaNuevoMasivo
    '===========================Servicios====================================================
    ...
    Private Sub frmCronograMina_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Nuevo
        Me.Text = "Registrar Nuevo Periodo Masivo"
        activar()
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oQuintaCategoriaCabService.GenerarPeriodoMasivo(Session.sCodEmp, cmbMoneda.Value, txtAnio.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
