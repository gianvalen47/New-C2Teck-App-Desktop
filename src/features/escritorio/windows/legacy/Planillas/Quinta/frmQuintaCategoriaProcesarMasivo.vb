...
Public Class frmQuintaCategoriaProcesarMasivo
    '===========================Servicios====================================================
    ...
    Private Sub frmCronograMina_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'txtMesPromedio.Text = 15 - Month(Today)
        CalcularMeses()
        'Nuevo
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oQuintaCategoriaDetService.ProcesarRetencionMasivo(Session.sCodEmp, txtAnio.Value, txtMesRegistro.Text, cmbTipoPlanilla.Value, txtMesPromedio.Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)


                    If estado_process Then
                        MsgBox("Se Proceso la Quinta Categoria Correctamente")
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL PROCESAR QUINTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
