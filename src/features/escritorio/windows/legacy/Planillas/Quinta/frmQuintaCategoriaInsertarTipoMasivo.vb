...
Public Class frmQuintaCategoriaInsertarTipoMasivo
    '===========================Servicios====================================================
    ...
    Private Sub frmCronograMina_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        'Nuevo
        Me.Text = "Insertar Tipo Quinta Masivamente"
        activar()
    ...
    Private Function ValidaCampos() As Boolean
        Try
            If cmbTipoPlanilla.Value = 0 Then
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oQuintaCategoriaDetService.InsertarTipoQuintaMasivo(Session.sCodEmp, txtAnio.Value, txtMesRegistro.Text, cmbTipoPlanilla.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)


                    If estado_process Then
                        MsgBox("Se Inserto la Quinta Categoria Correctamente")
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL INSERTAR QUINTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
