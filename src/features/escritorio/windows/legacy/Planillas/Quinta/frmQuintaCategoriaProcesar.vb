...
Public Class frmQuintaCategoriaProcesar
    '===========================Servicios====================================================
    ...
    Private Sub frmCronograMina_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '  cmbMoneda.Value = "NS"
        txtMesRegistro.Text = mes  'Format(Month(Today), "00")
        'txtMesPromedio.Text = 15 - CInt(mes)  '15 - Month(Today)
        CalcularMeses()
        cmbTipoPlanilla.Value = idTipo
        'Nuevo
    ...
    Private Sub CalcularMeses()
        Dim mesactual As Integer

        mesactual = txtMesRegistro.Text  'Today.Month()

        If mesactual <= 3 Then
            txtMesPromedio.Text = 12
        ElseIf mesactual = 4
            txtMesPromedio.Text = 9
        ElseIf mesactual >= 5 And mesactual <= 7
            txtMesPromedio.Text = 8
        ElseIf mesactual = 8
            txtMesPromedio.Text = 5
        ElseIf mesactual >= 9 And mesactual <= 11
            txtMesPromedio.Text = 4
        ElseIf mesactual = 12
            txtMesPromedio.Text = 1
        End If
        ...
        Try
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oQuintaCategoriaDetService.ProcesarRetencion(Session.sCodEmp, txtAnio.Value, txtMesRegistro.Text, cmbTipoPlanilla.Value, IdPersona, txtMesPromedio.Text, Session.sCodUsu, Session.sNomPc, Session.sDirIp)


                    If estado_process Then
                        MsgBox("Se proceso la retención Correctamente")
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL PROCESAR RETENCION: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
