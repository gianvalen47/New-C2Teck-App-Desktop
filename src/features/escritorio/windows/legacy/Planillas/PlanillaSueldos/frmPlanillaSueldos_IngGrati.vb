...
Public Class frmPlanillaSueldos_IngGrati
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoGrati
            registro = oPlanillaSueldosDetService.ObtenerIngresoGrati(IdPlanilla, IdPersona, IdRubro)
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
       ...
       And ValidaCampos() Then
            Dim registro As New PlanillaSueldosDetService.PlanillaSueldosDetIngresoGrati
    ...
    Private Sub Insertar(ByVal registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoGrati)
        Try
            Dim estado_process As Boolean
            estado_process = oPlanillaSueldosDetService.InsertarIngresoGrati(registro)
            type_process = "insert"
    ...
    Private Sub Modificar(ByVal registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoGrati)
        Try
            Dim estado_process As Boolean
            estado_process = oPlanillaSueldosDetService.ActualizarIngresoGrati(registro)
            type_process = "update"
            If estado_process = True Then
                IdRubro = toNumber(cmbIngreso.Value)
                Me.DialogResult = System.Windows.Forms.DialogResult.OK
