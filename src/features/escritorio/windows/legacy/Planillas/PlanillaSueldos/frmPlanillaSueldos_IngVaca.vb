...
Public Class frmPlanillaSueldos_IngVaca
    ...
    Private Sub llenarCombos()
        Try
            ...
            ''========================================== INGRESO ===============================================
            dtTipo = oPlanillaSueldosDetService.MostrarTipoVacaciones.Tables(0)
            cmbTipoVaca.DataSource = dtTipo
            cmbTipoVaca.DropDownList.DataMember = dtTipo.Columns("DesTipo").ToString
            cmbTipoVaca.DropDownList.DisplayMember = dtTipo.Columns("DesTipo").ToString
            cmbTipoVaca.DropDownList.ValueMember = dtTipo.Columns("IdTipo").ToString
            cmbTipoVaca.DropDownList.Columns(0).DataMember = dtTipo.Columns("IdTipo").ToString
            cmbTipoVaca.DropDownList.Columns(1).DataMember = dtTipo.Columns("DesTipo").ToString
            cmbTipoVaca.SelectedIndex = 0
            dtTipo = Nothing
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoVaca
            registro = oPlanillaSueldosDetService.ObtenerIngresoVaca(IdPlanilla, IdPersona, IdRubro, IdTipo)
            ...
            cmbTipoVaca.Value = registro.TipoVacacionesPlanilla.IdTipo
        Catch ex As Exception
    ...
    Private Sub desactivar()
        ...
        cmbTipoVaca.ReadOnly = False
        cmbTipoVaca.BackColor = System.Drawing.SystemColors.Window
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            If toBlank(txtItem.Value) = "" Then
                ...
                txtItem.Focus()
                Return False
            ElseIf toBlank(cmbIngreso.Value) = 0 Then
            ...
            ElseIf CodMon = "US" And txtMontoDol.Value = 0 Then
                ...
                txtMontoDol.Focus()
                Return False
            ElseIf toBlank(cmbTipoVaca.Value) = 0 Then
                MsgBox("Debe Ingresar el tipo de vacaciones.", MsgBoxStyle.Information, "Información")
                cmbTipoVaca.Focus()
                Return False
            Else
                Return True
    ...
    Private Sub btnGuardar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
       ...
       And ValidaCampos() Then
            Dim registro As New PlanillaSueldosDetService.PlanillaSueldosDetIngresoVaca
            ...
            Dim rubro As New PlanillaSueldosDetService.RubroIngresoPlanilla
            Dim tipo As New PlanillaSueldosDetService.TipoVacacionesPlanilla
            ...
            rubro.IdRubroIng = cmbIngreso.Value
            tipo.IdTipo = cmbTipoVaca.Value
            registro.TipoVacacionesPlanilla = tipo
            registro.RubroIngresoPlanilla = rubro
    ...
    Private Sub Insertar(ByVal registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoVaca)
        Try
            Dim estado_process As Boolean
            estado_process = oPlanillaSueldosDetService.InsertarIngresoVaca(registro)
            type_process = "insert"
            If estado_process = True Then
                IdRubro = toNumber(cmbIngreso.Value)
    ...
    Private Sub Modificar(ByVal registro As PlanillaSueldosDetService.PlanillaSueldosDetIngresoVaca)
        Try
            Dim estado_process As Boolean
            estado_process = oPlanillaSueldosDetService.ActualizarIngresoVaca(registro)
            type_process = "update"
            If estado_process = True Then
                IdRubro = toNumber(cmbIngreso.Value)
                Me.DialogResult = System.Windows.Forms.DialogResult.OK
