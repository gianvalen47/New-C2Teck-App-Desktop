...
Public Class rpFacturaImport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpFacturaImport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpFacturaImport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpFacturaImport = New rpFacturaImport()
        rpt.Site = Me.Site
        Return rpt
    End Function
