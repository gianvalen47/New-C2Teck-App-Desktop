...
Public Class rpRepCostoVentaGer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepCostoVentaGer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepCostoVentaGer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepCostoVentaGer = New rpRepCostoVentaGer()
        rpt.Site = Me.Site
        Return rpt
    End Function
