...
Public Class rptResumenGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptResumenGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptResumenGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptResumenGeneral = New rptResumenGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
