...
Public Class rptTransfMotores
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptTransfMotores.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTransfMotores
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTransfMotores = New rptTransfMotores()
        rpt.Site = Me.Site
        Return rpt
    End Function
