...
Public Class frmRepCostoMotores
    ...
    Private Sub frmRepCostoMotores_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 84)
        '/*************************************************************************************/
        ...
        Try
            ...
            ElseIf rbMotVend.Checked Then
                ...
                Else
                    ...
                    reporte.SetParameterValue("cbFecFinal", cbFecFinal.Text)
                    reporte.SetParameterValue("Titulo", "MOTORES")
            ...
            ElseIf rbCosAdi.Checked Then
                ...
                dtReporte = oDocumentoCostoService.ReporteCostoAdicionalMotor(cbAlmacen.Value, cbFecInicio.Text, cbFecFinal.Text).Tables(0).DefaultView
            ...
            ElseIf rbAccesVen.Checked Then
                ...
                Else
                    ...
                    reporte.SetParameterValue("cbFecInicio", cbFecInicio.Text)
                    reporte.SetParameterValue("cbFecFinal", cbFecFinal.Text)
                    reporte.SetParameterValue("Titulo", "ACCESORIOS")
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If ValidaCampos() Then
            oSeguridadService.RegistrarVisitaOpciones(84, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            MostrarReporte()
        End If
    End Sub
