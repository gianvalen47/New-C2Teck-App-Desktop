...
Public Class rptRepGmroiDetMer
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepGmroiDetMer.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepGmroiDetMer
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepGmroiDetMer = New rptRepGmroiDetMer()
        rpt.Site = Me.Site
        Return rpt
    End Function
