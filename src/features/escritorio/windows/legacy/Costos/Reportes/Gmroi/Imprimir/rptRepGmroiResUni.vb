...
Public Class rptRepGmroiResUni
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepGmroiResUni.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepGmroiResUni
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepGmroiResUni = New rptRepGmroiResUni()
        rpt.Site = Me.Site
        Return rpt
    End Function
