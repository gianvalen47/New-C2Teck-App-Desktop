...
Public Class rptActivoFijo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptActivoFijo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActivoFijo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActivoFijo = New rptActivoFijo()
        rpt.Site = Me.Site
        Return rpt
    End Function
