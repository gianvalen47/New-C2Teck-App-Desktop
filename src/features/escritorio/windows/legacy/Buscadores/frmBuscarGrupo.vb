...
Public Class frmBuscarGrupo
    ...
    Private Sub Seleccionar()
        Try
            codigo = dgvDatos.CurrentRow.Cells("CodGru").Text
            descripcion = dgvDatos.CurrentRow.Cells("DesGru").Text
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub listaDatos()
        Try
            ...
            dtDatos = oMaestro.FiltrarGrupoMerca(registro).Tables(0)
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("CodGru").Text = Nothing Then
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "CodGru", codigo)
        End If
    End Sub
