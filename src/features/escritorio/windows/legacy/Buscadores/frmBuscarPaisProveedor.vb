...
Public Class frmBuscarPaisProveedor

    Private oMaestro As New ProveedorService.ProveedorServiceClient
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("DesPais").Text
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub listaDatos()
        Try
            Dim registro As New MaestroService.Pais
            registro.CodPais = toBlank(txtCodPais.Text)
            registro.DesPais = toBlank(txtDesPais.Text)

            dtDatos = oMaestro.FiltrarPaisProveedor(registro.CodPais, registro.DesPais).Tables(0)
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("CodPais").Text = Nothing Then
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtDesPais.TextChanged, txtCodPais.TextChanged
        listaDatos()
    End Sub
