...
Public Class frmBuscarPedidoImportacion
    ...
    Private Sub frmBuscarPedidoImportacion_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmbProveedor.BackColor = System.Drawing.SystemColors.Control
        state_Search = False
        llenarCombos()
        cmbProveedor.Value = IdProveedor
        cmbProveedor.Text = DesProv
        cmbIdLocacion.Value = IdLocacion
        state_Search = True
        listaDatos()
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            numero = dgvDatos.CurrentRow.Cells("NumPed").Text
            IdLocacion = dgvDatos.CurrentRow.Cells("IdLocacion").Text
            IdProveedor = dgvDatos.CurrentRow.Cells("IdProveedor").Text
            CodMon = dgvDatos.CurrentRow.Cells("CodMon").Text
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
        ...
        Try
            If state_Search = True Then
                ...
                Else
                    ...
                    registro.Locacion = locacion
                End If
                proveedor.IdProveedor = toNumber(cmbProveedor.Value)
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtNumPed.TextChanged, cmbIdLocacion.ValueChanged, cmbOficinas.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "cIdPedidoImp", codigo)
        End If
    End Sub
