...
Public Class frmBuscarAplicacion
    ...
    Private Sub frmBuscarAplicacion_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Seleccionar()
        Try
            codigo = dgvDatos.CurrentRow.Cells("CodApl").Text
            descripcion = dgvDatos.CurrentRow.Cells("DesApl").Text
    ...
    Private Sub listaDatos()
        Try
            Dim registro As New MaestroService.AplicacionMerca
            registro.CodApl = toBlank(txtCodApl.Text)
            registro.DesApl = toBlank(txtDesApl.Text)

            dtDatos = oMaestro.FiltrarAplicacionMerca(registro).Tables(0)
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                ...
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("CodApl").Text = Nothing Then
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtCodApl.TextChanged, txtDesApl.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "CodApl", codigo)
        End If
    End Sub
