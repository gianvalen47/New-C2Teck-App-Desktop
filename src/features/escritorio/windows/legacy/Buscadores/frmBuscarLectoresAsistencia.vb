...
Public Class frmBuscarLectoresAsistencia

    Private oMaestro As New TablasPersonalService.TablasPersonalServiceClient
    ...
    Private Sub Salir_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
        ...
        End If
    End Sub
    Private Sub OnlyNumber_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) 'Handles txtCodGru.KeyPress
    ...
    Private Sub frmBuscarGrupo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Seleccionar()
        Try
            ...
            dirip = dgvDatos.CurrentRow.Cells("DirIp").Text
            puerto = dgvDatos.CurrentRow.Cells("Puerto").Text
            marca = dgvDatos.CurrentRow.Cells("Marca").Text
            modelo = dgvDatos.CurrentRow.Cells("Modelo").Text
            activo = dgvDatos.CurrentRow.Cells("Activo").Text
    ...
    Private Sub listaDatos()
        Try
            'Dim registro As New MaestroService.GrupoMerca
            'If txtCodGru.Text.Trim.Length > 0 Then
            '    registro.CodGru = CDbl(txtCodGru.Text)
            'End If
            'registro.DesGru = toBlank(txtDesGru.Text)

            dtDatos = oMaestro.MostrarEquipoMarcacion.Tables(0)
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtCodGru.TextChanged, txtDesGru.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "IdEquipo", codigo)
        End If
    End Sub
