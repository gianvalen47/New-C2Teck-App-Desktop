...
Public Class frmBuscarLocacionMercaderia

    Private oLocacionMercaderiaService As New LocacionMercaderiaService.LocacionMercaderiaServiceClient
    Private oProducto As New ProductoService.ProductoServiceClient
    ...
    Public costo_dolares As Double
    Public costo_soles As Double
    ...
    Private Sub frmBuscarLocacionMercaderia_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.DialogResult = System.Windows.Forms.DialogResult.Cancel
            Me.Close()
        End If
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        state_Search = True
        listaDatos()
        Me.Text = "Buscar Mercadería en almacén " + Chr(34) + oMaestro.MostrarDesLoc(IdLocacion) + Chr(34)
    End Sub
    ...
    Private Sub Seleccionar()
        Try
            ...
            descuento = 0.0
            costo_dolares = dgvDatos.CurrentRow.Cells("CosDol").Text
            costo_soles = dgvDatos.CurrentRow.Cells("CosSol").Text
            stock = toNumber(dgvDatos.CurrentRow.Cells("Stock").Text)
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                ...
                mercaderia.DesMer1 = toBlank(txtDesMer1.Text)
    ...
    Private Sub llenarCombos()
        Try
            '======================================= CLASES ================================================
            dtClases = oProducto.MostrarClasePorEmpresa(Session.sCodEmp).Tables(0)
            ...
            dtClases = Nothing
            '======================================= RUBROS ================================================
            dtRubros = oProducto.MostrarRubrosEmpresa(Session.sCodEmp).Tables(0)
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtDesMer1.TextChanged, txtCodMer.TextChanged, cmbCodRub.ValueChanged, cmbIdClase.ValueChanged
        listaDatos()
    End Sub
