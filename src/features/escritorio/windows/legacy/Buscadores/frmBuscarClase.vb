...
Public Class frmBuscarClase

    Private oMaestro As New MercaderiaService.MercaderiaServiceClient
    ...
    Private Sub Salir_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles _
        ...
        End If
    End Sub
    Private Sub OnlyNumber_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtIdClase.KeyPress
    ...
    Private Sub frmBuscarClase_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Seleccionar()
        Try
            ...
            descripcion = dgvDatos.CurrentRow.Cells("NomClas").Text
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub listaDatos()
        Try
            ...
            'If txtIdClase.Text.Trim.Length > 0 Then
            '    registro.IdClase = CInt(txtIdClase.Text)
            'End If
            'registro.NomClas = toBlank(txtNomClas.Text)

            dtDatos = oMaestro.FiltrarClaseMerca(Session.sCodEmp, toNull(txtIdClase.Text), toBlank(txtNomClas.Text)).Tables(0) 'oMaestro.FiltrarClaseMerca(registro).Tables(0)
    ...
    Private Sub dgvDatos_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvDatos.DoubleClick
        ...
        End If
    End Sub
    Private Sub btnBuscar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtNomClas.TextChanged, txtIdClase.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub miActualizar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miActualizar.Click
        ...
        If dgvDatos.RowCount > 0 And codigo.Trim.Length > 0 Then
            RowPossesion(dgvDatos, dtDatos, "IdClase", codigo)
        End If
    End Sub
