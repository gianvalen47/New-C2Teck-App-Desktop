...
Public Class frmRutasRuteador
    ...
    Private Sub frmRutasRuteador_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        Try
    ...
    Private Sub frmRutasRuteador_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
    ...
    Private Sub frmRutasRuteador_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 266)
        '/*************************************************************************************/
    ...
    Private Sub ListaDatos()
        Try
            dtDatos = oRondasService.MostrarRuteadorRutas().Tables(0)
    ...
    Private Sub nuevo()
        Try
            Dim frm As New frmRutaRuteador
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Ruta del Ruteador?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oRondasService.BorrarRuteadorRutas(CInt(dgvDatos.CurrentRow.Cells("IdRuteador").Value), dgvDatos.CurrentRow.Cells("CodRuta").Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo registro."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar registro actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar registro actual."
    End Sub
