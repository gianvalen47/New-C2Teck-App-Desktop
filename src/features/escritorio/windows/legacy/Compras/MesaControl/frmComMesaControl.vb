...
Public Class frmComMesaControl
    ...
    '==========================Evento FormClosed==================================
    Private Sub frmComMesaControl_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    '==========================Evento KeyDown===============================
    Private Sub frmComMesaControl_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub enableOpciones()
        ...
        Else
            ...
            biProcesar.Enabled = IIf(lEstado = "Aprobado" Or lEstado = "Aprobacion Extraordinaria", True, False)
            biAprobar.Enabled = IIf(lEstado = "Generado", True, False)
            biVerEstados.Enabled = True

            miImprimir.Enabled = True
            miMostrar.Enabled = True
            miEliminar.Enabled = IIf(lEstado = "Generado", True, False)
            miProcesar.Enabled = IIf(lEstado = "Aprobado" Or lEstado = "Aprobacion Extraordinaria", True, False)
            miAprobar.Enabled = IIf(lEstado = "Generado", True, False)
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdMesa").Value = codigo Then
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmComMesaControl_Nuevo           
            frm.state_button = True ' Mostrar
            frm.IdMesa = dgvDatos.CurrentRow.Cells("IdMesa").Text
            frm.edicion = False
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing                
                RowPossesion(dgvDatos, frm.IdMesa)
            Else            
            End If
            Actualizar()
            enableOpciones()
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR MESA DE CONTROL : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR la Mesa de Control Nº " + dgvDatos.CurrentRow.Cells("IdMesa").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                Dim estado_process As Boolean
                estado_process = oMesaControlService.Borrar(CInt(dgvDatos.CurrentRow.Cells("IdMesa").Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR MESA DE CONTROL:" + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Procesar()
        'Try
        '    cmbOpciones.Visible = False
        '    If MsgBox("¿Está seguro de PROCESAR la Mesa de Control Nº " + dgvDatos.CurrentRow.Cells("IdMesa").Text.ToString, MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
        '        Dim estado_process As Boolean
        'estado_process = oMesaControlService.Procesar(CInt(dgvDatos.CurrentRow.Cells("IdMesa").Text), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
        '        If estado_process = True Then
        '            Actualizar()
        '            MsgBox("Se proceso correctamente el registro...!!!", MsgBoxStyle.Information)
        '        Else
        '            MsgBox("Error en el proceso, comuníquese con el departamento de sistemas...!", MsgBoxStyle.Critical)
        '        End If
        '    End If
        'Catch ex As Exception
        '    MsgBox("ERROR AL PROCESAR MESA DE CONTROL:" + ex.Message, MsgBoxStyle.Exclamation)
        'End Try
    End Sub
    ...
    Private Sub Nuevo()
        Try
            Dim frm As New frmComMesaControl_Nuevo
            frm.state_button = False ' Nuevo
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                txtAnio.Value = frm.Anio
                dtDatos = Nothing
                listaDatos()
                RowPossesion(dgvDatos, frm.IdMesa)
                mostrar()
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR NUEVA MESA DE CONTROL: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biAprobar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biAprobar.Click
        Try
            If ValidaCodigoSeleccionado() Then
                ...
                frm.IdMesa = dgvDatos.CurrentRow.Cells("IdMesa").Value
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oMesaControlService.Filtrar(Session.sCodEmp, CInt(txtAnio.Value), CStr(cmbCodArea.Value), IIf(toBlank(txtIdGasto.Text) = "", 0, txtIdGasto.Text), cmbEstado.Value, IIf(toBlank(txtIdMesa.Text) = "", 0, txtIdMesa.Text)).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtAnio.TextChanged, cmbCodArea.ValueChanged, cmbEstado.ValueChanged, txtIdGasto.TextChanged, txtIdMesa.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub biEliminar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.Click, miEliminar.Click
        ...
        End If
    End Sub
    Private Sub biProcesar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biProcesar.Click, miProcesar.Click
        Try
            If ValidaCodigoSeleccionado() Then
                Dim frm As New frmComMesaControl_Procesar
                frm.IdMesa = dgvDatos.CurrentRow.Cells("IdMesa").Value
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    biRefrescar_Click(sender, e)
                End If
            End If
        Catch ex As Exception
            MsgBox("ERROR AL PROCESAR LA MESA DE CONTROL : " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdMesa").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub biVerEstados_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biVerEstados.Click, miVerEstados.Click
        Try
            If ValidaCodigoSeleccionado() Then
                Dim frm As New frmComMesaControl_Estados
                frm.IdMesa = dgvDatos.CurrentRow.Cells("IdMesa").Value
                frm.Text = "Estados de la Mesa de Control Nº " & dgvDatos.CurrentRow.Cells("IdMesa").Value
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biImprimir.MouseEnter, miImprimir.MouseEnter
        sslError.Text = "Imprimir Mesa de Control actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Mesa de Control."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Mesa de Control actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Mesa de Control actual."
    End Sub    
    Private Sub Aprobar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biAprobar.MouseEnter, miAprobar.MouseEnter
        sslError.Text = "Aprobar Mesa de Control actual."
    End Sub
    Private Sub Procesar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biProcesar.MouseEnter, miProcesar.MouseEnter
        sslError.Text = "Procesar Mesa de Control actual."
    End Sub
    Private Sub VerEstados_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biVerEstados.MouseEnter, miVerEstados.MouseEnter
        sslError.Text = "Ver Estados de Mesa de Control actual."
    End Sub
        ...
        Try
            ...
            If dgvDatos.RowCount > 0 Then
                ...
                Else
                    ...
                    reporte.SetParameterValue("pIdMesa", dgvDatos.CurrentRow.Cells("IdMesa").Value)
