...
Public Class frmComSolicitudGastos
    ...
    Private Sub biImprimir_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            If ValidaCodigoSeleccionado() Then
                ...
                frm.IdProvisional = IIf(IsDBNull(dgvDatos.CurrentRow.Cells("IdProvisional").Value), 0, dgvDatos.CurrentRow.Cells("GastoViaje").Value)
                frm.ShowDialog()
            End If
        Catch ex As Exception
            MsgBox(ex.Message, MsgBoxStyle.Exclamation)
