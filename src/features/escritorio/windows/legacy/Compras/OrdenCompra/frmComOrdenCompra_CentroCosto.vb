...
Public Class frmComOrdenCompra_CentroCosto
    ...
    'Private Sub cmbCodArea_ValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cmbCodArea.ValueChanged
    '    Try
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As OrdenesCompraDetService.FacturaOrdenCentroCosto
            registro = oOrdenesCompraDetService.ObtenerCentroCosto(IdOrdenDoc, CodCentro)
