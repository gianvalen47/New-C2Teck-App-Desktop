...
Public Class frmComOrdenCompra_Archivos

    Private oOrdenCompra As New OrdenesCompraService.OrdenesCompraServiceClient
    ...
    Private Sub listaDatos()
        Try
            ...
            dtDatos = oOrdenCompra.MostrarArchivo(IdOrden).Tables(0)
    ...
    Private Sub biNuevo_Click(sender As Object, e As EventArgs) Handles biNuevo.Click, miNuevo.Click
        ...
        While lLog
            Dim frm As New frmComOrdenCompra_Archivos_Nuevo
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdOrdenArchivo").Value = codigo Then
    ...
    Private Sub mostrar()
        ...
        Try
            ...
            Dim idArchivo As Int64 = dgvDatos.CurrentRow.Cells("IdOrdenArchivo").Text

            Dim registro As OrdenesCompraService.OrdenesCompraArchivos
            registro = oOrdenCompra.ObtenerArchivo(idArchivo)
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el archivo seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oOrdenCompra.BorrarArchivo(toNumber(dgvDatos.CurrentRow.Cells("IdOrdenArchivo").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdOrdenArchivo").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Function ValidaCodigoSeleccionado() As Boolean
        Try
            ...
            ElseIf dgvDatos.CurrentRow.RowIndex < 0 Then
                MsgBox("¡Seleccione un registro...!", MsgBoxStyle.Information, "Información")
                Return False
            ElseIf dgvDatos.CurrentRow.Cells("IdOrdenArchivo").Text = Nothing Then
                MsgBox("Registro Vacío", MsgBoxStyle.Information, "Información")
                Return False
            Else
                Return True
    ...
    Private Sub ModificarArchivo()
        ...
        Dim frm As New frmComOrdenCompra_Archivos_Actualizar
        frm.IdArchivo = dgvDatos.CurrentRow.Cells("IdOrdenArchivo").Text
