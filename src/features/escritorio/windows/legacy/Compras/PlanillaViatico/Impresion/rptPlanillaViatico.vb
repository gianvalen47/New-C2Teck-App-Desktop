...
Public Class rptPlanillaViatico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptPlanillaViatico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPlanillaViatico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPlanillaViatico = New rptPlanillaViatico()
        rpt.Site = Me.Site
        Return rpt
    End Function
