...
Public Class rptCalendario1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptCalendario1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCalendario1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCalendario1 = New rptCalendario1()
        rpt.Site = Me.Site
        Return rpt
    End Function
