...
Public Class rptGenerarVale
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptGenerarVale.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGenerarVale
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGenerarVale = New rptGenerarVale()
        rpt.Site = Me.Site
        Return rpt
    End Function
