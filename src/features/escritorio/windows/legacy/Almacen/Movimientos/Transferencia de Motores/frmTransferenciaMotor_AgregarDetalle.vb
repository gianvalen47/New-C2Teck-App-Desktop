...
Public Class frmTransferenciaMotor_AgregarDetalle
    ...
    Private Sub txtCosDol_Validating(sender As Object, e As CancelEventArgs) Handles txtCosDol.Validating
        Try
            'If oLocacionMercaderiaService.Buscar(1, txtCodMer.Text) = False Then
            If txtCosDol.Value > 0 Then
