...
Public Class frmCompraMotor_AgregarDetalle
    ...
    '============================================ PARAMETROS LOCALES ====================================================
    '====================================================================================================================
    Public IdCompraMotDet As Integer
    ...
    Private Sub frmCompraMotor_AgregarDetalle_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Function ValidaCampos() As Boolean
        Try
            If toNumber(IdCompraMot) = 0 Then
                MsgBox("Debe Ingresar el código del Compra de motor. ", MsgBoxStyle.Information, "Información")
                Return False
            ...
            ElseIf toDouble(txtPreMer.Text) <= 0 Then
                ...
                txtPreMer.Focus()
                Return False
            ElseIf toDouble(txtCosDol.Text) <= 0 Then
                MsgBox("Debe ingresar el Costo Dolares del artículo ", MsgBoxStyle.Information, "Información")
                txtCosDol.Focus()
                Return False
            ElseIf toDouble(txtCosSol.Text) <= 0 Then
                MsgBox("Debe ingresar el Costo Soles del artículo ", MsgBoxStyle.Information, "Información")
                txtCosSol.Focus()
                Return False
            ElseIf state_button = False And oComprasMotorDetService.Buscar(IdCompraMot, toBlank(txtCodMer.Text)) Then
        ...
        End Try
    End Function
    Private Sub Insertar(ByVal registro As ComprasMotorDetService.ComprasMotorDet)
        Try
            Dim estado_process As Integer
            estado_process = oComprasMotorDetService.Insertar(registro)
            type_process = "insert"
            If estado_process > 0 Then
                IdCompraMotDet = estado_process
        ...
        End Try
    End Sub
    Private Sub Modificar(ByVal registro As ComprasMotorDetService.ComprasMotorDet)
        Try
            Dim estado_process As Boolean
            estado_process = oComprasMotorDetService.Actualizar(registro)
            type_process = "update"
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ComprasMotorDetService.ComprasMotorDet
            registro = oComprasMotorDetService.MostrarPorId(toNumber(IdCompraMotDet))

            IdCompraMotDet = registro.IdCompraMotDet
            IdCompraMot = registro.ComprasMotor.IdCompraMot
            ...
            estado = oComprasMotorService.Estado(IdCompraMot)
        Catch ex As Exception
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
            ...
            Dim registro As New ComprasMotorDetService.ComprasMotorDet
            Dim comprasMotor As New ComprasMotorDetService.ComprasMotor

            registro.IdCompraMotDet = IIf(toNumber(IdCompraMotDet) = 0, Nothing, IdCompraMotDet)
            comprasMotor.IdCompraMot = IdCompraMot
            registro.ComprasMotor = comprasMotor
    ...
    Private Sub btnBuscarMercaderia_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnBuscarMercaderia.Click
        ...
        If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
            ...
            If CodMon = "NS" Then
                txtCosSol.Text = toDouble(txtPreMer.Text)
                txtCosDol.Text = toDouble(txtPreMer.Text / oMaestroService.MostrarTipoCambio("US", Fecha))
        ...
        Try
            If Len(Trim(txtCodMer.Text)) > 0 And state_button = False Then
                ...
                If oMercaderiaService.Buscar(txtCodMer.Text, Session.sCodEmp) Then
                    ...
                    txtDscMer.Text = 0.0
                    'txtCosDol.Text = mercaderia.CosDol
                    'txtCosSol.Text = mercaderia.CosSol
    ...
    Private Sub txtPreMer_Validating(ByVal sender As Object, ByVal e As System.ComponentModel.CancelEventArgs) Handles txtPreMer.Validating
        Try
            'If oLocacionMercaderiaService.Buscar(IdLocacion, txtCodMer.Text) = False Then
            If CodMon = "NS" Then
                txtCosSol.Text = toDouble(txtPreMer.Text) 'toDouble(txtPreMer.Text * oMaestroService.MostrarTipoCambio("US", Fecha))
                txtCosDol.Text = toDouble(txtPreMer.Text / oMaestroService.MostrarTipoCambio("US", Fecha))
            ElseIf CodMon = "US" Then
                txtCosSol.Text = toDouble(txtPreMer.Text * oMaestroService.MostrarTipoCambio("US", Fecha))
                txtCosDol.Text = toDouble(txtPreMer.Text)
