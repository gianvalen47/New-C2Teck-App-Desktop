...
Public Class rptMovAlmacen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptMovAlmacen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovAlmacen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovAlmacen = New rptMovAlmacen()
        rpt.Site = Me.Site
        Return rpt
    End Function
