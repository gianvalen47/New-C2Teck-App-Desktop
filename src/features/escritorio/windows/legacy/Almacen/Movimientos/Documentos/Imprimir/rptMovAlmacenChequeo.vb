...
Public Class rptMovAlmacenChequeo
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptMovAlmacenChequeo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptMovAlmacenChequeo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovAlmacenChequeo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovAlmacenChequeo = New rptMovAlmacenChequeo()
        rpt.Site = Me.Site
        Return rpt
    End Function
