...
Public Class rpRepInventario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepInventario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepInventario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepInventario = New rpRepInventario()
        rpt.Site = Me.Site
        Return rpt
    End Function
