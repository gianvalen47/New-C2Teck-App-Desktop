...
Public Class frmRepTomaInventario
    ...
    Private Sub frmRepTomaInventario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 13)
        '/*************************************************************************************/
            ...
            Else
                If rbExportExcel.Checked Then
                    ...
                    ElseIf rbsinceros.Checked Then
                        If rbDisponible.Checked Or rbSinDisponible.Checked Then
                ...
                Else
                    ...
                    ElseIf rbDisponible.Checked Then
                        ...
                        reporte.SetParameterValue("Marca", txtMarca.Text)
                        reporte.SetParameterValue("Aplicacion", txtAplicacion.Text)
                    ElseIf rbSinDisponible.Checked Then
                        reporte.SetParameterValue("Stock", "s")
                        reporte.SetParameterValue("Fecha", txtFecha.Text)
                        reporte.SetParameterValue("Marca", txtMarca.Text)
                        reporte.SetParameterValue("Aplicacion", txtAplicacion.Text)
                    End If
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        oSeguridadService.RegistrarVisitaOpciones(13, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
        MostrarReporte()
    End Sub
    ...
    Private Sub btnUnificado_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUnificado.Click
        MostrarReporteUnificado()
    End Sub

    Private Sub MostrarReporteUnificado()
        Try
            Dim forma As New frmReportes
            Dim reporte As New rpRepUnificadoComServ
            Dim dtReporte As New DataView

            dtReporte = oLocacionMercaderiaService.ReporteUnificadoComServ(txtFecha.Text, IIf(rbMarca.Checked, "", codMar), IIf(rbAplicacion.Checked, "", codApl), txtUbiMer.Text, cmbIdClase.Value, TipUbic, IIf(cmbCodRub.Value = "(Todos)", "", cmbCodRub.Value), IIf(cmbTipMot.Text = "(Todos)", "", cmbTipMot.Value), IIf(cmbModMer.Text = "(Todos)", "", cmbModMer.Value), IIf(cbUbicacion.Checked = True, 2, 1), IIf(rbReman.Checked = True, "1", "0")).Tables(0).DefaultView
            If dtReporte.Count = 0 Then
                MsgBox("No hay Datos que mostrar, verifique.!!!!!!", MsgBoxStyle.Information, "No hay datos")
            Else
                If rbExportExcel.Checked Then
                ...
                Else
                    ...
                    forma.Text = "Reporte Unificado de Comercial y Servicios"
                    If rbSinStock.Checked Then
                        reporte.SetParameterValue("Stock", "")
                        reporte.SetParameterValue("Fecha", txtFecha.Text)
                        reporte.SetParameterValue("Marca", txtMarca.Text)
