...
// Original: Almacen/Consultas/Documentos/frmConsultaDocumentoAlmacen.vb
...
export default function frmConsultaDocumentoAlmacen() {
  return (
    <div style={padding:20}>
      ...
      <p>Original file copied to: <code>Almacen/Consultas/Documentos/frmConsultaDocumentoAlmacen.vb</code></p>
