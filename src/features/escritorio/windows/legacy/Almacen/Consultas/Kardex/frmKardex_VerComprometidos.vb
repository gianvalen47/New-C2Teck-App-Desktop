Public Class frmKardex_VerComprometidos
    ...
    Private Sub frmKardex_VerComprometidos_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmKardex_VerComprometidos_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmKardex_VerComprometidos_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.Text = "Lista de Stock Comprometido de la Mercadería ( " + CodMer + " )"
    End Sub
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oValeMaterialDetService.MostrarComprometidos(IdLocacion, CodMer).Tables(0)
