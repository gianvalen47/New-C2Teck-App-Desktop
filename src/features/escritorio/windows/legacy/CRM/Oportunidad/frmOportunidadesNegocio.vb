...
Public Class frmOportunidadesNegocio
    ...
    Private Sub frmOportunidadNegocio_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 291)
        '/*************************************************************************************/
    ...
    Private Sub mostrar()
        Try
            ...
            frm.iEtapa = dgvDatos.CurrentRow.Cells("IdEtapa").Text
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtAnio.ValueChanged, txtCliente.TextChanged, _
                                                                                                                                                cmbVendedor.ValueChanged, cmbEtapa.ValueChanged, txtNombre.TextChanged
        listaDatos()
    End Sub
    ...
    Private Sub biImprimir_Click(sender As Object, e As System.EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            ...
            Dim reporte As New rpOportunidadNegocio

            If dgvDatos.RowCount > 0 Then
                dtReporte = oOportunidadNegocioService.Imprimir(dgvDatos.CurrentRow.Cells("IdOportunidad").Text).Tables(0)
                ...
                Else
                    ...
                    forma.Text = "Reporte de Oportunidad de Negocio"
                    forma.ShowDialog()
                End If
            Else
    ...
    Private Sub biRegistrarArchivos_Click(sender As Object, e As EventArgs) Handles biRegistrarArchivos.Click, miRegistrarArchivos.Click
        Try
            Dim frm As New frmOportunidadNegocio_Archivos
            frm.IdOportunidad = dgvDatos.CurrentRow.Cells("IdOportunidad").Value
    ...
    Private Sub biGastos_Click(sender As Object, e As EventArgs) Handles biGastos.Click, miGastos.Click
        Try
            If ValidaCodigoSeleccionado() Then
                Dim frm As New frmOportunidadNegocio_Gastos
                frm.IdOportunidad = dgvDatos.CurrentRow.Cells("IdOportunidad").Value
                frm.Text = "Mostrar Gastos de la Oportunidad de Negocio Nº " & dgvDatos.CurrentRow.Cells("IdOportunidad").Value & " - Gastos"
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                End If
            End If
        Catch ex As Exception
