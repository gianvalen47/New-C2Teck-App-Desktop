...
Public Class frmRepLibroDiario
    ...
    Private Sub frmRepLibroDiario_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRepLibroDiario_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRepLibroDiario_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try

            '/************************** Insertar Opciones de Session ************************/
            oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 188)
            '/*************************************************************************************/
    ...
    Private Sub MostrarReporte()
        ...
        Try
            ...
            Dim Reporte As New rpRepLibroDiario
            Dim forma As New frmReportes

            dtReporte = oContabilidadService.ReporteLibroDiario(Session.sCodEmp, toNumber(cmbUnidad.Value), toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), cbFecInicio.Value, cbFecFinal.Value, cmbMoneda.Value).Tables(0)
            ...
            Else
                ...
                Else
                    ...
                    forma.Text = "Reporte Libro Diario"
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        ...
        If validarCampos() Then
            oSeguridadService.RegistrarVisitaOpciones(188, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            MostrarReporte()
        End If
