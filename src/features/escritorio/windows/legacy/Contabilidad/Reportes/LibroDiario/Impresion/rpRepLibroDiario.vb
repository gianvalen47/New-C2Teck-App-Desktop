...
Public Class rpRepLibroDiario
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepLibroDiario.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepLibroDiario
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepLibroDiario = New rpRepLibroDiario()
        rpt.Site = Me.Site
        Return rpt
    End Function
