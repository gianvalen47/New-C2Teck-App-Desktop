...
Public Class frmRepContCtasCtes
    ...
    Private Sub frmRepCtasCtes_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 197)
        '/*************************************************************************************/

        txtFechaInicio.Value = CDate("01" & "/" & Month(Today) & "/" & Year(Today))
    ...
    Private Sub MostrarReporte()
        Try
            ...
            Dim reporte As New rpContCtasCtes

            oContabilidadService.InnerChannel.OperationTimeout = TimeSpan.FromMinutes(20)
            dtReporte = oContabilidadService.ReporteCtaCtes(Session.sCodEmp, toNumber(cmbUnidad.Value), toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), txtFechaInicio.Value, txtFechaFinal.Value, IdProveedor, IdPersona, txtCodCuenta1.Text, txtCodCuenta2.Text).Tables(0)
            ...
            Else
                ...
                forma.Text = "Reporte de Cuentas Corrientes"
