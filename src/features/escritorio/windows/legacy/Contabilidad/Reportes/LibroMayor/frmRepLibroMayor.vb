...
Public Class frmRepLibroMayor
    ...
    Private Sub frmRepLibroMayor_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRepLibroMayor_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRepLibroMayor_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            ...
            oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 189)
            '/*************************************************************************************/
    ...
    Private Sub btnAceptar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        If validarCampos() Then
            oSeguridadService.RegistrarVisitaOpciones(189, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            MostrarReporte()
        End If
    End Sub
    ...
    Private Sub MostrarReporte()
        Try
            ...
            Dim Reporte As New rpRepLibroMayor
            Dim forma As New frmReportes

            dtReporte = oContabilidadService.ReporteLibroMayor(Session.sCodEmp, toNumber(cmbUnidad.Value), toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), cbFecInicio.Value, cbFecFinal.Value, cmbMoneda.Value, txtCtaMayor.Text).Tables(0)
            ...
            Else
                ...
                forma.Text = "Reporte Libro Mayor"
    ...
    Private Function validarCampos() As Boolean
        Try
            ...
            ElseIf Year(cbFecInicio.Value) <> Year(cbFecInicio.Value) Then
                ...
                cbFecInicio.Focus()
                Return False
            ElseIf toBlank(txtCtaMayor.Text) = "" Then
                MsgBox("Debge ingresar la cuenta mayor")
                txtCtaMayor.Focus()
                Return False
            Else
                Return True
