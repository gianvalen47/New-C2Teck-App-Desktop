...
Public Class rptRegistroCompras
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRegistroCompras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRegistroCompras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRegistroCompras = New rptRegistroCompras()
        rpt.Site = Me.Site
        Return rpt
    End Function
