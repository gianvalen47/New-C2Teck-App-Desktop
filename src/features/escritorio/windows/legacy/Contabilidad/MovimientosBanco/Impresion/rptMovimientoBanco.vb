...
Public Class rptMovimientoBanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptMovimientoBanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMovimientoBanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMovimientoBanco = New rptMovimientoBanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
