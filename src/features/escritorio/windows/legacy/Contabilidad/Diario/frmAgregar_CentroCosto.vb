...
Public Class frmAgregar_CentroCosto
    ...
    Private Sub frmAgregar_CentroCosto_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub frmAgregar_CentroCosto_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub listaSeleccionados()
        Try
            ...
            '=================================== LISTA SELECCIONADOS ===================================
            If toNumber(IdContabilidadDet) > 0 Then
                dtSeleccionados = oContabilidadDetService.MostrarCentroCosto(IdContabilidadDet).Tables(0)
            ElseIf toNumber(IdTesoreriaDet) > 0 Then
                dtSeleccionados = oTesoreriaDetService.MostrarCentroCosto(IdTesoreriaDet).Tables(0)
            End If
    ...
    Private Sub cbProrratear_CheckedChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cbProrratear.CheckedChanged
        ...
        Else
            If cbProrratear.Checked = True Then
                ...
                Dim MontoPorrateadoSol As Double
                Dim MontoPorrateadoDol As Double
                Dim Cont As Integer = 0
                ...
                MontoPorrateadoSol = MontoSoles / Cont
                MontoPorrateadoDol = MontoDolares / Cont

                For i As Integer = 0 To dgvSeleccionados.RowCount - 1
                    dgvSeleccionados.Rows(i).Cells("cMontoSol").Value = MontoPorrateadoSol
                    dgvSeleccionados.Rows(i).Cells("cMontoDol").Value = MontoPorrateadoDol
                Next
            ...
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    If ValidaBalanceMontos() Then
                        ...
                        If toNumber(IdContabilidadDet) > 0 Then
                            state_process = oContabilidadDetService.InsertarCentroCosto(IdContabilidadDet, IdContabilidad, dtTable, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                        ElseIf toNumber(IdTesoreriaDet) > 0 Then
                            state_process = oTesoreriaDetService.InsertarCentroCosto(IdTesoreriaDet, IdTesoria, dtTable, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
                        End If
