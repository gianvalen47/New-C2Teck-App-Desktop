...
Public Class rptCheque_Wise
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptCheque_Wise.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheque_Wise
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheque_Wise = New rptCheque_Wise()
        rpt.Site = Me.Site
        Return rpt
    End Function
