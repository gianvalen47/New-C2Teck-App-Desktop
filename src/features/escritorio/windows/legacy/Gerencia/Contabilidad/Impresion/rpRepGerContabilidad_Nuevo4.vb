...
Public Class rpRepGerContabilidad_Nuevo4
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpRepGerContabilidad_Nuevo4.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepGerContabilidad_Nuevo4.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_DesCli() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrpRepGerContabilidad_Nuevo4
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepGerContabilidad_Nuevo4 = New rpRepGerContabilidad_Nuevo4()
        rpt.Site = Me.Site
        Return rpt
    End Function
