...
Public Class rpRepJobSerEst
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepJobSerEst.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepJobSerEst
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepJobSerEst = New rpRepJobSerEst()
        rpt.Site = Me.Site
        Return rpt
    End Function
