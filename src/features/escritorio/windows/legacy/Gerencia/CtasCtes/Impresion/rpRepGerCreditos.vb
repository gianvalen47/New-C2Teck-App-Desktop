...
Public Class rpRepGerCreditos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepGerCreditos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepGerCreditos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepGerCreditos = New rpRepGerCreditos()
        rpt.Site = Me.Site
        Return rpt
    End Function
