...
Public Class rptColaborador
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptColaborador.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptColaborador
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptColaborador = New rptColaborador()
        rpt.Site = Me.Site
        Return rpt
    End Function
