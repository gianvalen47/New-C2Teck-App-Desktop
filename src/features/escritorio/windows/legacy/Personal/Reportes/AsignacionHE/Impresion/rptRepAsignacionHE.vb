...
Public Class rptRepAsignacionHE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepAsignacionHE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepAsignacionHE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepAsignacionHE = New rptRepAsignacionHE()
        rpt.Site = Me.Site
        Return rpt
    End Function
