...
Public Class frmRepAsignacionHE
    ...
    Private Sub frmRepAsignacionHE_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub frmRepAsignacionHE_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRepAsignacionHE_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            If ValidaCampos() Then
                ...
                oSeguridadService.RegistrarVisitaOpciones(219, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)

                Dim forma As New frmReportes
                Dim reporte As New rptRepAsignacionHE
                Dim dtReporte As New DataTable

                dtReporte = oAsignacionHoraExtraService.Reporte(Session.sCodEmp, toBlank(cmbClase.Value), toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), txtFecInicio.Value, _
                                                                                          txtFecFinal.Value, toNumber(cmbPerAutoriza.Value), IdPersona, txtNumJob.Text).Tables(0)
