...
Public Class rptRepIngresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepIngresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepIngresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepIngresos = New rptRepIngresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
