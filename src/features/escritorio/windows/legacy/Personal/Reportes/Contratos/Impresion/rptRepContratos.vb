...
Public Class rptRepContratos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepContratos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepContratos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepContratos = New rptRepContratos()
        rpt.Site = Me.Site
        Return rpt
    End Function
