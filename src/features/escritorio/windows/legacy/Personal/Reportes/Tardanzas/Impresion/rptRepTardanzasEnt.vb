...
Public Class rptRepTardanzasEnt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepTardanzasEnt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRepTardanzasEnt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepTardanzasEnt = New rptRepTardanzasEnt()
        rpt.Site = Me.Site
        Return rpt
    End Function
