...
Public Class frmRepDescuentos
    ...
    Private Sub frmRepDescuentos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Finalizar()
    End Sub
    ...
    Private Sub frmRepDescuentos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRepDescuentos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 222)
        '/*************************************************************************************/
    ...
    Private Sub btnAceptar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnAceptar.Click
        Try
            If ValidaCampos() Then
                ...
                Dim reporte As New rptRepDescuentos
                Dim dtReporte As New DataTable

                oSeguridadService.RegistrarVisitaOpciones(222, "SIGECOM", Session.sCodUsu, Session.sNomPc, Session.sDirIp)

                dtReporte = oDescuentoPersonalService.Reporte(Session.sCodEmp, toBlank(cmbClase.Value), toBlank(cmbArea.Value), toBlank(cmbCentroCosto.Value), txtFecInicio.Value, txtFecFinal.Value _
                                                                                  , toNumber(cmbDescuento.Value), IdPersona).Tables(0)
