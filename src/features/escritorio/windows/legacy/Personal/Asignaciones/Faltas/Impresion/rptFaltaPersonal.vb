...
Public Class rptFaltaPersonal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptFaltaPersonal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptFaltaPersonal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptFaltaPersonal = New rptFaltaPersonal()
        rpt.Site = Me.Site
        Return rpt
    End Function
