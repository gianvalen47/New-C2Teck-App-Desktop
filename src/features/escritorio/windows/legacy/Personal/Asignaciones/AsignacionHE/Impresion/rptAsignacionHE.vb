...
Public Class rptAsignacionHE
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptAsignacionHE.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAsignacionHE
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAsignacionHE = New rptAsignacionHE()
        rpt.Site = Me.Site
        Return rpt
    End Function
