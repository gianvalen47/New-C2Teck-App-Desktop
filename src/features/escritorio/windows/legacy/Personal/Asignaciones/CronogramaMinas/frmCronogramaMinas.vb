...
Public Class frmCronogramaMinas
    '===========================Servicios====================================================
    ...
    Private Sub frmCronogramaMinasLoad(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 295)
        '/*************************************************************************************/
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdCronograma").Value = codigo Then
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmCronograMina
            frm.state_button = True
            frm.IdCronograma = dgvDatos.CurrentRow.Cells("IdCronograma").Text
            frm.ApeNom = dgvDatos.CurrentRow.Cells("ApeNom").Text
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
                If frm.type_process = "update" Then
                    RowPossesion(dgvDatos, frm.IdCronograma)
                Else
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el Cronograma seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oAsignacionHorarioService.BorrarCronograma(toNumber(dgvDatos.CurrentRow.Cells("IdCronograma").Value), Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                ...
                frm.iCodUbicacion = toBlank(cmbUbicacion.Value)
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    dtDatos = Nothing
                    listaDatos()
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oAsignacionHorarioService.FiltrarCronograma(Session.sCodEmp, txtAnio.Value, cmbMes.Value, IdPersona, cmbUbicacion.Value, toNumber(cmbTipo.Value)).Tables(0)
    ...
    Private Sub btnBuscar_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnBuscar.Click, txtAnio.ValueChanged, txtSolicitante.TextChanged, cmbMes.ValueChanged, cmbUbicacion.ValueChanged, cmbTipo.ValueChanged
        listaDatos()
    End Sub
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("IdCronograma").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub Limpiar_MouseLeave(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _
                             ...
                             biIngresarCronogramaMinaMasivo.MouseLeave, miIngresarCronogramaMinaMasivo.MouseLeave
        sslError.Text = ""
    End Sub
    ...
    End Sub
    Private Sub CrnogramaMasivo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biIngresarCronogramaMinaMasivo.MouseEnter, miIngresarCronogramaMinaMasivo.MouseEnter
        sslError.Text = "Ingresar Cronogramas de Mina Masivo."
    End Sub

    Private Sub biIngresarCronogramaMinaMasivo_Click(sender As System.Object, e As System.EventArgs) Handles biIngresarCronogramaMinaMasivo.Click, miIngresarCronogramaMinaMasivo.Click
        Try
            Dim frm As New frmCronogramaMina_Masivo
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                Actualizar()
            End If
            Actualizar()
        Catch ex As Exception
            MsgBox("Error al ingresar CRONOGRAMA DE MINA MASIVO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
End Class
