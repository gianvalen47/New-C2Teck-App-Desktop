...
Public Class frmIngresoPersonal_IngresoDescansoMedico
        ...
        Try
            If MsgBox("¿Está seguro de INSERTAR los Descansos Medicos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    estado_process = oDescuentoPersonalService.InsertarDescansoMedico(Session.sCodEmp, toBlank(cmbClase.Value), txtFecInicio.Value, txtFecFinal.Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
