...
Public Class frmIngresosPersonal_Masivo
    ...
    Private Sub frmIngresosPersonal_Masivo_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
    ...
    Private Sub frmIngresosPersonal_Masivo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        If e.KeyCode = Keys.Escape Then
            Me.DialogResult = System.Windows.Forms.DialogResult.Cancel
        End If
    End Sub

    Private Sub frmIngresosPersonal_Masivo_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Function ValidaCampos() As Boolean
        Try
            ...
            ElseIf toBlank(cmbIngreso.Value) = "" Then
                MsgBox("Debe Ingresar el rubro del ingreso.", MsgBoxStyle.Information, "Información")
                cmbIngreso.Focus()
                Return False
        ...
        Try
            ...
            If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes Then
                If ValidaCampos() Then
                    ...
                    If ContMonto > 0 Then
                        MsgBox("Debe ingresar el monto de ingreso a todos los colaboradores seleccionados.", MsgBoxStyle.Information, "Información")
                    Else
                        Dim Cont As Integer = 0

                        For i As Integer = 0 To dgvSeleccionados.RowCount - 1
                            Dim registro As New IngresoPersonalService.IngresoPersonal
                            Dim Colaborador As New IngresoPersonalService.Persona
                        ...
                        If Cont > 0 Then
                            MsgBox("Se insertó el(los) Ingreso(s) Correctamente.", MsgBoxStyle.Information, "Información")
                            LimpiarDatos()
                            listaDatos()
                        End If
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL GENERAR INGRESO(S) MASIVO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
