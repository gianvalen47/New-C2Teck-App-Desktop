Public Class frmClienteFacDsc
  ...
  Private Sub Eliminar()
    Try
      Dim estado_process As Boolean
            estado_process = oFacDscService.Borrar(Session.sCodEmp, lGruAlm, IdCliente, Session.sCodUsu)
            type_process = "delete"
            If estado_process = True Then
                Me.DialogResult = Windows.Forms.DialogResult.OK
            Else
    ...
    Private Sub ObtenerRegistro()
        Try
            ...
            registro = oFacDscService.MostrarPorId(Session.sCodEmp, lGruAlm, IdCliente)
    ...
    Private Sub GuardarDatos()
        If MsgBox("¿Está seguro que desea guardar los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes And ValidaCampos() Then
            ...
            Dim grupo As New ClienteFacDscService.GrupoAlmacen

            grupo.GruAlm = lGruAlm
            registro.GrupoAlmacen = grupo
