...
Public Class rptSaldoBanco
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptSaldoBanco.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSaldoBanco
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSaldoBanco = New rptSaldoBanco()
        rpt.Site = Me.Site
        Return rpt
    End Function
