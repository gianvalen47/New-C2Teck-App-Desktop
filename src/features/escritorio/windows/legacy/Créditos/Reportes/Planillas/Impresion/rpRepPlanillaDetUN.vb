...
Public Class rpRepPlanillaDetUN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepPlanillaDetUN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepPlanillaDetUN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepPlanillaDetUN = New rpRepPlanillaDetUN()
        rpt.Site = Me.Site
        Return rpt
    End Function
