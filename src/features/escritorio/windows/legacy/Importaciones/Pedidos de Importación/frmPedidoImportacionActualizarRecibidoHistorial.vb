...
Public Class frmPedidoImportacionActualizarRecibidoHistorial
    ...
    Private Sub Initialize_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dgvPrueba.Anchor = AnchorStyles.Top Or AnchorStyles.Right Or AnchorStyles.Left
        llenarCombos()
        'enableOpciones()
    End Sub
    ...
    '                estado_process = oPedidoImportDetService.ActualizarCanRec(Fila.Item("IdDetPedidoImp"), Fila.Item("IdPedidoImp"), Fila.Item("Recibir"), Fila.Item("Observacion"), Session.sCodUsu, Session.sNomPc, Session.sNomPc)
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oPedidoImportDetService.MostrarActualizados(Session.sCodEmp, cmbIdProveedor.Value, txtEmbarque.Text, txtNumPed.Text, txtNumFactura.Text, txtCodMer.Text).Tables(0)
