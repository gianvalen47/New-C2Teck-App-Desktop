...
Public Class frmPedidosImportacion_Archivos_Nuevo
    ...
    Public IdPedidoImpArchivo As String
    Private Extension As String
    Private RutaArchivo As String
    Private NombreArchivo As String

    Private Sub frmPedidosImportacion_Archivos_Nuevo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub frmPedidosImportacion_Archivos_Nuevo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmPedidosImportacion_Archivos_Nuevo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Insertar(ByVal registro As PedidoImportService.PedidoImportArchivos)
        Try
            IdPedidoImpArchivo = oPedidoImportService.InsertarArchivo(registro)
            type_process = "insert"
            If IdPedidoImpArchivo > 0 Then
