...
Public Class rptRepEmbarques
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRepEmbarques.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CodEmbarque() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptRepEmbarques
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRepEmbarques = New rptRepEmbarques()
        rpt.Site = Me.Site
        Return rpt
    End Function
