...
Public Class frmNotaCredito_NotaElectronica_EnviarCorreo
    ...
    Public IdDocumentoNota As Integer
    Public IdCliente As Integer

    Private Documento As String = ""

    Private Sub frmNotaCredito_NotaElectronica_EnviarCorreo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmNotaCredito_NotaElectronica_EnviarCorreo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmNotaCredito_NotaElectronica_EnviarCorreo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CargarCorreo()
        ...
        Try
            ...
            txtAsunto.Text = Session.sDesEmp & " - Nota Electronica: " & Documento '"DETROIT DIESEL MTU PERU SAC - Factura Electronica: " & Documento
    ...
    Private Sub DescargarPDF()
        ...
        Try
            ...
            pdfDoc = oNotaDigitalService.DescargarPdf(IdNota)

            Dim NombreXMLPDF As String = oNotaDigitalService.ObtenerNombre(IdNota)

            System.IO.File.WriteAllBytes("D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf", pdfDoc)
    ...
    Private Sub DescargarXML()
        ...
        Try
            ...
            xmlDoc.Load(New StringReader(oNotaDigitalService.Descargar(IdNota)))

            Dim NombreXMLPDF As String = oNotaDigitalService.ObtenerNombre(IdNota)

            xmlDoc.Save("D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".xml")
    ...
    Private Sub DescargarCDRXML()
        ...
        Try
            ...
            Dim xmlDoc As New XmlDocument
            xmlDoc.Load(New StringReader(oNotaDigitalService.DescargarCDR(IdNota)))

            Dim NombreXMLPDF As String = oNotaDigitalService.ObtenerNombre(IdNota)

            xmlDoc.Save("D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\R-" & NombreXMLPDF & ".xml")
        ...
        Try
            If ValidaCamposCorreo() Then
                ...
                If IdDocumentoNota = "5" Then
                    ...
                    Dim xmlcdrdir As String = "D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\R-" & Session.sRucEmp & "-07-" & Documento & ".xml"
                ...
                ElseIf IdDocumentoNota = "6" Then
                    ...
                    Dim xmlcdrdir As String = "D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\R-" & Session.sRucEmp & "-08-" & Documento & ".xml"
    ...
    Private Sub btnVerNota_Click(sender As Object, e As EventArgs) Handles btnVerNota.Click

        Try

            Dim NombreXMLPDF As String = oNotaDigitalService.ObtenerNombre(IdNota)

            System.Diagnostics.Process.Start("D:\Documentos_Electronicos\Notas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf")
