...
Public Class rpImprimirNotaAct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpImprimirNotaAct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirNotaAct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirNotaAct = New rpImprimirNotaAct()
        rpt.Site = Me.Site
        Return rpt
    End Function
