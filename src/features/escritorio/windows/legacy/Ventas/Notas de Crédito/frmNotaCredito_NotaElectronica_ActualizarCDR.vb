...
Public Class frmNotaCredito_NotaElectronica_ActualizarCDR

    Private oFacturaDigitalService As New NotaDigitalService.NotaDigitalServiceClient

    Public IdNota As Int64
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        Try
            ...
            Dim factura As New NotaDigitalService.NotaCredito
            ...
            factura.IdNota = IdNota
            registro.NotaCredito = factura
    ...
    Private Sub frmNotaCredito_NotaElectronica_ActualizarCDR_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Try
