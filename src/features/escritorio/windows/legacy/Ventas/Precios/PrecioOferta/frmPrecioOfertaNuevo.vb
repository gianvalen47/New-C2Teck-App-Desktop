...
Public Class frmPrecioOfertaNuevo
    ...
    Private Sub frmPrecioOfertaNuevo_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmPrecioOfertaNuevo_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmPrecioOfertaNuevo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As PrecioService.PreciosOferta
            registro = oPrecioService.ObtenerPrecioOferta(Session.sCodEmp, CodMer)
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        And ValidaCampos() Then
            ...
            Dim registro As New PrecioService.PreciosOferta
    ...
    Private Sub Insertar(ByVal registro As PrecioService.PreciosOferta)
        Try
            Dim estado_process As Boolean
            estado_process = oPrecioService.InsertarPrecioOferta(registro)
            type_process = "insert"
    ...
    Private Sub Modificar(ByVal registro As PrecioService.PreciosOferta)
        Try
            Dim estado_process As Boolean
            estado_process = oPrecioService.ActualizarPrecioOferta(registro)
            type_process = "update"
            If estado_process = True Then
                Me.DialogResult = Windows.Forms.DialogResult.OK
                'actualizarDetalles()
