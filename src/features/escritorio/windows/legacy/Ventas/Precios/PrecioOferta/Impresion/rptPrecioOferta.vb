...
Public Class rptPrecioOferta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptPrecioOferta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPrecioOferta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPrecioOferta = New rptPrecioOferta()
        rpt.Site = Me.Site
        Return rpt
    End Function
