...
Public Class frmListaOfertaNuevo_Detalle
    ...
    Private Sub frmListaOfertaNuevo_Detalle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CancelButton = Me.btnCancelar
        Me.Size = New System.Drawing.Size(606, 349)
    ...
    Private Sub frmListaOfertaNuevo_Detalle_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaOfertaNuevo_Detalle_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ListaOfertaDetService.ListaOfertaDet
            registro = oListaOfertaDetService.Obtener(toNumber(IdOfertaDet))
            ...
            'txtFecAprobacion.Value = registro.FecAprobacion
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
            ...
            Dim registro As New ListaOfertaDetService.ListaOfertaDet
            Dim listaoferta As New ListaOfertaDetService.ListaOfertaCab
            Dim Mercaderia As New ListaOfertaDetService.Mercaderia
            'Dim rubro As New ListaPrecioDetService.Rubro

            listaoferta.IdOferta = IdOferta
            registro.ListaOfertaCab = listaoferta
            registro.IdOfertaDet = IdOfertaDet
    ...
    Private Sub Insertar(ByVal registro As ListaOfertaDetService.ListaOfertaDet)
        Try
            Dim estado_process As Integer
            estado_process = oListaOfertaDetService.Insertar(registro)
            type_process = "insert"
            If estado_process > 0 Then
                IdOfertaDet = estado_process
    ...
    Private Sub Modificar(ByVal registro As ListaOfertaDetService.ListaOfertaDet)
        Try
            Dim estado_process As Boolean
            estado_process = oListaOfertaDetService.Actualizar(registro)
            type_process = "update"
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MODIFICAR LA LISTA DE OFERTA: " + ex.Message, MsgBoxStyle.Exclamation)
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
        End Try
    End Sub
