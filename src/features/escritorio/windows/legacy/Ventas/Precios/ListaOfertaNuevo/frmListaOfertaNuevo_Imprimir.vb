...
Public Class frmListaOfertaNuevo_Imprimir
    ...
    Private Sub frmListaOfertaNuevo_Imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        rbPantalla.Checked = True
        rbExcel.Enabled = IIf(oSeguridadService.ObtenerExpDatos(Session.sCodUsu) = True, True, False)
    End Sub

    Private Sub frmListaOfertaNuevo_Imprimir_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaOfertaNuevo_Imprimir_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub ImprimirListaPrecio()
        ...
        Try
            ...
            'dtReporte = oListaOfertaCabService.Imprimir(IdLista).Tables(0)
            ...
            Else
                ...
                ElseIf rbPantalla.Checked Then
                    ...
                    forma.Text = "Reporte de Listado de Oferta"
                    forma.ShowDialog()
                End If
            End If
