...
Public Class frmRubroEmpresa_Detalle
    ...
    Private Sub frmRubroEmpresa_Detalle_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmRubroEmpresa_Detalle_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmRubroEmpresa_Detalle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        listaDatos()
    End Sub
