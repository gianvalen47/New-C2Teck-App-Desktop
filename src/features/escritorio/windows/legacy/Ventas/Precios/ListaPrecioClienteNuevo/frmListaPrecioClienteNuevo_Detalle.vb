...
Public Class frmListaPrecioClienteNuevo_Detalle
    ...
    Private Sub frmListaPrecioClienteNuevo_Detalle_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaPrecioClienteNuevo_Detalle_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaPrecioClienteNuevo_Detalle_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As ListaClienteDetService.ListaClienteDet
            registro = oListaClienteDetService.Obtener(toNumber(IdListaDet))

            estado = registro.EstadoListaPrecioCliente.IdEstado
            ...
            txtCodigoCliente.Text = registro.CodMerCli
    ...
    Private Sub desactivar()
        ...
        Else
            ...
            txtCodigoCliente.BackColor = System.Drawing.SystemColors.Control
        End If
    ...
    Private Sub btnGuardar_Click(sender As Object, e As EventArgs) Handles btnGuardar.Click
        If MsgBox("¿Está seguro de GUARDAR los datos?", MsgBoxStyle.YesNo, "Advertencia") = MsgBoxResult.Yes _
            ...
            Dim registro As New ListaClienteDetService.ListaClienteDet
            Dim listaprecio As New ListaClienteDetService.ListaClienteCab
            Dim Mercaderia As New ListaClienteDetService.Mercaderia
            'Dim rubro As New ListaPrecioDetService.Rubro

            listaprecio.IdLista = IdLista
            registro.Item = txtItem.Value
            registro.ListaClienteCab = listaprecio
    ...
    Private Sub Insertar(ByVal registro As ListaClienteDetService.ListaClienteDet)
        Try
            Dim estado_process As Integer
            estado_process = oListaClienteDetService.Insertar(registro)
            type_process = "insert"
    ...
    Private Sub Modificar(ByVal registro As ListaClienteDetService.ListaClienteDet)
        Try
            Dim estado_process As Boolean
            estado_process = oListaClienteDetService.Actualizar(registro)
            type_process = "update"
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL MODIFICAR LA LISTA CLIENTE: " + ex.Message, MsgBoxStyle.Exclamation)
            Me.DialogResult = System.Windows.Forms.DialogResult.OK
        End Try
    End Sub
