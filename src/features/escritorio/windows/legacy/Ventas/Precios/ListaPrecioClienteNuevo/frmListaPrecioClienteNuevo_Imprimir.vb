...
Public Class frmListaPrecioClienteNuevo_Imprimir
    ...
    Private Sub frmListaPrecioClienteNuevo_Imprimir_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaPrecioClienteNuevo_Imprimir_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaPrecioClienteNuevo_Imprimir_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub ImprimirListaPrecio()
        ...
        Try
            ...
            dtReporte = oListaClienteCabService.Imprimir(IdLista).Tables(0)
