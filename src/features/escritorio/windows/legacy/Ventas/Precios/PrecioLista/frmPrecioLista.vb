...
Public Class frmPrecioLista
    ...
    Private Sub frmPrecioLista_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmPrecioLista_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmPrecioLista_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ListaDatos()
        Try
            dtDatos = oPrecioService.MostrarPrecioLista(Session.sCodEmp, cmbRubro.Value).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmPrecioListaNuevo
    ...
    Private Sub Eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("CodMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oPrecioService.BorrarPrecioLista(Session.sCodEmp, dgvDatos.CurrentRow.Cells("CodMer").Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub miFormatoExcel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miFormatoExcel.Click, biFormatoExcel.Click
        FormatoExcel()
    End Sub
    ...
    Private Sub InsertarMasivo()
        ...
        Try
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL INSERTAR MASIVO LA LISTA DE PRECIO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    ...
    Private Sub biImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            ...
            Dim reporte As New rptPrecioLista

            If dgvDatos.RowCount > 0 Then
                dtReporte = oPrecioService.MostrarPrecioLista(Session.sCodEmp, cmbRubro.Value).Tables(0)
    ...
    Private Sub biEliminar_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Precio Lista Seleccionada"
    End Sub
