...
Public Class rptListaOfertaN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptListaOfertaN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaOfertaN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaOfertaN = New rptListaOfertaN()
        rpt.Site = Me.Site
        Return rpt
    End Function
