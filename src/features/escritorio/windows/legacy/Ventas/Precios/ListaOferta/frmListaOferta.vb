...
Public Class frmListaOferta
    ...
    Private Sub frmListaOferta_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmListaOferta_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmListaOferta_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        llenarCombos()
        listaDatos()
    ...
    Private Sub listaDatos()
        Try
            dtDatos = oPrecioService.MostrarListaOferta(Session.sCodEmp, cmbRubro.Value, txtCodMer.Text, utils.toNumber(cmbEstados.Value)).Tables(0)
            'MostrarListaPrecio
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmListaOferta_Nuevo
            ...
            End While
        Catch ex As Exception
            MsgBox("Error al ingresar nuevo precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            RowPossesion(dgvDatos, frm.IdLista)
        Catch ex As Exception
            MsgBox("Error al mostrar el precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("CodMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oPrecioService.BorrarListaOferta(dgvDatos.CurrentRow.Cells("IdLista").Value, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
            ...
            End If
        Catch ex As Exception
            MsgBox("Error al eliminar el precio oferta:" + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biImprimir_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biImprimir.Click, miImprimir.Click
        Try
            ...
            Dim reporte As New rptListaOfertaN

            If dgvDatos.RowCount > 0 Then
                dtReporte = oPrecioService.MostrarListaOferta(Session.sCodEmp, cmbRubro.Value, txtCodMer.Text, utils.toNumber(cmbEstados.Value)).Tables(0)
                ...
                Else
                    ...
                    forma.Text = "Reporte de precio oferta"
                    forma.ShowDialog()
                End If
            Else
    ...
    Private Sub biEnviar_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles biEnviar.MouseEnter, miEnviar.MouseEnter
        sslError.Text = "Enviar precio oferta"
    End Sub
    ...
    Private Sub biAprobar_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles biAprobar.MouseEnter, miAprobar.MouseEnter
        sslError.Text = "Aprobar precio oferta"
    End Sub
    ...
    Private Sub biVencimiento_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles biVencimiento.MouseEnter, miVencimiento.MouseEnter
        sslError.Text = "Dar de baja precio oferta"
    End Sub
    ...
    Private Sub biEliminar_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar precio oferta seleccionado"
    End Sub
    ...
    Private Sub biEnviar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEnviar.Click, miEnviar.Click
        Try
            Dim frm As New frmListaOferta_CambiarEstado
            frm.IdEstado = "1"
            frm.DesEstado = dgvDatos.CurrentRow.Cells("DesEstado").Value
            frm.Text = "Enviar precio oferta"
        ...
        Catch ex As Exception
            MsgBox("Error al enviar el precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biAprobar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biAprobar.Click, miAprobar.Click
        Try
            ...
            frm.DesEstado = dgvDatos.CurrentRow.Cells("DesEstado").Value
            frm.Text = "Aprobar precio oferta"
            'frm.cmbEstados.ReadOnly = True
            'frm.IdLista = dgvDatos.CurrentRow.Cells("IdLista").Text
        ...
        Catch ex As Exception
            MsgBox("Error al aprobar el precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub biVerEstados_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biVerEstados.Click, miVerEstados.Click
        Try
            If ValidaCodigoSeleccionado() Then
                Dim frm As New frmListaOferta_Estados
                frm.IdLista = dgvDatos.CurrentRow.Cells("IdLista").Text
                frm.Text = "Estados del precio oferta : " & dgvDatos.CurrentRow.Cells("CodMer").Value
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                End If
            End If
        Catch ex As Exception
    ...
    Private Sub biVencimiento_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biVencimiento.Click, miVencimiento.Click
        Try
            ...
            'frm.cmbEstados.ReadOnly = True
            frm.DesEstado = dgvDatos.CurrentRow.Cells("DesEstado").Value
            frm.Text = "Dar de baja precio oferta"
            'frm.IdLista = dgvDatos.CurrentRow.Cells("IdLista").Text
        ...
        Catch ex As Exception
            MsgBox("Error al dar de baja el precio oferta: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
