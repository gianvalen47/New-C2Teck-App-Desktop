...
Public Class frmListaPrecio_Nuevo
    ...
    Private Sub frmPreciolistaNuevo2_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmPreciolistaNuevo2_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmPreciolistaNuevo2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As PrecioService.ListaPrecio
            registro = oPrecioService.MostrarPorIdListaPrecio(IdLista)
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        And ValidaCampos() Then
            ...
            Dim registro As New PrecioService.ListaPrecio
    ...
    Private Sub Insertar(ByVal registro As PrecioService.ListaPrecio)
        Try
            Dim estado_process As String
            estado_process = oPrecioService.InsertarListaPrecio(registro)
            type_process = "insert"
    ...
    Private Sub Modificar(ByVal registro As PrecioService.ListaPrecio)
        Try
            Dim estado_process As Boolean
            estado_process = oPrecioService.ActualizarListaPrecio(registro)
            type_process = "update"
