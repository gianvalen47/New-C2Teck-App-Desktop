...
Public Class rptListaPrecioN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptListaPrecioN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaPrecioN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaPrecioN = New rptListaPrecioN()
        rpt.Site = Me.Site
        Return rpt
    End Function
