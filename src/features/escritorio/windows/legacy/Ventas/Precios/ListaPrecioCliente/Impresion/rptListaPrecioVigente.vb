...
Public Class rptListaPrecioVigente
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rptListaPrecioVigente.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptListaPrecioVigente.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptListaPrecioVigente
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptListaPrecioVigente = New rptListaPrecioVigente()
        rpt.Site = Me.Site
        Return rpt
    End Function
