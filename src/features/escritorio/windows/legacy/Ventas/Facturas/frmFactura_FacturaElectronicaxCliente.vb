...
Public Class frmFactura_FacturaElectronicaxCliente
    ...
    Private Sub frmFactura_FacturaElectronicaxCliente_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmFactura_FacturaElectronicaxCliente_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmFactura_FacturaElectronicaxCliente_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ListarDatos()
        Try
            dtFacturas = oFacturaDigitalService.ConsultarFacturas(IdCliente, utils.toBlank(txtCodSerie.Text), utils.toNumber(txtNumDoc.Text)).Tables(0)
            'DataGridView1.DataSource = dtFacturas
            dgvDatos.DataSource = dtFacturas
    ...
    Private Sub ObtenerTagFirma()
        ...
        Try
            ...
            xmlDoc.Load("D:\Documentos_Electronicos\Facturas_Electronicas\" & DocumentoFac & "\" & NombreXMLPDF & ".xml")
    ...
    Private Sub CrearPDF()
        Try
            ...
            Dim url As String = RucEmp & "|" & TipoDoc & "|" & CodSerieFac & "|" & NumDocFac & "|" & IIf(CodMot <> "2", FormatNumber(TaxAmount, 2), FormatNumber("0.00", 2)) & "|" & IIf(CodMot <> "2", FormatNumber(LegalMonetaryTotal, 2), FormatNumber("0.00", 2)) & "|" & FecDoc.ToString("yyyy-MM-dd") & "|" & "6" & "|" & RucCli & "|" & ValorResumen & "|" & ValorFirma
            ...
            UbicacionCodBarra = "D:\Documentos_Electronicos\Facturas_Electronicas\" & DocumentoFac & "\" & DocumentoFac & ".png"
    ...
    Private Sub CrearPDF2()
        ...
        Try
            ...
            dtReporte = oFacturaService.ImprimirDigital(dgvDatos.CurrentRow.Cells("IdFactura").Text).Tables(0)
    ...
    Public Shared Function ExportToPDF(rpt As ReportDocument, NombreArchivo As String, DocumentoFac As String, NombreXMLPDF As String) As String
        ...
        Try
            diskOpts.DiskFileName = "D:\Documentos_Electronicos\Facturas_Electronicas\" & DocumentoFac & "\" & NombreXMLPDF & ".pdf"
    ...
    Private Sub btnBuscar_Click(sender As System.Object, e As System.EventArgs) Handles btnBuscar.Click, txtCliente.TextChanged, txtCodSerie.TextChanged, txtNumDoc.TextChanged
        ListarDatos()
    End Sub
