Public Class frmFacturaSugerirCabecera
    ...
    Private Sub frmFacturaSugerirCabecera_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmFacturaSugerirCabecera_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim estilo As New Estilo
        Me.Text = "Sugerir Factor - Dscto"
        state_button = oFacturaService.BuscarSugerido(IdFactura)
    ...
    Private Sub Insertar()
        Try
            ...
            estado_process = oFacturaService.InsertarSugerido(IdFactura, txtFactorSug.Text, txtDsctoSug.Text, txtObservacion.Text)
            type_process = "insert"
    ...
    Private Sub Modificar()
        Try
            ...
            estado_process = oFacturaService.ActualizarSugerido(IdSugerido, txtFactorSug.Text, txtDsctoSug.Text, txtObservacion.Text)
            type_process = "update"
    ...
    Private Sub Eliminar()
        Try
            Dim estado_process As Boolean
            estado_process = oFacturaService.BorrarSugerido(IdSugerido)
            type_process = "delete"
    ...
    Private Sub ObtenerRegistro()
        Try
            Dim registro As FacturaService.SugeridoFactura
            registro = oFacturaService.MostrarSugeridoPorId(IdSugerido)
