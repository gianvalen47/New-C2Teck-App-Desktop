...
Public Class rpImprimirFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpImprimirFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpImprimirFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpImprimirFactura = New rpImprimirFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
