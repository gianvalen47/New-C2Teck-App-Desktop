...
Public Class frmBoleta_BoletaElectronica_EnviarCorreo
    ...
    Private Sub frmBoleta_BoletaElectronica_EnviarCorreo_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmBoleta_BoletaElectronica_EnviarCorreo_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmBoleta_BoletaElectronica_EnviarCorreo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CargarCorreo()
        ...
        Try
            ...
            txtAsunto.Text = Session.sDesEmp & " - Boleta Electronica: " & Documento '"DETROIT DIESEL MTU PERU SAC - Factura Electronica: " & Documento
    ...
    Private Sub DescargarPDF()
        ...
        Try
            ...
            pdfDoc = oBoletaDigitalService.DescargarPdf(IdBoleta)

            Dim NombreXMLPDF As String = oBoletaDigitalService.ObtenerNombre(IdBoleta)

            System.IO.File.WriteAllBytes("D:\Documentos_Electronicos\Boletas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf", pdfDoc)
    ...
    Private Sub DescargarXML()
        ...
        Try
            ...
            xmlDoc.Load(New StringReader(oBoletaDigitalService.Descargar(IdBoleta)))

            Dim NombreXMLPDF As String = oBoletaDigitalService.ObtenerNombre(IdBoleta)

            xmlDoc.Save("D:\Documentos_Electronicos\Boletas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".xml")
    ...
    Private Sub btnVerBoleta_Click(sender As Object, e As EventArgs) Handles btnVerBoleta.Click

        Try

            Dim NombreXMLPDF As String = oBoletaDigitalService.ObtenerNombre(IdBoleta)

            System.Diagnostics.Process.Start("D:\Documentos_Electronicos\Boletas_Electronicas\" & Documento & "\" & NombreXMLPDF & ".pdf")
