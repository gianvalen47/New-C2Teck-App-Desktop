...
Public Class frmGuiaRemision_Electronica_ActualizarCDR

    Private oFacturaDigitalService As New GuiaRemisionDigitalService.GuiaRemisionDigitalServiceClient
    Public IdGuia As Int64
    ...
    Private Sub OK_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles OK_Button.Click
        ...
        Try
            ...
            Dim factura As New GuiaRemisionDigitalService.GuiaRemision
            ...
            factura.IdGuia = IdGuia
            registro.GuiaRemision = factura
            ...
            registro.UrlLink = toNull(txtUrlLink.Text)
    ...
    Private Sub ObtenerDatosXmlCDR()
        ...
        txtUrlLink.Text = toNull(UrlLink)
        '///////////////////////////////////////////////////////////////////////////

    End Sub

    Private Sub frmGuiaRemision_Electronica_ActualizarCDR_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Try
