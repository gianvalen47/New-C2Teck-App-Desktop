...
Public Class rpRepVentaGuias
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepVentaGuias.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepVentaGuias
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepVentaGuias = New rpRepVentaGuias()
        rpt.Site = Me.Site
        Return rpt
    End Function
