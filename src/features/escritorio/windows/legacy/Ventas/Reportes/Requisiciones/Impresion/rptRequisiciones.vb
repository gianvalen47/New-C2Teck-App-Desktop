...
Public Class rptRequisiciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptRequisiciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRequisiciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRequisiciones = New rptRequisiciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
