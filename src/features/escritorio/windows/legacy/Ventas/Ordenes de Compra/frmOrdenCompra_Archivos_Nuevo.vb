...
Public Class frmOrdenCompra_Archivos_Nuevo
    ...
    Private Sub Insertar(ByVal registro As OrdenCompraService.OrdenCompraArchivos)
        Try
            IdOrdenArchivo = oOrdenCompraService.InsertarArchivos(registro)
            type_process = "insert"
