...
Public Class frmOrdenCompra_Archivos_Actualizar

    Private oOrdenService As New OrdenCompraService.OrdenCompraServiceClient
    ...
    Private Sub ObtenerRegistro()
        ...
        Try
            Dim registro2 As OrdenCompraService.OrdenCompraArchivos
            oOrdenService.InnerChannel.OperationTimeout = TimeSpan.FromMinutes(10)
            registro2 = oOrdenService.ObtenerArchivos(IdArchivo)
    ...
    Private Sub btnAceptar_Click(sender As Object, e As EventArgs) Handles btnAceptar.Click
        ...
        Try
            ...
            Dim registro As New OrdenCompraService.OrdenCompraArchivos

            Dim orden As New OrdenCompraService.OrdenCompra
            ...
            actualizar = oOrdenService.ActualizarArchivos(registro)
