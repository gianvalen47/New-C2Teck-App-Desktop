...
Public Class rpRepReclamos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepReclamos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepReclamos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepReclamos = New rpRepReclamos
        rpt.Site = Me.Site
        Return rpt
    End Function
