...
Public Class rptSolicitudJob
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptSolicitudJob.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptSolicitudJob
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSolicitudJob = New rptSolicitudJob()
        rpt.Site = Me.Site
        Return rpt
    End Function
