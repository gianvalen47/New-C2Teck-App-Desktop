...
Public Class rptHorasMuertas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptHorasMuertas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHorasMuertas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHorasMuertas = New rptHorasMuertas()
        rpt.Site = Me.Site
        Return rpt
    End Function
