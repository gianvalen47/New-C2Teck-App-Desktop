...
Public Class rptJobGarantia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptJobGarantia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptJobGarantia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobGarantia = New rptJobGarantia
        rpt.Site = Me.Site
        Return rpt
    End Function
