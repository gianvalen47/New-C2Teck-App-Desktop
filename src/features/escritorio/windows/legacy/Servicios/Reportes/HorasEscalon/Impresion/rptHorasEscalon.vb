...
Public Class rptHorasEscalon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptHorasEscalon.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Mant() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptHorasEscalon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHorasEscalon = New rptHorasEscalon()
        rpt.Site = Me.Site
        Return rpt
    End Function
