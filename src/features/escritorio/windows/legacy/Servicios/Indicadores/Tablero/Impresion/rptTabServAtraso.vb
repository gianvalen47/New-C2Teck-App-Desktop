...
Public Class rptTabServAtraso
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptTabServAtraso.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptTabServAtraso
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptTabServAtraso = New rptTabServAtraso()
        rpt.Site = Me.Site
        Return rpt
    End Function
