...
Public Class frmJob_Mostrar_RefrigMovil
    ...
    Private Sub frmJob_Mostrar_RefrigMovil_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            oJobService.Close()
    ...
    Private Sub frmJob_Mostrar_RefrigMovil_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub frmJob_Mostrar_RefrigMovil_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        listaDatos()
