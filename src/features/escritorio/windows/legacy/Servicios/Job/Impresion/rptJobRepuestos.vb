...
Public Class rptJobRepuestos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rptJobRepuestos.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_pMotor() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptJobRepuestos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptJobRepuestos = New rptJobRepuestos()
        rpt.Site = Me.Site
        Return rpt
    End Function
