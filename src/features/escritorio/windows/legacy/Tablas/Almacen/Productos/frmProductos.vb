    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("CodMer").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                codmer = dgvDatos.CurrentRow.Cells("CodMer").Text

                estado_process = oMercaderiaService.Borrar(codmer, Session.sCodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                ...
                dtDatos = oMercaderiaService.Filtrar(toBlank(txtCodMer.Text), Session.sCodEmp, toBlank(txtDesMer1.Text), toBlank(cmbCodRub.Value), toBlank(cmbModMer.Value), toBlank(cmbTipMot.Value), toBlank(cmbIdClase.Value)).Tables(0)
