Public Class frmTiposMotoresProducto
    ...
    Private Sub mostrar()
        Try
            Dim frm As New frmTipoMotorProducto
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro con CÓDIGO = " + dgvDatos.CurrentRow.Cells("TipMot").Text.ToString + " ?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                Dim tipmot As String
                tipmot = dgvDatos.CurrentRow.Cells("TipMot").Text
                estado_process = oTipoMotorService.Borrar(tipmot, Session.sCodEmp, Session.sCodUsu, Session.sNomPc, Session.sDirIp)
    ...
    Private Sub listaDatos()
        Try
            ...
            dtDatos = oTipoMotorService.Filtrar(txtTipMot.Text, Session.sCodEmp, txtDescripcion.Text).Tables(0)
