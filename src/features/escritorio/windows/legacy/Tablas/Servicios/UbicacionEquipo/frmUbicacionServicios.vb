...
Public Class frmUbicacionServicios
    ...
    Private Sub frmUbicacionEquipos_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmUbicacionEquipos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 236)
        '/*************************************************************************************/
    ...
    '==========================Evento KeyDown===============================================
    Private Sub frmUbicacionEquipos_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTablasPersonalService.MostrarUbicacionEquipo().Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmUbicacionServicio
            ...
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVA UBICACIÓN DE EQUIPO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oTablasPersonalService.BorrarUbicacionEquipo(toNumber(dgvDatos.CurrentRow.Cells("CodUbicacion").Value))
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR UBICACIÓN DE EQUIPO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            RowPossesion(dgvDatos, frm.CodUbicacion)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR UBICACIÓN DE EQUIPO: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Ubicación de Servicio actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nueva Ubicación de Servicio."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Ubicación de Servicio actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Ubicación de Servicio actual."
    End Sub
