...
Public Class rpRepCuentaContable
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpRepCuentaContable.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SIGECOM.rpRepCuentaContable.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrpRepCuentaContable
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpRepCuentaContable = New rpRepCuentaContable()
        rpt.Site = Me.Site
        Return rpt
    End Function
