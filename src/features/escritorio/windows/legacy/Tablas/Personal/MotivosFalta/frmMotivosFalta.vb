...
Public Class frmMotivosFalta
    ...
    Private Sub frmMotivosFalta_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmCargos_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 232)
        '/*************************************************************************************/
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("CodMotivo").Value = codigo Then
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTablasPersonalService.FiltrarMotivoFaltas().Tables(0)
    ...
    Private Sub Actualizar()
        ...
        If dgvDatos.RowCount > 0 Then
            codigo = dgvDatos.CurrentRow.Cells("CodMotivo").Text
        End If
        dtDatos = Nothing
        listaDatos()
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmMotivoFalta
                frm.state_button = False
                If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                    dtDatos = Nothing
                    listaDatos()
                    If frm.type_process = "insert" Then
                        RowPossesion(dgvDatos, frm.CodMotivo)
                    End If
                Else
                    lLog = False
                End If
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oTablasPersonalService.BorrarMotivoFaltas(toBlank(dgvDatos.CurrentRow.Cells("CodMotivo").Value))
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR EL MOTIVO DE FALTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.CodMotivo = dgvDatos.CurrentRow.Cells("CodMotivo").Value
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
            ...
            RowPossesion(dgvDatos, frm.CodMotivo)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR EL MOTIVO DE FALTA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Motivo de Falta actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo Motivo de Falta."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Motivo de Falta actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Motivo de Falta actual."
    End Sub
