...
Public Class frmTiposHoraExtra
    ...
    Private Sub frmTiposHoraExtra_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
    ...
    Private Sub frmTiposHoraExtra_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load

        '/************************** Insertar Opciones de Session ************************/
        oSeguridadService.InsertarSesionOpciones(Session.sIdSesion, 235)
        '/*************************************************************************************/
    ...
    '==========================Evento KeyDown===============================================
    Private Sub frmTiposHoraExtra_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub RowPossesion(ByVal lista As Janus.Windows.GridEX.GridEX, ByVal codigo As String)
        ...
        For Each row In rows
            If row.Cells("IdHoraExtra").Value = codigo Then
    ...
    Private Sub listaDatos()
        Try
            If state_Search = True Then
                dtDatos = oTablasPersonalService.FiltrarTipoHoraExtra(Session.sCodEmp).Tables(0)
    ...
    Private Sub Nuevo()
        Try
            ...
            While lLog
                Dim frm As New frmTipoHoraExtra
            ...
            End While
        Catch ex As Exception
            MsgBox("ERROR AL INGRESAR NUEVO TIPO HORA EXTRA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub eliminar()
        Try
            ...
            If MsgBox("¿Está seguro de ELIMINAR el registro seleccionado?", MsgBoxStyle.YesNo, "Información") = MsgBoxResult.Yes Then
                ...
                estado_process = oTablasPersonalService.BorrarTipoHoraExtra(toNumber(dgvDatos.CurrentRow.Cells("IdHoraExtra").Value))
            ...
            End If
        Catch ex As Exception
            MsgBox("ERROR AL ELIMINAR TIPO HORA EXTRA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub mostrar()
        Try
            ...
            frm.IdHoraExtra = toNumber(dgvDatos.CurrentRow.Cells("IdHoraExtra").Value)
            If frm.ShowDialog = System.Windows.Forms.DialogResult.OK Then
                dtDatos = Nothing
                listaDatos()
            ...
            RowPossesion(dgvDatos, frm.IdHoraExtra)
        Catch ex As Exception
            MsgBox("ERROR AL MOSTRAR TIPO HORA EXTRA: " + ex.Message, MsgBoxStyle.Exclamation)
        End Try
    End Sub
    ...
    Private Sub Imprimir_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles miImprimir.MouseEnter, biImprimir.MouseEnter
        sslError.Text = "Imprimir Tipo de Hora Extra actual."
    End Sub
    Private Sub Nuevo_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biNuevo.MouseEnter, miNuevo.MouseEnter
        sslError.Text = "Crear Nuevo Tipo de Hora Extra."
    End Sub
    Private Sub Mostrar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biMostrar.MouseEnter, miMostrar.MouseEnter
        sslError.Text = "Mostrar Tipo de Hora Extra actual."
    End Sub
    Private Sub Eliminar_MouseEnter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles biEliminar.MouseEnter, miEliminar.MouseEnter
        sslError.Text = "Eliminar Tipo Hora Extra actual."
    End Sub
