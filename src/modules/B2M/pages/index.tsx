...
export default function B2MModule() {
  const features = [
    { id: 'proveedores', label: 'Proveedores', icon: Store, description: 'GestiÃ³n de proveedores B2B' },
    { id: 'catalogo', label: 'CatÃ¡logo', icon: Globe, description: 'CatÃ¡logo de productos' },
    { id: 'pedidos', label: 'Pedidos', icon: TrendingUp, description: 'Ã“rdenes B2B' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-slate-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">MÃ³dulo B2M</h1>
          <p className="text-lg text-slate-600">Plataforma de comercio B2B para gestiÃ³n de proveedores y pedidos</p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <Link to={`/dashboard/b2m/${feature.id}` as any}>
