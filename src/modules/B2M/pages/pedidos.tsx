...
export default function B2mPedidosPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Página generada automáticamente para la sección Pedidos. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
