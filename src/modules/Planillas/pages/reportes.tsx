...
export default function PlanillasReportesPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Página generada automáticamente para la sección Reportes. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
