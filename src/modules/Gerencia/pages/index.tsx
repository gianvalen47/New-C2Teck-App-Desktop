...
export default function GerenciaModule() {
  const features = [
    { id: 'reportes', label: 'Reportes', icon: BarChart3, description: 'Reportes consolidados' },
    { id: 'indicadores', label: 'Indicadores', icon: Gauge, description: 'KPIs y indicadores' },
    { id: 'estado-financiero', label: 'Estado Financiero', icon: DollarSign, description: 'Reportes financieros' },
    { id: 'proyecciones', label: 'Proyecciones', icon: TrendingUp, description: 'Proyecciones presupuestarias' },
    { id: 'dashboard', label: 'Dashboard', icon: PieChart, description: 'Panel de control' },
    { id: 'consultas', label: 'Consultas', icon: Search, description: 'Consultas gerenciales' },
  ];
