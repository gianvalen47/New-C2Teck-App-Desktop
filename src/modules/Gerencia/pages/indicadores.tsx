...
export default function GerenciaIndicadoresPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Página generada automáticamente para la sección Indicadores. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
