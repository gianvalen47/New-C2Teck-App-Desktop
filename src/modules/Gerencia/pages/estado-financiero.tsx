...
export default function GerenciaEstadoFinancieroPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-slate-900">Estado Financiero</h1>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Página generada automáticamente para la sección Estado Financiero. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
