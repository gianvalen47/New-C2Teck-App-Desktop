...
export default function TelefoniaEquiposPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              PÃ¡gina generada automÃ¡ticamente para la secciÃ³n Equipos. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
