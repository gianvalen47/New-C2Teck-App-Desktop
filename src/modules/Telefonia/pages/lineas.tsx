...
export default function TelefoniaLineasPage() {
  return (
      ...
      <div className="max-w-5xl mx-auto">
        <div className="mb-6 flex items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-bold text-slate-900">LÃ­neas</h1>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              PÃ¡gina generada automÃ¡ticamente para la secciÃ³n LÃ­neas. Completa esta vista con los datos y formularios correspondientes.
            </CardDescription>
          </CardHeader>
          <CardContent>
