...
export default function ServiciosModule() {
  const features = [
    { id: 'jobs', label: 'Trabajos (Jobs)', icon: Wrench, description: 'Órdenes de servicio' },
    { id: 'marcacion', label: 'Marcación', icon: Clock, description: 'Control de marcación' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Módulo de Servicios</h1>
          <p className="text-lg text-slate-600">Gestión integral de órdenes de servicio, marcación y mantenimiento</p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <Link to={`/dashboard/servicios/${feature.id}`}>
