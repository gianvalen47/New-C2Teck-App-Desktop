...
import { facturasToolbarButtons } from '@/lib/toolbar-config'
import type { ToolbarButtonWithIcon } from '@/components/ui/toolbar-enhanced'

export default function VentasFacturasPage() {
  const [toolbarButtons] = useState<ToolbarButtonWithIcon[]>(facturasToolbarButtons as ToolbarButtonWithIcon[])
  ...
  const handleToolbarButtonClick = (buttonId: string) => {
    ...
    switch (buttonId) {
      ...
      case 'generarElectronica':
        console.log('Generar factura electrónica...')
        break
      case 'descargarElectronica':
        console.log('Descargar factura electrónica...')
        break
      case 'salir':
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="py-8 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Registros de Facturas (0)</CardTitle>
              <CardDescription>
                Listado de facturas disponibles en el sistema
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <div className="mt-4 p-3 bg-slate-50 border border-slate-200 rounded text-sm text-slate-600">
                ℹ️ Utiliza los botones de la barra de herramientas para crear, editar o eliminar facturas.
              </div>
            </CardContent>
          </Card>
        </div>
