...
export default function ContabilidadModule() {
  const features = [
    ...
    { id: 'tesoreria', label: 'Tesorería', icon: Wallet, description: 'Gestión de tesorería' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-zinc-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Módulo de Contabilidad</h1>
          <p className="text-lg text-slate-600">Gestión integral de registros contables y finanzas</p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <Link to={`/dashboard/contabilidad/${feature.id}`}>
