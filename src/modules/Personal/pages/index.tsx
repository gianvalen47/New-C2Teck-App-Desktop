...
export default function PersonalModule() {
  const features = [
    ...
    { id: 'comunicacion', label: 'Comunicación', icon: MessageSquare, description: 'Comunicaciones internas' },
    { id: 'informacion', label: 'Información', icon: FileText, description: 'Información de empleados' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">Módulo de Personal</h1>
          <p className="text-lg text-slate-600">Gestión integral de recursos humanos y personal</p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <Link to={`/dashboard/personal/${feature.id}`}>
