...
export default function AdministracionModule() {
  const features = [
    ...
    { id: 'configuracion', label: 'ConfiguraciÃ³n', icon: Settings, description: 'Ajustes del sistema' },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 py-8 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 mb-2">MÃ³dulo de AdministraciÃ³n</h1>
          <p className="text-lg text-slate-600">Control administrativo de usuarios, perfiles y configuraciÃ³n del sistema</p>
        </div>
          ...
          {features.map((feature) => {
            ...
            return (
              <Card key={feature.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  <Link to={`/dashboard/administracion/${feature.id}` as any}>
